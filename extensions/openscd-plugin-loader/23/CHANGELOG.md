...
- Uploading a file while an OpenSCD plugin (e.g. Supervision) is open now reliably shows the newest content instead of occasionally staying on the previous file.

## [22] - 2026-07-12

### Fixed

- an issue when working with openscd plugins

...
(n.charCodeAt(2) > 122 || n.charCodeAt(2) < 97), Hs = (n) => n.startsWith("onUpdate:"), Kt = Object.assign, Ws = (n, i) => {
  const a = n.indexOf(i);
  a > -1 && n.splice(a, 1);
}, Kc = Object.prototype.hasOwnProperty, nt = (n, i) => Kc.call(n, i), Ke = Array.isArray, Hi = (n) => ko(n) === "[object Map]", qc = (n) => ko(n) === "[object Set]", qe = (n) => typeof n == "function", Pt = (n) => typeof n == "string", ci = (n) => typeof n == "symbol", St = (n) => n !== null && typeof n == "object", vu = (n) => (St(n) || qe(n)) && qe(n.then) && qe(n.catch), Bc = Object.prototype.toString, ko = (n) => Bc.call(n), $c = (n) => ko(n).slice(8, -1), Vc = (n) => ko(n) === "[object Object]", Ys = (n) => Pt(n) && n !== "NaN" && n[0] !== "-" && "" + parseInt(n, 10) === n, Wi = /* @__PURE__ */ Gs(
...
function sr(n, i, a, u, l, d) {
  ...
  if (zs(), i === "clear")
    ...
    if (D && a === "length") {
      const K = Number(u);
      v.forEach((G, re) => {
        (re === "length" || re === ro || !ci(re) && re >= K) && S(G);
      });
    } else
      switch ((a !== void 0 || v.has(void 0)) && S(v.get(a)), W && S(v.get(ro)), i) {
        case "add":
          D ? W && S(v.get("length")) : (S(v.get(Zr)), Hi(n) && S(v.get(Ps)));
          break;
        case "delete":
          D || (S(v.get(Zr)), Hi(n) && S(v.get(Ps)));
          break;
        case "set":
          Hi(n) && S(v.get(Zr));
          break;
...
function rr(n, i, a, u, l, d) {
  const v = ta(n), S = v !== n && !Tn(n), D = v[i];
  if (D !== il[i]) {
    const G = D.apply(n, d);
    return S ? Jt(G) : G;
  }
  let W = a;
  v !== n && (S ? W = function(G, re) {
...
function _a(n, i, a, u) {
  const l = ta(n);
  let d = a;
  return l !== n && (Tn(n) ? a.length > 3 && (d = function(v, S, D) {
    return a.call(this, v, S, D, n);
  }) : d = function(v, S, D) {
    return a.call(this, v, Jt(S), D, n);
  }), l[i](d, ...u);
}
function vs(n, i, a) {
  const u = tt(n);
...
class Iu {
  ...
  get(i, a, u) {
    ...
    return (ci(a) ? Pu.has(a) : ol(a)) || (l || Lt(i, "get", a), d) ? S : Mt(S) ? v && Ys(a) ? S : S.value : St(S) ? l ? ku(S) : ra(S) : S;
  }
}
class Ou extends Iu {
  constructor(i = !1) {
  ...
  set(i, a, u, l) {
    ...
    if (!this._isShallow) {
      const D = ei(d);
      if (!Tn(u) && !ei(u) && (d = tt(d), u = tt(u)), !Ke(i) && Mt(d) && !Mt(u))
        return D ? !1 : (d.value = u, !0);
    }
    const v = Ke(i) && Ys(a) ? Number(a) < i.length : nt(i, a), S = Reflect.set(
      i,
      a,
      u,
      Mt(i) ? i : l
    );
    return i === tt(l) && (v ? mr(u, d) && sr(i, "set", a, u) : sr(i, "add", a, u)), S;
  }
  deleteProperty(i, a) {
    const u = nt(i, a);
    i[a];
...
function fl(n, i, a) {
  return function(...u) {
    const l = this.__v_raw, d = tt(l), v = Hi(d), S = n === "entries" || n === Symbol.iterator && v, D = n === "keys" && v, W = l[n](...u), K = a ? Is : i ? Os : Jt;
    return !i && Lt(
      d,
      "iterate",
      D ? Ps : Zr
...
function dl(n, i) {
  const a = {
    get(l) {
      const d = this.__v_raw, v = tt(d), S = tt(l);
      n || (mr(l, S) && Lt(v, "get", l), Lt(v, "get", S));
    ...
    has(l) {
      const d = this.__v_raw, v = tt(d), S = tt(l);
      return n || (mr(l, S) && Lt(v, "has", l), Lt(v, "has", S)), l === S ? d.has(l) : d.has(l) || d.has(S);
    },
    forEach(l, d) {
      const v = this, S = v.__v_raw, D = tt(S), W = i ? Is : n ? Os : Jt;
      return !n && Lt(D, "iterate", Zr), S.forEach((K, G) => l.call(d, W(K), W(G), v));
    }
  };
  return Kt(
    a,
    n ? {
      ...
      set(l, d) {
        !i && !Tn(d) && !ei(d) && (d = tt(d));
        const v = tt(this), { has: S, get: D } = po(v);
        let W = S.call(v, l);
        W || (l = tt(l), W = S.call(v, l));
        const K = D.call(v, l);
        return v.set(l, d), W ? mr(d, K) && sr(v, "set", l, d) : sr(v, "add", l, d), this;
      },
      delete(l) {
        const d = tt(this), { has: v, get: S } = po(d);
        let D = v.call(d, l);
        D || (l = tt(l), D = v.call(d, l)), S && S.call(d, l);
        const W = d.delete(l);
...
function Al(n, i, a = ft) {
  const { immediate: u, deep: l, once: d, scheduler: v, augmentJob: S, call: D } = a, W = (pe) => l ? pe : Tn(pe) || l === !1 || l === 0 ? pr(pe, 1) : pr(pe);
  let K, G, re, se, he = !1, de = !1;
  if (Mt(n) ? (G = () => n.value, he = Tn(n)) : Xi(n) ? (G = () => W(n), he = !0) : Ke(n) ? (de = !0, he = n.some((pe) => Xi(pe) || Tn(pe)), G = () => n.map((pe) => {
    if (Mt(pe))
      return pe.value;
    if (Xi(pe))
      return W(pe);
  ...
  const ke = (pe) => {
    if (!(!(K.flags & 1) || !K.dirty && !pe))
      if (i) {
        const Fe = K.run();
        if (l || he || (de ? Fe.some((ie, oe) => mr(ie, ye[oe])) : mr(Fe, ye))) {
          re && re();
          const ie = zr;
          zr = K;
          try {
  ...
  return S && S(ke), K = new wu(G), K.scheduler = v ? () => v(ke, !1) : ke, se = (pe) => Cl(pe, !1, K), re = K.onStop = () => {
    const pe = To.get(K);
    if (pe) {
      if (D)
        D(pe, 4);
...
function Ji(n, i, a, u, l = !1) {
  ...
  const d = u.shapeFlag & 4 ? pa(u.component) : u.el, v = l ? null : d, { i: S, r: D } = n, W = i && i.r, K = S.refs === ft ? S.refs = {} : S.refs, G = S.setupState, re = tt(G), se = G === ft ? () => !1 : (he) => nt(re, he);
  if (W != null && W !== D && (Pt(W) ? (K[W] = null, se(W) && (G[W] = null)) : Mt(W) && (W.value = null)), qe(D))
    uo(D, S, 12, [v, K]);
  else {
    const he = Pt(D), de = Mt(D);
    if (he || de) {
      const Ce = () => {
        if (n.f) {
          const ae = he ? se(D) ? G[D] : K[D] : D.value;
          l ? Ke(ae) && Ws(ae, d) : Ke(ae) ? ae.includes(d) || ae.push(d) : he ? (K[D] = [d], se(D) && (G[D] = K[D])) : (D.value = [d], n.k && (K[n.k] = D.value));
        } else he ? (K[D] = v, se(D) && (G[D] = v)) : de && (D.value = v, n.k && (K[n.k] = v));
      };
...
const Hl = Symbol.for("v-ndc"), Ds = (n) => n ? pc(n) ? pa(n) : Ds(n.parent) : null, eo = (
  ...
  get({ _: n }, i) {
    if (i === "__v_skip")
      return !0;
    const { ctx: a, setupState: u, data: l, props: d, accessCache: v, type: S, appContext: D } = n;
    let W;
    if (i[0] !== "$") {
      const se = v[i];
      if (se !== void 0)
  ...
  has({
    ...
    let S;
    return !!a[v] || n !== ft && nt(n, v) || gs(i, v) || (S = d[0]) && nt(S, v) || nt(u, v) || nt(eo, v) || nt(l.config.globalProperties, v);
  },
...
function Yl(n) {
  ...
  if (Ns = !0, d)
    for (const be in d) {
      const Pe = d[be], et = qe(Pe) ? Pe.bind(a, a) : qe(Pe.get) ? Pe.get.bind(a, a) : Dn, ze = !qe(Pe) && qe(Pe.set) ? Pe.set.bind(a) : Dn, at = Kf({
        get: et,
        set: ze
      });
  ...
  K && Ea(K, n, "c");
  function Ue(be, Pe) {
    Ke(Pe) ? Pe.forEach((et) => be(et.bind(a))) : Pe && be(Pe.bind(a));
  }
  if (Ue(Ml, G), Ue(Po, re), Ue(Kl, se), Ue(ql, he), Ue(Fl, de), Ue(jl, Ce), Ue(Gl, Ee), Ue(Ul, ie), Ue(Vl, oe), Ue(Bl, ye), Ue(ua, pe), Ue($l, B), Ke(it))
    if (it.length) {
  ...
  Fe && n.render === Dn && (n.render = Fe), rt != null && (n.inheritAttrs = rt), Ne && (n.components = Ne), Ge && (n.directives = Ge), B && Vu(n);
}
...
function Wu(n) {
  ...
  let D;
  return S ? D = S : !l.length && !a && !u ? D = i : (D = {}, l.length && l.forEach(
    (W) => Io(D, W, v, !0)
...
function ef(n, i) {
  return function(u, l = null) {
    ...
    const d = Yu(), v = /* @__PURE__ */ new WeakSet(), S = [];
    let D = !1;
    const W = d.app = {
      _uid: Zl++,
      _component: u,
...
function rf(n, i, a, u) {
  ...
  if (
    ...
    for (const G in S)
      ...
      ((K = ti(G)) === G || !nt(i, K))) && (D ? a && // for camelCase
...
function Ju(n, i, a, u) {
  ...
  if (i)
    for (let D in i) {
      ...
      const W = i[D];
      let K;
      l && nt(l, K = vr(D)) ? !d || !d.includes(K) ? a[K] = W : (S || (S = {}))[K] = W : Ko(n.emitsOptions, D) || (!(D in u) || W !== u[D]) && (u[D] = W, v = !0);
    }
  if (d) {
    const D = tt(a), W = S || ft;
...
function Zu(n, i, a = !1) {
  ...
  if (Ke(d))
    ...
    for (const K in d) {
      const G = vr(K);
      if (Aa(G)) {
        const re = d[K], se = v[G] = Ke(re) || qe(re) ? { type: re } : Kt({}, re), he = se.type;
        let de = !1, Ce = !0;
        if (Ke(he))
...
const ca = (n) => n[0] === "_" || n === "$stable", la = (n) => Ke(n) ? n.map(In) : [In(n)], sf = (n, i, a) => {
  ...
  if (u.shapeFlag & 32) {
    const S = i._;
    S ? a && S === 1 ? d = !1 : nc(l, i, a) : (d = !i.$stable, ec(i, l)), v = i;
  } else i && (tc(n, i), v = { default: 1 });
  if (d)
    for (const S in l)
      !ca(S) && v[S] == null && delete l[S];
}, dn = xf;
function cf(n) {
  return lf(n);
}
function lf(n, i) {
  ...
  const {
  ...
  } = n, de = (A, L, Z, I = null, k = null, j = null, V = void 0, M = null, te = !!L.dynamicChildren) => {
    if (A === L)
      return;
    ...
    let Te;
    if (Z && Xr(Z, !1), (Te = xe.onVnodeBeforeUpdate) && An(Te, Z, L, A), me && Qr(L, A, Z, "beforeUpdate"), Z && Xr(Z, !0), (ce.innerHTML && xe.innerHTML == null || ce.textContent && xe.textContent == null) && K(M, ""), Q ? it(
      A.dynamicChildren,
      Q,
      M,
      Z,
    ...
    if (Q > ce) {
      ...
      for (Q = Te; Q <= ce; Q++) {
        ...
        ne === void 0 ? ot(Je, k, j, !0) : ($t[ne - Ie] = Q + 1, ne >= ct ? ct = ne : _t = !0, de(
          Je,
          L[ne],
          Z,
          null,
...
function rc(n, i, a = !1) {
  ...
  if (Ke(u) && Ke(l))
    for (let d = 0; d < u.length; d++) {
      const v = u[d];
      let S = l[d];
      S.shapeFlag & 1 && !S.dynamicChildren && ((S.patchFlag <= 0 || S.patchFlag === 32) && (S = l[d] = fr(l[d]), S.el = v.el), !a && S.patchFlag !== -2 && rc(v, S)), S.type === qo && (S.el = v.el), S.type === ai && !S.el && (S.el = v.el);
    }
}
function df(n) {
  const i = n.slice(), a = [0];
...
function fa(n, i, a = ft) {
  const { immediate: u, deep: l, flush: d, once: v } = a, S = Kt({}, a), D = i && u || !i && d !== "post";
  let W;
  if (so) {
    if (d === "sync") {
      const se = hf();
...
function yf(n, i, a) {
  ...
  const v = co(this), S = fa(l, d.bind(u), a);
  return v(), S;
}
function oc(n, i) {
  const a = i.split(".");
...
function gf(n, i, ...a) {
  ...
  let S, D = u[S = ps(i)] || // also try camelCase event handler (#2249)
  u[S = ps(vr(i))];
  !D && d && (D = u[S = ps(ti(i))]), D && Nn(
    D,
    n,
    6,
    l
...
function sc(n, i, a = !1) {
  ...
  return !d && !S ? (St(n) && u.set(n, null), null) : (Ke(d) ? d.forEach((D) => v[D] = null) : Kt(v, d), St(n) && u.set(n, v), v);
}
function Ko(n, i) {
...
function _f(n, i, a) {
  const { props: u, children: l, component: d } = n, { props: v, children: S, patchFlag: D } = i, W = d.emitsOptions;
  ...
  if (a && D >= 0) {
    ...
    return (l || S) && (!S || !S.$stable) ? !0 : u === v ? !1 : u ? v ? Oa(u, v, W) : !0 : !!v;
  return !1;
}
function Oa(n, i, a) {
...
function dc(n, i = null, a = null, u = 0, l = null, d = n === or ? 0 : 1, v = !1, S = !1) {
  const D = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: n,
  ...
  return S ? (da(D, a), d & 128 && n.normalize(D)) : a && (D.shapeFlag |= Pt(a) ? 8 : 16), oo > 0 && // avoid a block node from tracking itself
...
function Af(n, i = null, a = null, u = 0, l = null, d = !1) {
  ...
  if (Mf(n) && (n = n.__vccOpts), i) {
    ...
    S && !Pt(S) && (i.class = Xs(S)), St(D) && (oa(D) && !Ke(D) && (D = Kt({}, D)), i.style = Qs(D));
  }
...
function ui(n, i, a = !1, u = !1) {
  const { props: l, ref: d, patchFlag: v, children: S, transition: D } = n, W = i ? Of(l || {}, i) : l, K = {
    __v_isVNode: !0,
    __v_skip: !0,
    type: n.type,
    props: W,
    ...
    if (i)
      if (Pt(i))
        for (const v of i.split(";")) {
          const S = v.slice(0, v.indexOf(":")).trim();
          a[S] == null && So(u, S, "");
        }
      else
        for (const v in i)
...
function Ba(n, i, a, u, l) {
  ...
  !d.includes("-")) {
    const S = d === "OPTION" ? n.getAttribute("value") || "" : n.value, D = a == null ? (
      // #11647: value should be set as empty string for null and undefined,
      // but <input type="checkbox"> should be set as 'on'.
      n.type === "checkbox" ? "on" : ""
    ) : String(a);
    (S !== D || !("_value" in n)) && (n.value = D), a == null && n.removeAttribute(i), n._value = a;
    return;
  }
  let v = !1;
  if (a === "" || a == null) {
    const S = typeof n[i];
    S === "boolean" ? a = bu(a) : a == null && S === "string" ? (a = "", v = !0) : S === "number" && (a = 0, v = !0);
  }
  try {
    n[i] = a;
  } catch {
...
function vd() {
  return Ya || (Ya = 1, function(n) {
    (function(i) {
      ...
      K.prototype = Object.create(S.prototype, {
        constructor: {
          value: K
        }
...
Char: ` + P.c), w = new Error(w), P.error = w, rt(P, "onerror", w), P;
      ...
      function Ue(P) {
        return P.sawRoot && !P.closedRoot && be(P, "Unclosed root tag"), P.state !== B.BEGIN && P.state !== B.BEGIN_WHITESPACE && P.state !== B.TEXT && wt(P, "Unexpected end"), Ge(P), P.c = "", P.closed = !0, rt(P, "onend"), u.call(P, P.strict, P.opt), P;
      }
      function be(P, w) {
      ...
      function ze(P) {
        ...
        if (P.opt.xmlns) {
          var w = et(P.attribName, !0), F = w.prefix, $ = w.local;
          if (F === "xmlns")
      ...
      function at(P, w) {
        if (P.opt.xmlns) {
          ...
          for (var A = 0, L = P.attribList.length; A < L; A++) {
            var Z = P.attribList[A], I = Z[0], k = Z[1], j = et(I, !0), V = j.prefix, M = j.local, te = V === "" ? "" : F.ns[V] || "", Q = {
              name: I,
              value: k,
              prefix: V,
              local: M,
...
function wd() {
  return Qa || (Qa = 1, function(n, i) {
    (function(a, u) {
      ...
      var d = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : dd, v = Object.keys, S = Array.isArray;
      function D(e, t) {
 ...
 ` + c : ""), this.inner = c || null) : typeof s == "object" && (this.message = "".concat(s.name, " ").concat(s.message), this.inner = s) : (this.message = ot[t] || r, this.inner = null);
      ...
      var wi = (Ae.prototype._trans = function(e, t, r) {
        ...
        var f = t.reduce(function(h, m) {
          ...
          return [g || h, g || !h ? Ht(_, h && h.multi ? function(y) {
            return y = ie(y, m), S(y) && y.some(function(b) {
              return s(T, b);
            });
          } : function(y) {
            return s(T, ie(y, m));
        ...
        return typeof e != "object" || S(e) ? this.where(":id").equals(e).modify(t) : (e = ie(e, this.schema.primKey.keyPath), e === void 0 ? je(new F.InvalidArgument("Given object does not contain its primary key")) : this.where(":id").equals(e).modify(t));
      ...
      var Wo = (we.prototype._read = function(e, t) {
        ...
        return this._write(function(o) {
          ...
          return t.clone().primaryKeys().then(function(C) {
            function O(R) {
              ...
              return (x ? Promise.resolve([]) : p.getMany({ trans: o, keys: Y, cache: "immutable" })).then(function(U) {
                ...
                return Promise.resolve(0 < H.length && p.mutate({ trans: o, type: "add", values: H }).then(function(Re) {
                  ...
                  return (0 < ee.length || N && x) && p.mutate({ trans: o, type: "delete", keys: ee, criteria: N, isAdditionalChunk: 0 < R }).then(function(Re) {
            ...
            var N = cn(r) && r.limit === 1 / 0 && (typeof e != "function" || x) && { index: r.index, range: r.range };
      ...
      var Ci = (Object.defineProperty(Ve.prototype, "Collection", { get: function() {
        ...
        return C._ondirectionchange = function(O) {
          ...
          for (var q, Y = O.key; x(Y); ) if (++y === _.length) return N(R), !1;
      ...
      function Jo(e, t, m) {
        function o(x) {
          ...
          var y = x.lower, b = x.upper, E = x.lowerOpen, x = x.upperOpen;
          return y === void 0 ? b === void 0 ? null : t.upperBound(b, !!x) : b === void 0 ? t.lowerBound(y, !!E) : t.bound(y, b, !!E, !!x);
        }
        function s(T) {
          var y, b = T.name;
          return { name: b, schema: T, mutate: function(E) {
            var x = E.trans, C = E.type, O = E.keys, N = E.values, R = E.range;
            ...
            return new Promise(function(O, N) {
              O = Oe(O);
              for (var R, q = x.objectStore(b), Y = C.length, U = new Array(Y), H = 0, z = 0, X = function(ge) {
            ...
            return new Promise(function(x, C) {
              ...
              y ? ((U = q ? z.getAll(X, U) : z.getAllKeys(X, U)).onsuccess = function(ee) {
                ...
                var fe = N.result;
                return fe ? (R.push(q ? fe.value : fe.primaryKey), ++O === Y ? x({ result: R }) : void fe.continue()) : x({ result: R });
              }, N.onerror = yt(C));
            });
          }), openCursor: function(E) {
            var x = E.trans, C = E.values, O = E.query, N = E.reverse, R = E.unique;
            return new Promise(function(q, Y) {
              q = Oe(q);
              var z = O.index, U = O.range, H = x.objectStore(b), H = z.isPrimaryKey ? H : H.index(z.name), z = N ? R ? "prevunique" : "prev" : R ? "nextunique" : "next", X = !C && "openKeyCursor" in H ? H.openKeyCursor(o(U), z) : H.openCursor(o(U), z);
            ...
            var x = E.query, C = E.trans, O = x.index, N = x.range;
        ...
        var c, f, p, _ = (f = m, p = Pi((c = e).objectStoreNames), { schema: { name: c.name, tables: p.map(function(T) {
          ...
          var y = T.keyPath, x = T.autoIncrement, b = S(y), E = {}, x = { name: T.name, primaryKey: { name: null, isPrimaryKey: !0, outbound: y == null, compound: b, keyPath: y, autoIncrement: x, unique: !0, extractKey: Or(y) }, indexes: Pi(T.indexNames).map(function(C) {
            return T.index(C);
          }).map(function(R) {
            var O = R.name, N = R.unique, q = R.multiEntry, R = R.keyPath, q = { name: O, compound: S(R), keyPath: R, unique: N, multiEntry: q, extractKey: Or(R) };
            return E[_n(R)] = q;
          }), getIndexByKeyPath: function(C) {
            return E[_n(C)];
          } };
          return E[":id"] = x.primaryKey, y != null && (E[_n(y)] = x.primaryKey), x;
      ...
      function ts(e, t, r, o) {
        ...
        Ot(function() {
          return ne.trans = c, ne.transless = p, t !== 0 ? (Gn(e, r), g = t, ((m = c).storeNames.includes("$meta") ? m.table("$meta").get("version").then(function(_) {
            ...
            return T = _, y = c, b = r, E = [], _ = (h = e)._versions, x = h._dbSchema = Yn(0, h.idbdb, b), (_ = _.filter(function(C) {
              return C._cfg.version >= T;
            })).length !== 0 ? (_.forEach(function(C) {
              E.push(function() {
                var O = x, N = C._cfg.dbschema;
                Qn(h, O, b), Qn(h, N, b), x = h._dbSchema = N;
                var R = Nr(O, N);
      ...
      function is(e) {
        ...
        function p() {
          return new J(function(T, y) {
            ...
            E.onerror = yt(y), E.onblocked = Oe(e._fireOnBlocked), E.onupgradeneeded = Oe(function(x) {
              var C;
              ...
              })) : (_.onerror = yt(y), x = x.oldVersion > Math.pow(2, 62) ? 0 : x.oldVersion, h = x < 1, e.idbdb = E.result, c && ns(e, _), ts(e, x / 10, _, y));
            }, y), E.onsuccess = Oe(function() {
              _ = null;
              var x, C, O, N, R, q = e.idbdb = E.result, Y = ye(q.objectStoreNames);
              if (0 < Y.length) try {
                var U = q.transaction((N = Y).length === 1 ? N[0] : N, "readonly");
                if (t.autoSchema) C = q, O = U, (x = e).verno = C.version / 10, O = x._dbSchema = Yn(0, C, O), x._storeNames = ye(C.objectStoreNames, 0), Hn(x, [x._allTables], v(O), O);
      ...
      var os = { stack: "dbcore", name: "VirtualIndexMiddleware", level: 1, create: function(e) {
        return u(u({}, e), { table: function(t) {
          ...
          function f(h, T, y) {
            var b = _n(h), E = s[b] = s[b] || [], x = h == null ? 0 : typeof h == "string" ? 1 : h.length, C = 0 < T, C = u(u({}, y), { name: C ? "".concat(b, "(virtual-from:").concat(y.name, ")") : y.name, lowLevelIndex: y, isVirtual: C, keyTail: T, keyLength: x, extractKey: Or(h), unique: !C && y.unique });
            return E.push(C), C.isPrimaryKey || c.push(C), 1 < x && f(x === 2 ? h[0] : h.slice(0, x - 1), T + 1, y), E.sort(function(O, N) {
      ...
      var ss = { stack: "dbcore", name: "HooksMiddleware", level: 2, create: function(e) {
        return u(u({}, e), { table: function(t) {
          ...
          return u(u({}, r), { mutate: function(s) {
                  ...
                  return function h(T, y, b) {
                    return r.query({ trans: T, values: !1, query: { index: o, range: y }, limit: b }).then(function(E) {
                      ...
                      return _({ type: "delete", keys: x, trans: T }).then(function(C) {
                        return 0 < C.numFailures ? Promise.reject(C.failures[0]) : x.length < b ? { failures: [], numFailures: 0, lastResult: void 0 } : h(T, u(u({}, y), { lower: x[x.length - 1], lowerOpen: !0 }), b);
                      });
                    });
                  }(s.trans, s.range, 1e4);
                }, !0);
            ...
            return r.mutate(s);
            function _(h) {
              var T, y, b, E = ne.trans, x = h.keys || Ur(o, h);
              if (!x) throw new Error("Keys missing");
              return (h = h.type === "add" || h.type === "put" ? u(u({}, h), { keys: x }) : u({}, h)).type !== "delete" && (h.values = l([], h.values)), h.keys && (h.keys = l([], h.keys)), T = r, b = x, ((y = h).type === "add" ? Promise.resolve([]) : T.getMany({ trans: y.trans, keys: b, cache: "immutable" })).then(function(C) {
                var O = x.map(function(N, R) {
                ...
                return r.mutate(h).then(function(N) {
                  for (var R = N.failures, q = N.results, Y = N.numFailures, N = N.lastResult, U = 0; U < x.length; ++U) {
                    var H = (q || x)[U], z = O[U];
      ...
      var us = { stack: "dbcore", level: 0, name: "Observability", create: function(e) {
        ...
        return u(u({}, e), { transaction: function(o, s, c) {
          ...
          var s = e.table(o), c = s.schema, f = c.primaryKey, h = c.indexes, p = f.extractKey, m = f.outbound, g = f.autoIncrement && h.filter(function(y) {
            ...
            var E, x, C, O = y.trans, N = y.mutatedParts || (y.mutatedParts = {}), R = b(""), q = b(":dels"), Y = y.type, z = y.type === "deleteRange" ? [y.range] : y.type === "delete" ? [y.keys] : y.values.length < 50 ? [Ur(f, y).filter(function(X) {
              return X;
            }), y.values] : [], U = z[0], H = z[1], z = y.trans._cache;
            return S(U) ? (R.addKeys(U), (z = Y === "delete" || U.length === H.length ? Fi(U, z) : null) || q.addKeys(U), (z || H) && (E = b, x = z, C = H, c.indexes.forEach(function(X) {
              var ee = E(X.name || "");
              function fe(le) {
          ...
          return v(T).forEach(function(y) {
            _[y] = function(b) {
              var E = ne.subscr, x = !!E, C = ji(ne, s) && Li(y, b) ? b.obsSet = {} : E;
              if (x) {
                var O = function(H) {
                  return H = "idb://".concat(t, "/").concat(o, "/").concat(H), C[H] || (C[H] = new He());
                }, N = O(""), R = O(":dels"), E = T[y](b), x = E[0], E = E[1];
                if ((y === "query" && x.isPrimaryKey && !b.values ? R : O(x.name || "")).add(E), !x.isPrimaryKey) {
                  if (y !== "count") {
      ...
      function Ki(e, t, T, o, s, c) {
        ...
        var f = t.query.index, p = f.multiEntry, m = t.query.range, g = o.schema.primaryKey.extractKey, _ = f.extractKey, h = (f.lowLevelIndex || f).extractKey, T = T.reduce(function(y, b) {
          ...
          if (b.type === "add" || b.type === "put") for (var C = new He(), O = b.values.length - 1; 0 <= O; --O) {
            ...
            C.hasKey(q) || (N = _(R), (p && S(N) ? N.some(function(X) {
              return Gr(X, m);
            }) : Gr(N, m)) && (C.addKey(q), x.push(R)));
          }
          switch (b.type) {
            case "add":
              var Y = new He().addKeys(t.values ? y.map(function(ee) {
                return g(ee);
              }) : y), E = y.concat(t.values ? x.filter(function(ee) {
              ...
              if (c.abort(), o === "readwrite") {
                for (var g = /* @__PURE__ */ new Set(), _ = 0, h = r; _ < h.length; _++) {
                  ...
                  if (y) {
                    ...
                    if (p._explicit && m && p.mutatedParts) for (var x = 0, C = Object.values(y.queries.query); x < C.length; x++) for (var O = 0, N = (Y = C[x]).slice(); O < N.length; O++) Mr((U = N[O]).obsSet, p.mutatedParts) && (Pe(Y, U), U.subscribers.forEach(function(ee) {
                      return g.add(ee);
                    }));
                    else if (0 < E.length) {
      ...
      var Et = (Le.prototype.version = function(e) {
        ...
        var m = (function g(_, h, T, y, b) {
          return J.resolve().then(function() {
            var E = ne.transless || ne, x = _._createTransaction(h, T, _._dbSchema, y);
            if (x.explicit = !0, E = { trans: x, transless: E }, y) x.idbtrans = y.idbtrans;
            else try {
            ...
            return O && an(), E = J.follow(function() {
              var N;
              (C = b.call(x, x)) && (O ? (N = Dt.bind(null, null), C.then(N, N)) : typeof C.next == "function" && typeof C.throw == "function" && (C = $r(C)));
            }, E), (C && typeof C.then == "function" ? J.resolve(C).then(function(N) {
              return x.active ? N : je(new F.PrematureCommit("Transaction committed too early. See http://bit.ly/2kdckMn"));
            }) : E.then(function() {
              return C;
            })).then(function(N) {
      ...
      function Le(e, t) {
        ...
        g.dbReadyPromise = new J(function(h) {
          ...
          return function(T, y) {
            Le.vip(function() {
              var b, E = r._state;
              E.openComplete ? (E.dbOpenError || J.resolve().then(T), y && h(T)) : E.onReadyBeingFired ? (E.onReadyBeingFired.push(T), y && h(T)) : (h(T), b = r, y || h(function x() {
          ...
          this._ctx = { table: x, index: E.index, isPrimKey: !E.index || x.schema.primKey.keyPath && E.index === x.schema.primKey.name, range: y, keysOnly: !1, dir: "next", unique: "", algorithm: null, filter: null, replayFilter: null, justLimit: !0, isMatch: null, offset: 0, limit: 1 / 0, error: b, or: E.or, valueMapper: C !== L ? C : null };
          ...
          h !== "readonly" && T.forEach(function(C) {
            ...
            var O = x.active;
            return x.active = !1, x.on.error.fire(C), x.parent ? x.parent._reject(C) : O && x.idbtrans && x.idbtrans.abort(), je(C);
          });
        ...
        var t, r = !1, o = new ds(function(s) {
          ...
          var h = !1, T = function() {
            ...
            !p && tr.indexedDB && (m = {}, E = {}, f && f.abort(), f = new AbortController(), C = function(O) {
              ...
              r = !0, t = O, p || x.signal.aborted || (m = {}, function(N) {
      ...
      re(Yt, u(u({}, De), { delete: function(e) {
        ...
        me(e);
      } }, derive: de, extend: D, props: re, override: ke, Events: mn, on: kt, liveQuery: Bi, extendObservabilitySet: zn, getByKeyPath: ie, setByKeyPath: oe, delByKeyPath: function(e, t) {
...
async function yc(n) {
  ...
  const v = l.children.map((W) => W.id), S = await i.table(zt).bulkGet(v);
  Pd({
    childrenRecords: S,
    parentRecord: l
  });
  ...
  for (const d of u)
    if (!(d.name === "xmlns" || d.name.startsWith("xmlns:")))
      if (gd(d)) {
        ...
        const S = d.name.includes(":") && d.name.split(":").pop() || d.name, D = v ? `${v}:${S}` : S;
...
function Ad(n) {
  ...
  for (const S of l)
    d.set(S, []);
  for (const S of a)
    l.has(S.tagName) ? d.get(S.tagName)?.push(S) : v.push(S);
  for (const S of l) {
    const D = d.get(S);
    D && D.length && u.push(...D);
  }
...
function Md(n, i) {
  if (i.endsWith(")")) {
    const [re, se] = Bt(i), [he, de, Ce] = se.substring(1, se.length - 1).split(" ");
    if (!he || !de) return bt;
...
function Hd(n, i) {
  const [a, u] = Bt(i), [l, d, v, S, D, W] = u.split(/[ /]/), [
    K,
    G,
    re,
    se,
...
function Wd(n) {
  ...
  return `${Ct(n.parentElement)}>${W} (${S}${D ? " [" + D + "]" : ""})`;
}
function Yd(n, i) {
  const [a, u] = Bt(i), [l, d, v, S] = u.split(/[ /.]/), D = u.match(/.([A-Z][A-Za-z0-9.]*) ([A-Za-z0-9.]*) \(/), W = D && D[1] ? D[1] : "", K = D && D[2] ? D[2] : "", G = u.match(/\(([A-Z]{2})/), re = u.match(/ \[([0-9]{1,2})\]/), se = G && G[1] ? G[1] : "", he = re && re[1] ? re[1] : "", [
    de,
    Ce,
    ae,
    ye,
...
function Qd(n) {
  ...
  const [
    ...
    "srcLNInst",
    "srcCBName"
  ].map((ke) => n.getAttribute(ke)), ae = Ce ? `${G}:${Ce} ${re ?? ""}/${se ?? ""} ${he ?? ""} ${de ?? ""}` : "", ye = `${a} ${d}/${v ?? ""} ${S} ${D ?? ""} ${W} ${K || ""}`;
...
function Xd(n, i) {
  ...
  if (u.endsWith("]")) {
    ...
    return qt(l, [">"], [n], Pe).map((et) => et.join("")).join(",");
  }
  let d, v, S, D, W, K, G, re, se, he, de, Ce, ae, ye;
  !u.includes(":") && !u.includes("@") ? [d, v, S, D, W, K, G] = u.split(/[ /]/) : u.includes(":") && !u.includes("@") ? [
    re,
    se,
    he,
    de,
    ...
    K,
    G
  ] = u.split(/[ /:]/) : !u.includes(":") && u.includes("@") ? [d, v, S, D, W, K, G, ye] = u.split(/[ /@]/) : [
    re,
    se,
    he,
    de,
...
function Ks(n, i, a = -1) {
  ...
  const [u, l] = Bt(i), [d, v, S, D] = l.match(/([^[]*)(\[([0-9]*)\])?/) ?? [];
  if (!v) return bt;
...
function np(n, i) {
  const [a, u] = Bt(i), [l, d] = u.split(" "), v = parseFloat(d), S = Tt[n].parents.flatMap(
    (K) => jt(K, a).split(",")
  ), [D, W] = [
    l ? [`[sGroup="${l}"]`] : [""],
    v ? [`:nth-child(${v + 1})`] : [""]
  ];
  return qt(S, [">"], [n], D, W).map((K) => K.join("")).join(",");
}
function rp(n) {
...
function up(n, i) {
  const [a, u] = Bt(i), [l] = u.split(" "), d = u && u.match(/\[([0-9]+)\]/) && u.match(/\[([0-9]+)\]/)[1] ? parseFloat(u.match(/\[([0-9]+)\]/)[1]) : NaN, [v, S, D] = [
    Tt[n].parents.flatMap((W) => jt(W, a).split(",")),
    [`[type="${l}"]`],
    d ? [`:nth-child(${d + 1})`] : [""]
  ];
  return qt(v, [">"], [n], S, D).map((W) => W.join("")).join(",");
}
function cp(n) {
...
function dp(n, i) {
  const [a, u] = Bt(i), [l, d] = u.split("	"), [v] = [
    Tt[n].parents.flatMap((S) => jt(S, a).split(","))
  ];
  return qt(v, [">"], [n], [`[type="${l}"]`], [">"], [d]).map((S) => S.join("")).join(",");
}
function pp() {
  return "";
}
...
function Qe(n, i, a = -1) {
  ...
  if (!d) return bt;
  const v = d.flatMap(
    (S) => Tt[S].selector === Tt.Substation.selector ? Qe(S, u, a - 1).split(",") : jt(S, u).split(",")
  ).filter((S) => !S.startsWith(bt));
  return v.length === 0 ? bt : qt(v, [">"], [n], [`[name="${l}"]`]).map((S) => S.join("")).join(",");
}
function _e(n) {
...
function eh({
  ...
  if (i && Object.keys(i).reverse().forEach((d) => {
    ...
    for (const d of Object.entries(i))
      try {
        const [v, S] = d;
        S === null ? n.removeAttribute(v) : n.setAttribute(v, S);
      } catch {
        delete u[d[0]];
      }
  if (a && Object.entries(a).forEach(([d, v]) => {
    Object.keys(v).reverse().forEach((S) => {
      l[d] = {
        ...l[d],
  ...
  for (const [K, G] of Object.entries(l))
    if (G)
      for (const [re, se] of Object.entries(G))
        if (se == null) {
          const de = await fu(K, i), Ce = de ? `${de}:${re}` : re;
          Es(D, Ce) || Es(D, re);
        } else {
          const de = await fu(K, i), Ce = de ? `${de}:${re}` : re, ae = $s(
            Ce,
            se,
            de ? K : void 0,
            de
...
function hh(n) {
  ...
  async function v(ie, oe) {
    const Ee = ie.children?.some((it) => it.id === oe.id), B = oe.parent?.id === ie.id;
...
function wh() {
  return pu || (pu = 1, function(n, i) {
    (function(a, u) {
      ...
      var d = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : Vs, v = Object.keys, S = Array.isArray;
      function D(e, t) {
        return typeof t != "object" || v(t).forEach(function(r) {
          e[r] = t[r];
        }), e;
...
const {
  ...
  setup(n) {
    ...
    function G(ae) {
      ...
      l.commit(ae), a.value += 1, de(a.value), kc(ae, v.value);
    }
    function re(ae) {
      ae.appendChild(
        se(
...
function xh() {
  return yu || (yu = 1, (function() {
    ...
    rt.prototype.define = function(I, k) {
      ...
      wt(k, V, j);
      var M = pe.call(Fe, I), te, Q, me = (Q = (te = M) == null ? void 0 : te.s) != null ? Q : k.formAssociated || de.CustomElementRegistryPolyfill.formAssociated.has(I);
      ...
      ot.push(this), Fe.upgrade.apply(Fe, S(k)), ot.pop();
    ...
    Element.prototype.attachShadow = function(I, k) {
      ...
      return V = I.customElements, V = I.registry === void 0 ? V : I.registry, M = (delete M.customElements, delete M.registry, M), j = at.call.apply(at, [this, M].concat(S(j))), V !== void 0 && (j.customElements = j.registry = V), j;
    };
    var ot = [document];
    function ht(I, k, j) {
    ...
    if (rn(Element), rn(ShadowRoot), Object.defineProperty(window, "customElements", { value: new CustomElementRegistry(), configurable: !0, writable: !0 }), window.ElementInternals && window.ElementInternals.prototype.setFormValue) {
      ...
      HTMLElement.prototype.attachInternals = function(I) {
        ...
        k[I] = function(V) {
          ...
          if (te = It.get(this), ie.get(te).formAssociated === !0) return j?.call.apply(j, [this].concat(S(M)));
      ...
      if (F.prototype = D($.prototype), F.prototype.constructor = F, he) he(F, $);
...
const Eh = /* @__PURE__ */ $u({
  ...
  setup(n) {
    ...
    const l = Lc();
    Po(() => {
      u = i.api.activeFileName.subscribe(async (v, S) => {
        d(v), l.value = v;
    ...
    async function d(v) {
      if (!v)
        return;
      const { xmlDocument: S } = await xd({ databaseName: v });
      a.value = S;
    }
    return (v, S) => (uc(), Cf(Sh, {
      doc: Fu(a),

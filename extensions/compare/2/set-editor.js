...
function Zn(e, t, n, r, i = !1) {
	if (b(e)) {
		e.forEach((e, a) => Zn(e, t && (b(t) ? t[a] : t), n, r, i));
		return;
	}
	if ($n(r) && !i) {
	...
	let a = r.shapeFlag & 4 ? Ea(r.component) : r.el, o = i ? null : a, { i: s, r: c } = e, l = t && t.r, d = s.refs === u ? s.refs = {} : s.refs, f = s.setupState, m = /* @__PURE__ */ W(f), h = f === u ? p : (e) => Yn(d, e) ? !1 : y(m, e), g = (e, t) => !(t && Yn(d, t));
	if (l != null && l !== c) {
		if (Qn(t), T(l)) d[l] = null, h(l) && (f[l] = null);
...
function ar(e, t, n = ua, r = !1) {
	if (n) {
		let i = n[e] || (n[e] = []), a = t.__weh ||= (...r) => {
			Ye();
			let i = ma(n), a = un(t, n, e, r);
			return i(), Xe(), a;
		};
...
var X = (e) => (t, n = ua) => {
	(!_a || e === "sp") && ar(e, (...e) => t(...e), n);
}, or = X("bm"), sr = X("m"), cr = X("bu"), lr = X("u"), ur = X("bum"), dr = X("um"), fr = X("sp"), pr = X("rtg"), mr = X("rtc");
function hr(e, t = ua) {
	ar("ec", e, t);
}
var gr = "components";
function _r(e, t) {
	return yr(gr, e, !0, t) || e;
}
var vr = /* @__PURE__ */ Symbol.for("v-ndc");
function yr(e, t, n = !0, r = !1) {
	let i = On || ua;
	if (i) {
		let n = i.type;
		if (e === gr) {
			let e = Da(n, !1);
			if (e && (e === t || e === O(t) || e === de(O(t)))) return n;
		}
...
var Sr = (e) => e ? ga(e) ? Ea(e) : Sr(e.parent) : null, Cr = /* @__PURE__ */ g(/* @__PURE__ */ Object.create(null), {
	$: (e) => e,
	$el: (e) => e.vnode.el,
	$data: (e) => e.data,
	$props: (e) => e.props,
	...
	$watch: (e) => Vn.bind(e)
}), wr = (e, t) => e !== u && !e.__isScriptSetup && y(e, t), Tr = {
	get({ _: e }, t) {
	...
	set({ _: e }, t, n) {
		...
		return wr(i, t) ? (i[t] = n, !0) : r !== u && y(r, t) ? (r[t] = n, !0) : y(e.props, t) || t[0] === "$" && t.slice(1) in e ? !1 : (a[t] = n, !0);
	},
	has({ _: { data: e, setupState: t, accessCache: n, ctx: r, appContext: i, props: a, type: o } }, s) {
		let c;
		return !!(n[s] || e !== u && s[0] !== "$" && y(e, s) || wr(t, s) || y(a, s) || y(r, s) || y(Cr, s) || y(i.config.globalProperties, s) || (c = o.__cssModules) && c[s]);
	},
...
function Or(e) {
	...
	if (l && kr(l, r, null), o) for (let e in o) {
		let t = o[e];
		w(t) && (r[e] = t.bind(n));
	}
	if (i) {
	...
	if (s) for (let e in s) jr(s[e], r, n, e);
	if (c) {
	...
	if (D(or, d), D(sr, p), D(cr, m), D(lr, h), D(tr, g), D(nr, _), D(hr, te), D(mr, T), D(pr, ee), D(ur, y), D(dr, S), D(fr, ne), b(re)) if (re.length) {
		let t = e.exposed ||= {};
		re.forEach((e) => {
	...
	C && e.render === f && (e.render = C), ie != null && (e.inheritAttrs = ie), ae && (e.components = ae), oe && (e.directives = oe), ne && Jn(e);
}
function kr(e, t, n = f) {
	b(e) && (e = Lr(e));
	for (let n in e) {
...
function jr(e, t, n, r) {
	...
	else if (E(e)) if (b(e)) e.forEach((e) => jr(e, t, n, r));
	else {
...
function Mr(e) {
	...
	return s ? c = s : !i.length && !n && !r ? c = t : (c = {}, i.length && i.forEach((e) => Nr(c, e, o, !0)), Nr(c, t, o)), E(t) && a.set(t, c), c;
}
...
function Br(e, t) {
	return e ? b(e) && b(t) ? [.../* @__PURE__ */ new Set([...e, ...t])] : g(/* @__PURE__ */ Object.create(null), Er(e), Er(t ?? {})) : t;
}
function Vr(e, t) {
	if (!e) return t;
	if (!t) return e;
...
function Wr(e, t) {
	return function(n, r = null) {
		...
		let i = Hr(), a = /* @__PURE__ */ new WeakSet(), o = [], s = !1, c = i.app = {
			...
			mount(a, o, l) {
				if (!s) {
					let u = c._ceVNode || Xi(n, r);
					return u.appContext = i, l === !0 ? l = "svg" : l === !1 && (l = void 0), o && t ? t(u, a) : e(u, a, l), s = !0, c._container = a, a.__vue_app__ = c, Ea(u.component);
				}
			},
			onUnmount(e) {
				o.push(e);
...
var Gr = null, Kr = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${O(t)}Modifiers`] || e[`${ue(t)}Modifiers`];
function qr(e, t, ...n) {
	if (e.isUnmounted) return;
	let r = e.vnode.props || u, i = n, a = t.startsWith("update:"), o = a && Kr(r, t.slice(7));
	...
	try {
		if (n.shapeFlag & 4) {
			...
			v = na(e.length > 1 ? e(d, {
				...
				slots: o,
				emit: c
			}) : e(d, null)), y = t.props ? s : Qr(s);
		}
	} catch (t) {
		zi.length = 0, dn(t, e, 1), v = Xi(Li);
	}
	let b = v;
	if (y && g !== !1) {
		let e = Object.keys(y), { shapeFlag: t } = b;
		e.length && t & 7 && (a && e.some(h) && (y = $r(y, a)), b = $i(b, y, !1, !0));
	}
	return n.dirs && (b = $i(b, null, !1, !0), b.dirs = b.dirs ? b.dirs.concat(n.dirs) : n.dirs), n.transition && Kn(b, n.transition), v = b, An(_), v;
}
var Qr = (e) => {
	let t;
...
function ci(e, t, n, r) {
	...
	if ((r || o > 0) && !(o & 16)) {
		...
		li(e, t, i, a) && (l = !0);
		let r;
		for (let a in s) (!t || !y(t, a) && ((r = ue(a)) === a || !y(t, r))) && (c ? n && (n[a] !== void 0 || n[r] !== void 0) && (i[a] = ui(c, s, a, void 0, e, !0)) : delete i[a]);
...
function li(e, t, n, r) {
	...
	if (t) for (let c in t) {
		if (se(c)) continue;
		let l = t[c], u;
		i && y(i, u = O(c)) ? !a || !a.includes(u) ? n[u] = l : (s ||= {})[u] = l : Xr(e.emitsOptions, c) || (!(c in r) || l !== r[c]) && (r[c] = l, o = !0);
	}
	if (a) {
		let t = /* @__PURE__ */ W(n), r = s || u;
		for (let o = 0; o < a.length; o++) {
			let s = a[o];
			n[s] = ui(i, t, s, r[s], e, !y(r, s));
		}
	}
	return o;
}
...
var mi = (e) => e === "_" || e === "_ctx" || e === "$stable", hi = (e) => b(e) ? e.map(na) : [na(e)], gi = (e, t, n) => {
	if (t._n) return t;
	let r = jn((...e) => hi(t(...e)), n);
	return r._c = !1, r;
}, _i = (e, t, n) => {
	...
	if (e.vnode.shapeFlag & 32) {
		let e = t._;
		e ? (yi(r, t, n), n && me(r, "_", e, !0)) : _i(t, r);
	} else t && vi(e, t);
}, xi = (e, t, n) => {
	let { vnode: r, slots: i } = e, a = !0, o = u;
	if (r.shapeFlag & 32) {
		let e = t._;
		e ? n && e === 1 ? a = !1 : yi(i, t, n) : (a = !t.$stable, _i(t, i)), o = t;
...
function wi(e, t) {
	...
	let { insert: r, remove: i, patchProp: a, createElement: o, createText: s, createComment: c, setText: l, setElementText: p, parentNode: m, nextSibling: h, setScopeId: g = f, insertStaticContent: _ } = e, v = (e, t, n, r = null, i = null, a = null, o = void 0, s = null, c = !!t.dynamicChildren) => {
		if (e === t) return;
		e && !qi(e, t) && (r = j(e), k(e, i, a, !0), e = null), t.patchFlag === -2 && (c = !1, t.dynamicChildren = null);
		...
		if (d = e.el = o(e.type, c, m && m.is, m), h & 8 ? p(d, e.children) : h & 16 && E(e.children, d, null, i, s, Ti(e, c), l, u), _ && Nn(e, null, i, "created"), ee(d, e, e.scopeId, l, i), m) {
			for (let e in m) e !== "value" && !se(e) && a(d, e, null, m[e], c, i);
			"value" in m && a(d, "value", null, m.value, c), (f = m.onVnodeBeforeMount) && oa(f, i, e);
		}
		_ && Nn(e, null, i, "beforeMount");
		let v = Di(s, g);
		v && g.beforeEnter(d), r(d, t, n), ((f = m && m.onVnodeMounted) || v || _) && Si(() => {
			try {
				f && oa(f, i, e), v && g.enter(d), _ && Nn(e, null, i, "mounted");
			} finally {}
		}, s);
	}, ee = (e, t, n, r, i) => {
		...
		for (let l = c; l < e.length; l++) v(null, e[l] = s ? ra(e[l]) : na(e[l]), t, n, r, i, a, o, s);
	}, te = (e, t, n, r, i, o, s) => {
		let c = t.el = e.el, { patchFlag: l, dynamicChildren: d, dirs: f } = t;
		l |= e.patchFlag & 16;
		let m = e.props || u, h = t.props || u, g;
		if (n && Ei(n, !1), (g = h.onVnodeBeforeUpdate) && oa(g, n, t, e), f && Nn(t, e, n, "beforeUpdate"), n && Ei(n, !0), (m.innerHTML && h.innerHTML == null || m.textContent && h.textContent == null) && p(c, ""), d ? ne(e.dynamicChildren, d, c, n, r, Ti(t, i), o) : s || le(e, t, c, null, n, r, Ti(t, i), o, !1), l > 0) {
		...
		((g = h.onVnodeUpdated) || f) && Si(() => {
			g && oa(g, n, t, e), f && Nn(t, e, n, "updated");
		}, r);
	}, ne = (e, t, n, r, i, a, o) => {
		for (let s = 0; s < t.length; s++) {
			let c = e[s], l = t[s];
			v(c, l, c.el && (c.type === Fi || !qi(c, l) || c.shapeFlag & 198) ? m(c.el) : n, null, r, i, a, o, !0);
		}
	}, re = (e, t, n, r, i) => {
		if (t !== n) {
		...
		h && (l = l ? l.concat(h) : h), e == null ? (r(d, n, i), r(f, n, i), E(t.children || [], n, f, a, o, c, l, u)) : p > 0 && p & 64 && m && e.dynamicChildren && e.dynamicChildren.length === m.length ? (ne(e.dynamicChildren, m, n, a, o, c, l), (t.key != null || a && t === a.subTree) && Oi(e, t, !0)) : le(e, t, n, f, a, o, c, l, u);
	}, ae = (e, t, n, r, i, a, o, s, c) => {
		t.slotScopeIds = s, e == null ? t.shapeFlag & 512 ? i.ctx.activate(t, n, r, o, c) : oe(t, n, r, i, a, o, c) : D(e, t, c);
	}, oe = (e, t, n, r, i, a, o) => {
		let s = e.component = la(e, r, i);
		if (er(e) && (s.ctx.renderer = be), va(s, !1, o), s.asyncDep) {
		...
		let s = () => {
			if (e.isMounted) {
				...
				let u = t, d;
				Ei(e, !1), t ? (t.el = c.el, O(e, t, o)) : t = c, n && pe(n), (d = t.props && t.props.onVnodeBeforeUpdate) && oa(d, s, t, c), Ei(e, !0);
				let f = Zr(e), p = e.subTree;
				e.subTree = f, v(p, f, m(p.el), j(p), e, i, a), t.el = f.el, u === null && ri(e, f.el), r && Si(r, i), (d = t.props && t.props.onVnodeUpdated) && Si(() => oa(d, s, t, c), i);
			} else {
				let o, { el: s, props: c } = t, { bm: l, m: u, parent: d, root: f, type: p } = e, m = $n(t);
				if (Ei(e, !1), l && pe(l), !m && (o = c && c.onVnodeBeforeMount) && oa(o, d, t), Ei(e, !0), s && Se) {
					let t = () => {
				...
				(t.shapeFlag & 256 || d && $n(d.vnode) && d.vnode.shapeFlag & 256) && e.a && Si(e.a, i), e.isMounted = !0, t = n = r = null;
			}
		};
		e.scope.on();
		...
		u.i = e, u.id = e.uid, c.scheduler = () => Sn(u), Ei(e, !0), l();
	}, O = (e, t, n) => {
		t.component = e;
		let r = e.vnode.props;
		e.vnode = t, e.next = null, ci(e, t.props, r, n), xi(e, t.children, n), Ye(), Y(e), Xe();
		...
		for (; l <= f && l <= p;) {
			let r = e[l], u = t[l] = c ? ra(t[l]) : na(t[l]);
			if (qi(r, u)) v(r, u, n, null, i, a, o, s, c);
			else break;
			l++;
		}
		for (; l <= f && l <= p;) {
			let r = e[f], l = t[p] = c ? ra(t[p]) : na(t[p]);
			if (qi(r, l)) v(r, l, n, null, i, a, o, s, c);
			else break;
			f--, p--;
		}
		if (l > f) {
			if (l <= p) {
				...
				for (; l <= p;) v(null, t[l] = c ? ra(t[l]) : na(t[l]), n, d, i, a, o, s, c), l++;
			}
		} else if (l > p) for (; l <= f;) k(e[l], i, a, !0), l++;
		else {
			let m = l, h = l, g = /* @__PURE__ */ new Map();
			for (l = h; l <= p; l++) {
				let e = t[l] = c ? ra(t[l]) : na(t[l]);
			...
			for (_ = w.length - 1, l = b - 1; l >= 0; l--) {
				let e = h + l, d = t[e], f = t[e + 1], p = e + 1 < u ? f.el || Mi(f) : r;
		...
		if (a !== 2 && d & 1 && l) if (a === 0) l.beforeEnter(s), r(s, t, n), Si(() => l.enter(s), o);
		else {
		...
		if (d === -2 && (i = !1), s != null && (Ye(), Zn(s, null, n, e, !0), Xe()), p != null && (t.renderCache[p] = void 0), u & 256) {
			t.ctx.deactivate(e);
			return;
		}
		let h = u & 1 && f, g = !$n(e), _;
		if (g && (_ = o && o.onVnodeBeforeUnmount) && oa(_, t, e), u & 6) A(e.component, n, r);
		else {
			if (u & 128) {
				e.suspense.unmount(n, r);
				return;
			}
			h && Nn(e, null, t, "beforeUnmount"), u & 64 ? e.type.remove(e, t, n, be, r) : l && !l.hasOnce && (a !== Fi || d > 0 && d & 64) ? _e(l, t, n, !1, !0) : (a === Fi && d & 384 || !i && u & 16) && _e(c, t, n), r && me(e);
		}
		let v = m != null && p == null;
		(g && (_ = o && o.onVnodeUnmounted) || h || v) && Si(() => {
			_ && oa(_, t, e), h && Nn(e, null, t, "unmounted"), v && (e.el = null);
		}, n);
	}, me = (e) => {
		...
		ji(c), ji(l), r && pe(r), i.stop(), a && (a.flags |= 8, k(o, e, t, n)), s && Si(s, t), Si(() => {
			e.isUnmounted = !0;
		}, t);
...
function Oi(e, t, n = !1) {
	...
	if (b(r) && b(i)) for (let e = 0; e < r.length; e++) {
		let t = r[e], a = i[e];
		a.shapeFlag & 1 && !a.dynamicChildren && ((a.patchFlag <= 0 || a.patchFlag === 32) && (a = i[e] = ra(i[e]), a.el = t.el), !n && a.patchFlag !== -2 && Oi(t, a)), a.type === Ii && (a.patchFlag === -1 && (a = i[e] = ra(a)), a.el = t.el), a.type === Li && !a.el && (a.el = t.el);
	}
}
function ki(e) {
...
var Fi = /* @__PURE__ */ Symbol.for("v-fgt"), Ii = /* @__PURE__ */ Symbol.for("v-txt"), Li = /* @__PURE__ */ Symbol.for("v-cmt"), Ri = /* @__PURE__ */ Symbol.for("v-stc"), zi = [], Bi = null;
function Z(e = !1) {
	zi.push(Bi = e ? null : []);
}
function Vi() {
...
var Ji = ({ key: e }) => e ?? null, Yi = ({ ref: e, ref_key: t, ref_for: n }) => (typeof e == "number" && (e = "" + e), e == null ? null : T(e) || /* @__PURE__ */ K(e) || w(e) ? {
	i: On,
	r: e,
	k: t,
	f: !!n
} : e);
function $(e, t = null, n = null, r = 0, i = null, a = e === Fi ? 0 : 1, o = !1, s = !1) {
	let c = {
		__v_isVNode: !0,
		__v_skip: !0,
		type: e,
	...
	return s ? (ia(c, n), a & 128 && e.normalize(c)) : n && (c.shapeFlag |= T(n) ? 8 : 16), Hi > 0 && !o && Bi && (c.patchFlag > 0 || a & 6) && c.patchFlag !== 32 && Bi.push(c), c;
}
var Xi = Zi;
function Zi(e, t = null, n = null, r = 0, i = null, a = !1) {
	if ((!e || e === vr) && (e = Li), Ki(e)) {
		let r = $i(e, t, !0);
		return n && ia(r, n), Hi > 0 && !a && Bi && (r.shapeFlag & 6 ? Bi[Bi.indexOf(e)] = r : Bi.push(r)), r.patchFlag = -2, r;
	}
	...
	let o = T(e) ? 1 : Ni(e) ? 128 : Wn(e) ? 64 : E(e) ? 4 : w(e) ? 2 : 0;
	return $(e, t, n, r, i, o, a, !0);
}
function Qi(e) {
	return e ? /* @__PURE__ */ Ht(e) || oi(e) ? g({}, e) : e : null;
}
function $i(e, t, n = !1, r = !1) {
	let { props: i, ref: a, patchFlag: o, children: s, transition: c } = e, l = t ? aa(i || {}, t) : i, u = {
		...
		props: l,
		key: l && Ji(l),
		ref: t && t.ref ? n && a ? b(a) ? a.concat(Yi(t)) : [a, Yi(t)] : Yi(t) : a,
		scopeId: e.scopeId,
...
function ta(e = "", t = !1) {
	return t ? (Z(), Gi(Li, null, e)) : Xi(Li, null, e);
}
function na(e) {
	return e == null || typeof e == "boolean" ? Xi(Li) : b(e) ? Xi(Fi, null, e.slice()) : Ki(e) ? ra(e) : Xi(Ii, null, String(e));
}
function ra(e) {
...
function ia(e, t) {
	...
	if (t == null) t = null;
		...
		n = 32;
		let r = t._;
		!r && !oi(t) ? t._ctx = On : r === 3 && On && (On.slots._ === 1 ? t._ = 1 : (t._ = 2, e.patchFlag |= 1024));
	}
	else w(t) ? (t = {
		default: t,
		_ctx: On
	}, n = 32) : (t = String(t), r & 64 ? (n = 16, t = [ea(t)]) : n = 8);
...
function ya(e, t) {
	...
	if (r) {
		Ye();
		let n = e.setupContext = r.length > 1 ? Ta(e) : null, i = ma(e), a = ln(r, e, 0, [e.props, n]), o = te(a);
		if (Xe(), i(), (o || e.sp) && !$n(e) && Jn(e), o) {
...
function ba(e, t, n) {
	w(t) ? e.type.__ssrInlineRender ? e.ssrRender = t : e.render = t : E(t) && (e.setupState = Jt(t)), Ca(e, n);
}
var xa, Sa;
function Ca(e, t, n) {
	let r = e.type;
	if (!e.render) {
		if (!t && xa && !r.render) {
			let t = r.template || Mr(e).template;
			if (t) {
...
var ka = (e, t) => /* @__PURE__ */ tn(e, t, _a), Aa = "3.5.32", ja = void 0, Ma = typeof window < "u" && window.trustedTypes;
if (Ma) try {
...
function Ga(e, t, n) {
	...
	if (n && !i) {
		...
		for (let e in n) e === "display" && (a = !0), qa(r, e, n[e]);
	} else if (i) {
		if (t !== n) {
			let e = r[Ua];
...
var Ka = /\s*!important$/;
function qa(e, t, n) {
	if (b(n)) n.forEach((n) => qa(e, t, n));
	else if (n ??= "", t.startsWith("--")) e.setProperty(t, n);
	else {
		let r = Xa(e, t);
		Ka.test(n) ? e.setProperty(ue(r), n.replace(Ka, ""), "important") : e[r] = n;
	}
}
var Ja = [
	"Webkit",
...
function Qa(e, t, n, r, i, a = Ce(t)) {
	r && t.startsWith("xlink:") ? n == null ? e.removeAttributeNS(Za, t.slice(6, t.length)) : e.setAttributeNS(Za, t, n) : n == null || a && !we(n) ? e.removeAttribute(t) : e.setAttribute(t, a ? "" : ee(n) ? String(n) : n);
}
...
function ro(e, t, n, r, i = null) {
	...
	if (r && o) o.value = r;
		...
		let [n, s] = ao(t);
		r ? eo(e, n, a[t] = lo(r, i), s) : o && (to(e, n, o, s), a[t] = void 0);
	}
}
...
var oo = 0, so = /* @__PURE__ */ Promise.resolve(), co = () => oo ||= (so.then(() => oo = 0), Date.now());
function lo(e, t) {
	let n = (e) => {
		if (!e._vts) e._vts = Date.now();
		else if (e._vts <= n.attached) return;
		un(uo(e, n.value), t, 5, [e]);
	};
...
var fo = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, po = (e, t, n, r, i, a) => {
	let o = i === "svg";
	t === "class" ? Ba(e, r, o) : t === "style" ? Ga(e, n, r) : m(t) ? h(t) || ro(e, t, n, r, a) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : mo(e, t, r, o)) ? ($a(e, t, r), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && Qa(e, t, r, o, a, t !== "value")) : e._isVueCE && (ho(e, t) || e._def.__asyncLoader && (/[A-Z]/.test(t) || !T(r))) ? $a(e, O(t), r, a, t) : (t === "true-value" ? e._trueValue = r : t === "false-value" && (e._falseValue = r), Qa(e, t, r, o));
};
function mo(e, t, n, r) {
	if (r) return !!(t === "innerHTML" || t === "textContent" || t in e && fo(t) && w(n));
	if (t === "spellcheck" || t === "draggable" || t === "translate" || t === "autocorrect" || t === "sandbox" && e.tagName === "IFRAME" || t === "form" || t === "list" && e.tagName === "INPUT" || t === "type" && e.tagName === "TEXTAREA") return !1;
	if (t === "width" || t === "height") {
		let t = e.tagName;
		if (t === "IMG" || t === "VIDEO" || t === "CANVAS" || t === "SOURCE") return !1;
	}
	return fo(t) && T(n) ? !1 : t in e;
}
function ho(e, t) {
	let n = e._def.props;
	if (!n) return !1;
...
var xo = {
	created(e, { modifiers: { lazy: t, trim: n, number: r } }, i) {
		...
		}), t || (eo(e, "compositionstart", _o), eo(e, "compositionend", vo), eo(e, "change", vo));
	},
	mounted(e, { value: t }) {
		e.value = t ?? "";
	},
...
}, So = /* @__PURE__ */ g({ patchProp: po }, Ra), Co;
function wo() {
	return Co ||= Ci(So);
}
var To = ((...e) => {
...
function $o(e, t) {
	...
	for (let n in t) {
		...
		let r = t[n], i = e[n];
		Mo(i) && Mo(r) && e.hasOwnProperty(n) && !/* @__PURE__ */ K(r) && !/* @__PURE__ */ Bt(r) ? e[n] = $o(i, r) : e[n] = r;
	}
	return e;
}
var es = Symbol();
...
function is(e, t, n, r) {
	...
	function l() {
		return s || (n.state.value[e] = i ? i() : {}), ns(/* @__PURE__ */ Yt(n.state.value[e]), a, Object.keys(o || {}).reduce((t, r) => (t[r] = Ut(ka(() => {
			Ao(n);
			let t = n._s.get(e);
			return o[r].call(t, t);
		})), t), {}));
...
function as(e, t, n = {}, r, i, a) {
	...
	let v = (t, n = "") => {
		...
		$reset: g,
		$subscribe(t, n = {}) {
			let i = Jo(d, t, n.detached, () => a()), a = o.run(() => zn(() => r.state.value[e], (r) => {
				(n.flush === "sync" ? u : l) && t({
					storeId: e,
					type: No.direct,
					events: void 0
	...
	r._s.set(e, y);
	let b = (r._a && r._a.runWithContext || Xo)(() => r._e.run(() => (o = Me()).run(() => t({ action: v }))));
	for (let t in b) {
		let n = b[t];
		/* @__PURE__ */ K(n) && !rs(n) || /* @__PURE__ */ Bt(n) ? a || (p && ts(n) && (/* @__PURE__ */ K(n) ? n.value = p[t] : $o(n, p[t])), r.state.value[e][t] = n) : typeof n == "function" && (b[t] = v(n, t), s.actions[t] = n);
	}
	return ns(y, b), ns(/* @__PURE__ */ W(y), b), Object.defineProperty(y, "$state", {
		get: () => r.state.value[e],
		set: (e) => {
			h((t) => {
				ns(t, e);
...
function os(e, t, n) {
	...
	function a(n, a) {
		let o = In();
		return n ||= o ? Fn(jo, null) : null, n && Ao(n), n = ko, n._s.has(e) || (i ? as(e, t, r, n) : is(e, r, n)), n._s.get(e);
	}
	return a.$id = e, a;
}
function ss(e) {
...
//#endregion
//#region src/file-slots/file-slot.store.ts
var cs = "compare:slot:base", ls = "compare:slot:compare";
function us(e) {
	return e === "base" ? cs : ls;
}
function ds(e) {
	try {
		let t = localStorage.getItem(us(e));
...
function fs(e, t) {
	t ? localStorage.setItem(us(e), JSON.stringify(t)) : localStorage.removeItem(us(e));
}
var ps = os("compare/file-slots", () => {
	let e = /* @__PURE__ */ q(ds("base")), t = /* @__PURE__ */ q(ds("compare")), n = /* @__PURE__ */ q(null), r = /* @__PURE__ */ q(null);
	function i(i, a) {
		i === "base" ? (e.value = a, n.value = null) : (t.value = a, r.value = null), fs(i, a);
	}
	function a(i) {
		i === "base" ? (e.value = null, n.value = null) : (t.value = null, r.value = null), fs(i, null);
	}
	function o(e, t) {
...
})))(), 1), hs = Symbol.for("Dexie"), gs = globalThis[hs] || (globalThis[hs] = ms.default);
if (ms.default.semVer !== gs.semVer) throw Error(`Two different versions of Dexie loaded in the same app: ${ms.default.semVer} and ${gs.semVer}`);
var { liveQuery: _s, mergeRanges: vs, rangesOverlap: ys, RangeSet: bs, cmp: xs, Entity: Ss, PropModification: Cs, replacePrefix: ws, add: Ts, remove: Es, DexieYProvider: Ds } = gs, Os = Object.create, ks = Object.defineProperty, As = Object.getOwnPropertyDescriptor, js = Object.getOwnPropertyNames, Ms = Object.getPrototypeOf, Ns = Object.prototype.hasOwnProperty, Ps = (e, t) => () => (t || e((t = { exports: {} }).exports, t), t.exports), Fs = (e, t, n, r) => {
	if (t && typeof t == "object" || typeof t == "function") for (var i = js(t), a = 0, o = i.length, s; a < o; a++) s = i[a], !Ns.call(e, s) && s !== n && ks(e, s, {
		get: ((e) => t[e]).bind(null, s),
		enumerable: !(r = As(t, s)) || r.enumerable
	});
	return e;
}, Is = (e, t, n) => (n = e == null ? {} : Os(Ms(e)), Fs(t || !e || !e.__esModule ? ks(n, "default", {
	value: e,
	enumerable: !0
}) : n, e)), Ls = /* @__PURE__ */ Ps(((e, t) => {
	t.exports = {};
})), Rs = /* @__PURE__ */ Is((/* @__PURE__ */ Ps(((e) => {
	(function(e) {
...
function Vs(e) {
	...
	for (let [e, t] of n.entries()) {
		let r = zs[t.id] || [];
		r.length > 0 && (n[e].children.push(...r), Hs({ parentId: t.id }));
	}
	return n;
}
function Hs(e) {
...
var Ws = [
	...
	".icd",
	".xml"
], Gs = "sclElements", Ks = "id, tagName, [id+tagName], parent.id, parent.tagName, *children.id, *children.tagName", qs = "attachedFiles", Js = "id, filename, file", Ys = {
	default: {
		prefix: "",
...
`${Ys.default.uri}`, `${Ys.v2019C1.uri}`;
var Xs = "db-id";
`${Ys.test.prefix}${Ys.test.uri}`;
var Zs = `${Ys.test.prefix}:${Xs}`, Qs = {
	AccessControl: {},
	AccessPoint: {
		clock: "",
		desc: "",
...
function ec(e) {
	...
	i.onopentag = (e) => r = tc({
		...
		text: e,
		state: r
	}), i.onclosetag = () => ({updatedState: r} = rc({
		state: r,
		hooks: n
	})), i.onerror = ic;
	function a() {
...
function tc(e) {
	let { node: t, state: n, useTestIds: r } = e, i = { ...n }, a = ac(t);
	i.defaultNamespace ||= oc(t);
	let o = sc(t, i.defaultNamespace), s = {
		id: uc({
...
function uc(e) {
	let { attributes: t, useTestIds: n } = e, r = t[Zs];
	return n && r && r.value ? r.value : crypto.randomUUID();
}
function dc(e) {
	let { attributes: t, useTestIds: n } = e;
	return n ? Object.values(t).filter((e) => e.name !== Zs) : Object.values(t);
}
function fc(e) {
	let { currentTagName: t, attributes: n } = e, r = n, i = $s.find((e) => e === t), a = n.some((e) => e.name === "uuid");
	if (i && !a) {
...
function mc(e) {
	...
	let i = pc(t);
	return i && r.push(i), r.length === 0 ? null : xc(r);
}
function hc() {
	return () => null;
}
...
function _c() {
	return (e) => {
		let t = bc(e, "lnClass");
		return t ? {
			segment: `${bc(e, "prefix") ?? ""}${t}${bc(e, "inst") ?? bc(e, "lnInst") ?? ""}`,
			separator: "/"
		} : null;
	};
}
...
var yc = {
	...
	ExtCtrl: vc("intAddr", "."),
	SourceRef: vc("input", "."),
	ControlRef: vc("output", "."),
	Substation: gc(),
	VoltageLevel: gc(),
	Bay: gc(),
	ConductingEquipment: gc(),
	PowerTransformer: gc(),
	TransformerWinding: gc(),
	GeneralEquipment: gc(),
	SubEquipment: gc(),
	LNode: _c(),
	Function: gc(),
	...
	EqSubFunction: gc(),
	AllocationRole: gc(),
	BehaviorDescription: gc(),
	FunctionCategory: gc(),
	SubCategory: gc(),
	FunctionalVariant: gc(),
	FunctionalSubVariant: gc(),
	ProcessResource: gc(),
	PowerSystemRelation: gc(),
	Variable: gc(),
	Process: gc()
};
function bc(e, t) {
...
function Cc(e, t) {
	return Sc[e]?.find((e) => e.attribute.path === t)?.resolution ?? null;
}
function wc(e, t, n, r) {
	let i = Cc(e, t);
	...
	return i === "lnode" ? Tc(n) : i === "behavior-description" ? Ec(t, n, r) : null;
}
function Tc(e) {
...
function Ec(e, t, n) {
	...
	return r ? e === "dataName" ? {
		lookupKey: r,
		qualifier: t
	} : e === "inputName" || e === "outputName" ? { lookupKey: `${r}.${Oc(t)}` } : null : null;
}
function Dc(e) {
	let t = -1;
...
function Ac() {
	...
	return {
		beforeImportRecord: (r) => {
			let { record: i, ancestry: a } = r, { tagName: o } = i, s = Pc(i);
			if (s && Nc.has(o)) {
				let t = mc({
					record: i,
					ancestry: a
			...
			for (let e of c) {
				...
				let s = wc(o, e.attribute.path, r, a);
				if (!s) {
					Cc(o, e.attribute.path) === "unsupported" && n.push({
...
var jc = new Set(Object.entries(Qs).filter(([, e]) => "uuid" in e).map(([e]) => e)), Mc = new Set(Object.keys(Sc)), Nc = new Set(Object.values(Sc).flatMap((e) => e.flatMap((e) => e.target)));
function Pc(e) {
	if (!jc.has(e.tagName)) return;
...
var Fc = /* @__PURE__ */ Is((/* @__PURE__ */ Ps(((e, t) => {
	(function(n, r) {
		typeof e == "object" && t !== void 0 ? t.exports = r() : typeof define == "function" && define.amd ? define(r) : (n = typeof globalThis < "u" ? globalThis : n || self).Dexie = r();
	})(e, function() {
		var e = function(t, n) {
...
})))(), 1), Ic = Symbol.for("Dexie"), Lc = globalThis[Ic] || (globalThis[Ic] = Fc.default);
if (Fc.default.semVer !== Lc.semVer) throw Error(`Two different versions of Dexie loaded in the same app: ${Fc.default.semVer} and ${Lc.semVer}`);
var { liveQuery: Rc, mergeRanges: zc, rangesOverlap: Bc, RangeSet: Vc, cmp: Hc, Entity: Uc, PropModification: Wc, replacePrefix: Gc, add: Kc, remove: qc, DexieYProvider: Jc } = Lc, Yc = class extends Lc {
	constructor(...e) {
		super(...e), this.upgrade();
	}
	async upgrade() {
		if (this.isOpen()) {
			this.close(), Xc(this), await this.open();
			return;
		}
		Xc(this);
	}
...
function Xc(e) {
	return e.version(1).stores({ [Gs]: Ks }), e.version(2).stores({
		[Gs]: Ks,
		[qs]: Js
		...
		e.table(qs).toCollection().modify((e) => {
			typeof e.file == "string" && (e.file = new Blob([e.file], { type: "text/xml" }));
		});
	}), e;
}
async function Zc(e) {
	let { databaseInstance: t, records: n } = e, r = t.table(Gs);
...
async function $c(e) {
	if (await Lc.exists(e)) return await Lc.delete(e);
}
var el = {
	useBrowserApi: !0,
	chunkSize: 32 * 1024,
...
async function nl(e) {
	let { files: t, options: n, isForTest: r } = e, i = Ac(), a = {
		...el,
		...n
	}, o = [];
...
function rl(e) {
	return Ws.some((t) => e.name.toLowerCase().endsWith(t));
}
function il(e) {
...
async function al(e) {
	...
	try {
		...
		await $c(e);
		let a = new Yc(e);
		n.useBrowserApi && t.size !== 0 && await ol({
			file: t,
			databaseInstance: a,
			options: {
				useTestIds: r,
...
async function cl(e) {
	...
	n.getSize() >= r && await Zc({
		databaseInstance: t,
		records: Vs({ currentBatch: n.drainBatch() })
	});
}
...
async function ul(e) {
	let t = new gs(e);
	await t.open();
	let n = await t.table(Gs).toArray();
	return {
...
var fl = new Set([
	...
	"DAType",
	"EnumType"
]), pl = new Set(/* @__PURE__ */ "Substation.VoltageLevel.Bay.PowerTransformer.TransformerWinding.TapChanger.NeutralPoint.GeneralEquipment.ConductingEquipment.EqFunction.EqSubFunction.ConnectivityNode.IED.AccessPoint.LN.LN0.Server.LDevice.Function.SubFunction.FunctionTemplate.SubFunctionTemplate.Application.AllocationRole.SubNetwork.DataSet.GSEControl.SampledValueControl.ReportControl.LogControl.Log.GOOSESecurity.SMVSecurity.Line.Process.SubCategory.FunctionCategory.FunctionRole.SignalRole.ProcessResource.Project.BehaviorDescription.Variable.DO.DA.BDA.SDO.DOI.DAI.SDI.SDS.DAS.DOS.GSE.SMV.P.Label".split("."));
function ml(e) {
	let t = e.tagName;
	if (t === "LN" || t === "LN0") return `${t}:${dl(e, "prefix")}${dl(e, "lnClass")}${dl(e, "inst")}`;
	if (t === "LNode") return `${t}:${dl(e, "prefix")}${dl(e, "lnClass")}${dl(e, "lnInst")}`;
	if (t === "LDevice") return `${t}:${dl(e, "inst")}`;
	if (t === "ConnectedAP") return `${t}:${dl(e, "iedName")}:${dl(e, "apName")}`;
	if (t === "FCDA") {
		let n = dl(e, "ldInst"), r = dl(e, "lnClass");
		return `${t}:${n}:${dl(e, "prefix")}${r}${dl(e, "lnInst")}.${dl(e, "doName")}.${dl(e, "daName")}`;
	}
	if (t === "EnumVal") {
		let n = dl(e, "ord");
		if (n) return `${t}:${n}`;
...
function Cl(e) {
	return vl.has(e) ? "substation" : yl.has(e) ? "ied" : bl.has(e) ? "templates" : xl.has(e) ? "communication" : Sl.has(e) ? "dataflow" : "other";
}
var wl = new Set([
	"uuid",
	"templateUuid",
...
function Tl(e, t) {
	let n = new Map(e.attributes.filter((e) => !wl.has(e.name)).map((e) => [e.name, e.value])), r = new Map(t.attributes.filter((e) => !wl.has(e.name)).map((e) => [e.name, e.value])), i = [], a = new Set([...n.keys(), ...r.keys()]);
	for (let e of a) {
...
function Ol(e, t) {
	...
	for (let t of e.values()) r.set(ml(t), t);
	for (let e of t.values()) i.set(ml(e), e);
	let a = Dl(El([...e.values()]), El([...t.values()])), o = new Set([...r.keys(), ...i.keys()]);
	for (let s of o) {
...
var kl = os("compare/global", () => {
	let e = /* @__PURE__ */ q([]), t = /* @__PURE__ */ q(!1), n = /* @__PURE__ */ q(null), r = /* @__PURE__ */ q(!1), i = ps(), a = ka(() => i.base !== null && i.compare !== null), o = ka(() => ({
	...
	async function s() {
		...
		let s = null, c = null;
		try {
			let [t, n] = await Promise.all([ul(a.dbName), ul(o.dbName)]);
			s = t.db, c = n.db, e.value = Ol(t.records, n.records), r.value = !0;
		} catch (e) {
...
}), Al = os("compare/changelog", () => {
	let e = kl(), t = /* @__PURE__ */ q(!0), n = /* @__PURE__ */ q(!0), r = /* @__PURE__ */ q(!0), i = /* @__PURE__ */ q("all"), a = /* @__PURE__ */ q(null), o = ka(() => e.diffEntries.filter((e) => {
	...
	let e = kl(), t = Al(), n = /* @__PURE__ */ q("substation"), r = /* @__PURE__ */ q(!1), i = /* @__PURE__ */ q(!1), a = /* @__PURE__ */ q(!1), o = ka(() => {
...
}), Ml = { class: "flex items-center gap-3 border border-base-300 rounded-lg px-3 py-2 bg-base-100 w-64 min-w-0" }, Nl = { class: "flex flex-col min-w-0 flex-1" }, Pl = ["title"], Fl = /* @__PURE__ */ qn({
	__name: "file-slot-card",
	props: { slot: {} },
	emits: ["clear"],
	setup(e, { emit: t }) {
		let n = e, r = t, i = ka(function() {
			let e = n.slot.displayName.toUpperCase();
			for (let t of [
				"SSD",
				"ASD",
				"SCD",
				...
				"FSD",
				"ISD"
			]) if (e.endsWith(`.${t}`)) return t;
			return "SCL";
		}), a = ka(function() {
			switch (i.value) {
				case "SCD": return "bg-violet-500";
				case "SSD": return "bg-blue-500";
				case "ASD": return "bg-teal-500";
				default: return "bg-slate-500";
			}
		});
		return (t, n) => (Z(), Q("div", Ml, [
			$("span", { class: xe(["text-xs font-bold rounded px-2 py-1 text-white flex-shrink-0 uppercase", a.value]) }, M(i.value), 3),
			$("div", Nl, [$("span", {
				class: "text-sm font-medium truncate leading-snug",
				title: e.slot.displayName
			}, M(e.slot.displayName), 9, Pl)]),
			$("button", {
				class: "text-base-content/30 hover:text-base-content/70 flex-shrink-0 text-lg leading-none",
				title: "Remove",
				onClick: n[0] ||= (e) => r("clear")
			}, " × ")
		]));
	}
}), Il = { class: "modal-box max-w-md" }, Ll = {
	key: 0,
	class: "text-center py-6"
}, Rl = { class: "btn btn-primary btn-sm gap-2 cursor-pointer" }, zl = {
	key: 1,
	class: "flex flex-col gap-1 max-h-64 overflow-y-auto mb-4"
}, Bl = ["onClick"], Vl = { class: "text-xs font-mono bg-base-300 rounded px-1" }, Hl = { class: "truncate flex-1 text-left" }, Ul = {
	key: 0,
	class: "badge badge-xs badge-primary"
}, Wl = {
	key: 2,
	class: "border-t border-base-300 pt-3"
}, Gl = { class: "btn btn-sm btn-ghost w-full gap-2 cursor-pointer" }, Kl = { class: "modal-action" }, ql = ".ssd,.asd,.scd,.iid,.icd,.fsd,.isd,.xml", Jl = /* @__PURE__ */ qn({
	...
	emits: ["select", "close"],
	setup(e, { emit: t }) {
		let n = t, r = /* @__PURE__ */ q([]);
		sr(async function() {
			try {
				let e = await indexedDB.databases?.();
				e && (r.value = e.filter((e) => e.name && !e.name.startsWith("_")).sort((e, t) => e.name.localeCompare(t.name)));
			} catch {}
		});
		function i(e) {
			let t = e.toUpperCase();
			for (let e of [
				...
				"FSD",
				"ISD"
			]) if (t.endsWith(`.${e}`) || t.endsWith(`_${e}`)) return e;
			return "SCL";
		}
		function a(e) {
			n("select", {
		...
		async function o(e) {
			...
			if (r) {
				try {
					await tl({ files: [r] }), n("select", {
						dbName: il(r),
						displayName: r.name
					});
				} catch (e) {
					console.error("Failed to import SCL file", e);
				}
				t.value = "";
			}
		}
		return (t, s) => (Z(), Q("dialog", { class: xe(["modal", { "modal-open": e.isOpen }]) }, [$("div", Il, [
			s[7] ||= $("h3", { class: "font-bold text-lg mb-4" }, "Select SCL File", -1),
			r.value.length === 0 ? (Z(), Q("div", Ll, [s[4] ||= $("p", { class: "text-sm text-base-content/50 mb-4" }, "No SCL files loaded in this browser.", -1), $("label", Rl, [
				s[2] ||= $("span", null, "📂", -1),
				s[3] ||= ea(" Upload new file… ", -1),
				$("input", {
					type: "file",
					class: "hidden",
					accept: ql,
			...
			])])) : (Z(), Q("div", zl, [(Z(!0), Q(Fi, null, xr(r.value, (t) => (Z(), Q("button", {
				key: t.name,
				class: xe(["btn btn-sm btn-ghost justify-start gap-2", { "btn-active": t.name === e.activeFileName }]),
				onClick: (e) => a(t.name)
			}, [
				$("span", Vl, M(i(t.name)), 1),
				$("span", Hl, M(t.name), 1),
				t.name === e.activeFileName ? (Z(), Q("span", Ul, "active")) : ta("", !0)
			], 10, Bl))), 128))])),
			r.value.length > 0 ? (Z(), Q("div", Wl, [$("label", Gl, [
				s[5] ||= $("span", null, "📂", -1),
				s[6] ||= ea(" Upload new file… ", -1),
				$("input", {
					type: "file",
					class: "hidden",
					accept: ql,
...
}), Yl = os("compare/inspector", () => {
	let e = kl(), t = /* @__PURE__ */ q(null), n = ka(() => t.value ? e.diffEntries.find((e) => e.identity === t.value) ?? null : null);
	function r(e) {
		t.value = e;
	}
	function i() {
...
}, Zl = { class: "px-3 pt-2 pb-1 border-b border-base-300" }, Ql = { class: "flex items-center gap-1 flex-wrap" }, $l = ["data-testid", "onClick"], eu = { class: "flex items-center gap-1 mt-1" }, tu = { class: "flex items-center gap-2 px-3 py-2 border-b border-base-300 flex-wrap" }, nu = { class: "flex items-center gap-1 cursor-pointer text-xs whitespace-nowrap" }, ru = ["checked"], iu = { class: "flex items-center gap-2 px-3 py-1 border-b border-base-300" }, au = { class: "flex items-center gap-1 cursor-pointer text-xs" }, ou = ["checked"], su = {
	...
	key: 1,
	class: "text-sm text-base-content/40 px-4 py-4"
}, uu = ["data-testid", "onClick"], du = { class: "flex flex-col min-w-0 flex-1" }, fu = { class: "text-sm font-medium truncate" }, pu = { class: "text-xs text-base-content/40 font-mono truncate" }, mu = { class: "flex items-center gap-1 flex-shrink-0" }, hu = {
	key: 0,
	...
	__name: "compare-tree",
	setup(e) {
		let t = jl(), n = kl(), r = Yl(), i = Al(), { activeTab: a, changedOnly: o, expandChanges: s, showDataflowOverlay: c, entriesForTab: l } = ss(t), { hasCompared: u } = ss(n), { selectedIdentity: d } = ss(r), f = /* @__PURE__ */ q(""), p = [
			{
				id: "substation",
				label: "Substation"
			},
		...
		return (e, t) => (Z(), Q("div", Xl, [
			$("div", Zl, [$("div", Ql, [(Z(), Q(Fi, null, xr(p, (e) => $("button", {
				key: e.id,
				...
				onClick: (t) => h(e.id)
			}, M(e.label), 11, $l)), 64))]), $("div", eu, [$("button", {
			...
			$("div", tu, [
				...
				$("label", nu, [$("input", {
					...
					onChange: g
				}, null, 40, ru), t[2] ||= ea(" Changed only ", -1)]),
				$("button", {
			...
			$("div", iu, [$("button", {
				...
				onClick: y
			}, " Collapse "), $("label", au, [$("input", {
				type: "checkbox",
				class: "checkbox checkbox-xs",
				checked: J(c),
				"data-testid": "checkbox-dataflow-overlay",
				onChange: v
			}, null, 40, ou), t[3] ||= ea(" Dataflow overlay ", -1)])]),
			$("div", su, [J(u) ? m.value.length === 0 ? (Z(), Q("p", lu, "No changes in this section.")) : (Z(!0), Q(Fi, { key: 2 }, xr(m.value, (e) => (Z(), Q("div", {
				key: e.identity,
				...
				$("span", { class: xe(["w-2 h-2 rounded-full flex-shrink-0", x(e.kind)]) }, null, 2),
				$("div", du, [$("span", fu, M(b(e)), 1), $("span", pu, M(e.identity.substring(0, 24)), 1)]),
				$("div", mu, [e.kind === "added" || S(e).added > 0 ? (Z(), Q("span", hu, " +" + M(e.kind === "added" ? 1 : S(e).added), 1)) : ta("", !0), e.kind === "removed" || S(e).removed > 0 ? (Z(), Q("span", gu, " −" + M(e.kind === "removed" ? 1 : S(e).removed), 1)) : ta("", !0)]),
				e.orderChanged ? (Z(), Q("span", _u, "⇅")) : ta("", !0)
			], 10, uu))), 128)) : (Z(), Q("p", cu, " Load files and run Compare to see the tree. "))])
		]));
	}
}), yu = ["data-testid"], bu = { class: "min-w-0 flex-1" }, xu = { class: "text-sm font-medium truncate" }, Su = { class: "text-base-content/50 font-normal" }, Cu = { class: "text-xs text-base-content/40 font-mono truncate mt-0.5" }, wu = {
	key: 0,
	...
	setup(e, { emit: t }) {
		...
		return (t, n) => (Z(), Q("div", {
			...
			$("div", bu, [$("p", xu, [$("span", Su, M(e.entry.tagName) + ":", 1), ea(" " + M(i.value), 1)]), $("p", Cu, M(e.entry.path), 1)]),
			e.entry.orderChanged ? (Z(), Q("span", wu, "⇅")) : ta("", !0)
		], 10, yu));
	}
}), Eu = {
	class: "flex flex-col h-full overflow-hidden",
	"data-testid": "changelog"
}, Du = { class: "flex items-start justify-between px-4 pt-3 pb-2" }, Ou = { class: "text-xs text-base-content/50 mt-0.5" }, ku = {
	key: 0,
	...
	key: 1,
	class: "text-sm text-base-content/40 px-4 py-4"
}, Fu = { class: "px-4 py-2 text-xs font-bold uppercase tracking-wider text-base-content/50 bg-base-100/50" }, Iu = { class: "px-4 py-2 text-xs font-bold uppercase tracking-wider text-base-content/50 bg-base-100/50" }, Lu = { class: "px-4 py-2 text-xs font-bold uppercase tracking-wider text-base-content/50 bg-base-100/50" }, Ru = /* @__PURE__ */ qn({
	__name: "changelog",
	setup(e) {
		let t = Al(), n = kl(), r = Yl(), { showRemoved: i, showAdded: a, showChanged: o, filtered: s } = ss(t), { hasCompared: c } = ss(n), { selectedIdentity: l } = ss(r), u = /* @__PURE__ */ q("path"), d = ka(function() {
		...
		return (e, t) => (Z(), Q("div", Eu, [
			$("div", Du, [$("div", null, [t[5] ||= $("span", { class: "font-bold text-base" }, "Change Log", -1), $("p", Ou, M(J(c) ? "Path changes • Click to jump" : "Load a compare file and click Compare"), 1)]), J(c) ? (Z(), Q("span", ku, M(J(s).length) + " items ", 1)) : ta("", !0)]),
			J(c) ? (Z(), Q("div", Au, [$("button", {
			...
			$("div", Mu, [J(c) ? J(s).length === 0 ? (Z(), Q("p", Pu, "No changes match the current filters.")) : (Z(), Q(Fi, { key: 2 }, [
				J(i) && d.value.length > 0 ? (Z(), Q(Fi, { key: 0 }, [$("div", Fu, " Removed " + M(d.value.length), 1), (Z(!0), Q(Fi, null, xr(d.value, (e) => (Z(), Gi(Tu, {
					key: e.identity,
					entry: e,
					selected: J(l) === e.identity,
					onSelect: h
				}, null, 8, ["entry", "selected"]))), 128))], 64)) : ta("", !0),
				J(a) && f.value.length > 0 ? (Z(), Q(Fi, { key: 1 }, [$("div", Iu, " Added " + M(f.value.length), 1), (Z(!0), Q(Fi, null, xr(f.value, (e) => (Z(), Gi(Tu, {
					key: e.identity,
					entry: e,
					selected: J(l) === e.identity,
					onSelect: h
				}, null, 8, ["entry", "selected"]))), 128))], 64)) : ta("", !0),
				J(o) && p.value.length > 0 ? (Z(), Q(Fi, { key: 2 }, [$("div", Lu, " Changed " + M(p.value.length), 1), (Z(!0), Q(Fi, null, xr(p.value, (e) => (Z(), Gi(Tu, {
					key: e.identity,
					entry: e,
					selected: J(l) === e.identity,
					onSelect: h
				}, null, 8, ["entry", "selected"]))), 128))], 64)) : ta("", !0)
			], 64)) : (Z(), Q("p", Nu, " Click a change to jump to the node in the tree. "))])
		]));
	}
}), zu = /* @__PURE__ */ qn({
	__name: "change-badge",
...
}, Vu = { class: "flex items-center justify-between px-4 py-3" }, Hu = { class: "text-sm text-base-content/40" }, Uu = {
	key: 0,
	class: "px-4 py-4"
}, Wu = { class: "bg-base-200 rounded-xl px-5 py-5" }, Gu = { class: "text-sm text-base-content/40 mt-1" }, Ku = {
	key: 1,
	class: "flex-1 overflow-y-auto"
}, qu = { class: "flex items-center gap-2 px-4 py-2 border-b border-base-300" }, Ju = { class: "px-4 py-2" }, Yu = { class: "table table-xs w-full" }, Xu = { class: "font-mono text-xs" }, Zu = { key: 0 }, Qu = /* @__PURE__ */ qn({
	__name: "inspector",
	setup(e) {
		let t = Yl(), n = kl(), { selectedEntry: r } = ss(t), { hasCompared: i } = ss(n), a = ka(function() {
			let e = r.value;
			if (!e) return [];
		...
		return (e, t) => (Z(), Q("div", Bu, [
			$("div", Vu, [t[0] ||= $("span", { class: "font-bold text-base" }, "Inspector", -1), $("span", Hu, M(J(r) ? "" : "Select a node in the tree"), 1)]),
			t[4] ||= $("div", { class: "border-t border-base-200 mx-4" }, null, -1),
			J(r) ? (Z(), Q("div", Ku, [$("div", qu, [
				$("button", {
					class: "btn btn-xs btn-ghost",
			...
			]), $("div", Ju, [$("table", Yu, [t[3] ||= $("thead", null, [$("tr", null, [
				$("th", null, "Attribute"),
				$("th", null, "Base"),
				$("th", null, "Compare")
			])], -1), $("tbody", null, [(Z(!0), Q(Fi, null, xr(a.value, (e) => (Z(), Q("tr", {
				key: e.name,
			...
			], 2))), 128)), a.value.length === 0 ? (Z(), Q("tr", Zu, [...t[2] ||= [$("td", {
				colspan: "3",
				class: "text-xs text-base-content/50 text-center py-2"
			}, " No attributes ", -1)]])) : ta("", !0)])])])])) : (Z(), Q("div", Uu, [$("div", Wu, [t[1] ||= $("p", { class: "font-semibold text-sm text-base-content/60" }, "No selection", -1), $("p", Gu, M(J(i) ? "Click a node to see before/after attributes." : "Load a compare file and compare structure, edges, and control blocks + dataset definitions."), 1)])]))
		]));
	}
}), $u = {
	class: "flex flex-col h-full overflow-hidden",
	...
	class: "px-4 pt-3 pb-2 border-b border-base-300",
	"data-testid": "top-bar"
}, td = { class: "flex items-start gap-6" }, nd = { class: "flex flex-col gap-2 w-64" }, rd = { class: "flex items-center gap-2" }, id = { class: "flex flex-col gap-2 w-64" }, ad = { class: "flex items-center gap-2" }, od = ["disabled"], sd = { class: "flex-1 flex justify-end pt-1" }, cd = {
	key: 0,
	class: "flex items-center gap-1.5 px-3 py-1.5 rounded-full bg-base-200 text-sm",
	"data-testid": "summary-pill"
}, ld = { class: "text-green-600 font-semibold" }, ud = { class: "text-red-500 font-semibold" }, dd = { class: "text-orange-500 font-semibold" }, fd = {
	key: 0,
	class: "alert alert-error text-sm px-4 py-2 rounded-none",
	"data-testid": "error-bar"
}, pd = { class: "flex flex-1 overflow-hidden" }, md = { class: "w-96 border-r border-base-300 overflow-hidden flex flex-col" }, hd = { class: "w-96 border-r border-base-300 overflow-hidden flex flex-col" }, gd = { class: "flex-1 overflow-hidden flex flex-col" }, _d = /* @__PURE__ */ ((e, t) => {
	let n = e.__vccOpts || e;
	...
	props: { api: {} },
	setup(e) {
		let t = e, n = ps(), r = kl(), i = jl(), a = /* @__PURE__ */ q(null), o = /* @__PURE__ */ q(null), s = () => {};
		sr(() => {
			s = t.api.activeFileName.subscribe((e) => {
		...
		return (e, t) => {
			...
			return Z(), Gi(s, null, {
				default: jn(() => [
					$("div", $u, [
						$("div", ed, [$("div", td, [
							$("div", nd, [$("div", rd, [t[10] ||= $("span", { class: "text-xs font-bold uppercase tracking-widest text-base-content/40" }, "Base", -1), $("button", {
								class: "btn btn-sm btn-outline gap-1",
								"data-testid": "btn-change-base",
								onClick: t[0] ||= (e) => c("base")
							}, [...t[9] ||= [
								$("span", { class: "opacity-50" }, "📄", -1),
								ea(" Change ", -1),
								$("span", { class: "opacity-40" }, "▾", -1)
							]])]), J(n).base ? (Z(), Gi(Fl, {
								key: 0,
								slot: J(n).base,
							...
							$("div", id, [$("div", ad, [
								t[12] ||= $("span", { class: "text-xs font-bold uppercase tracking-widest text-base-content/40" }, "Compare", -1),
								$("button", {
									class: "btn btn-sm btn-outline gap-1",
									"data-testid": "btn-change-compare",
									onClick: t[2] ||= (e) => c("compare")
								}, [...t[11] ||= [
									$("span", { class: "opacity-50" }, "📄", -1),
									ea(" Change ", -1),
									$("span", { class: "opacity-40" }, "▾", -1)
								...
								$("button", {
									...
									onClick: t[3] ||= (e) => J(r).runCompare()
								}, M(J(r).isLoading ? "Comparing…" : "Compare"), 9, od)
							]), J(n).compare ? (Z(), Gi(Fl, {
								key: 0,
								slot: J(n).compare,
								onClear: t[4] ||= (e) => J(n).clearSlot("compare")
							}, null, 8, ["slot"])) : ta("", !0)]),
							$("div", sd, [J(r).hasCompared ? (Z(), Q("div", cd, [
								$("span", ld, M(J(r).summary.added) + " added", 1),
								t[13] ||= $("span", { class: "text-base-content/30" }, "•", -1),
								$("span", ud, M(J(r).summary.removed) + " removed", 1),
								t[14] ||= $("span", { class: "text-base-content/30" }, "•", -1),
								$("span", dd, M(J(r).summary.changed) + " changed (" + M(J(i).activeTab) + ")", 1)
							])) : ta("", !0)])
						])]),
						J(r).error ? (Z(), Q("div", fd, M(J(r).error), 1)) : ta("", !0),
						$("div", pd, [
							$("div", md, [Xi(vu)]),
							$("div", hd, [Xi(Ru)]),
							$("div", gd, [Xi(Qu)])
					...
					Xi(Jl, {
						...
						onSelect: t[5] ||= (e) => l("base", e),
						onClose: t[6] ||= (e) => o.value = null
					}, null, 8, ["is-open", "active-file-name"]),
					Xi(Jl, {
						"is-open": o.value === "compare",
						"slot-id": "compare",
						"active-file-name": a.value,
						onSelect: t[7] ||= (e) => l("compare", e),
						onClose: t[8] ||= (e) => o.value = null
					}, null, 8, ["is-open", "active-file-name"])
				]),
				_: 1
			});

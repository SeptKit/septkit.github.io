...
var Mu = (e) => e(), Nu = Symbol(), Pu = Symbol();
function Fu(e, t) {
	e instanceof Map && t instanceof Map ? t.forEach((t, n) => e.set(n, t)) : e instanceof Set && t instanceof Set && t.forEach(e.add, e);
	for (let n in t) {
		if (!t.hasOwnProperty(n)) continue;
		let r = t[n], i = e[n];
		mu(i) && mu(r) && e.hasOwnProperty(n) && !/* @__PURE__ */ q(r) && !/* @__PURE__ */ Ht(r) ? e[n] = Fu(i, r) : e[n] = r;
	}
	return e;
}
var Iu = Symbol();
function Lu(e) {
	return !mu(e) || !Object.prototype.hasOwnProperty.call(e, Iu);
}
var { assign: Ru } = Object;
function zu(e) {
...
function Bu(e, t, n, r) {
	...
	function l() {
		return s || (n.state.value[e] = i ? i() : {}), Ru(/* @__PURE__ */ on(n.state.value[e]), a, Object.keys(o || {}).reduce((t, r) => (t[r] = Gt(Us(() => {
			fu(n);
			let t = n._s.get(e);
			return o[r].call(t, t);
		})), t), {}));
	}
	return c = Vu(e, l, t, n, r, !0), c;
}
function Vu(e, t, n = {}, r, i, a) {
	let o, s = Ru({ actions: {} }, n), c = { deep: !0 }, l, u, d = /* @__PURE__ */ new Set(), f = /* @__PURE__ */ new Set(), p = r.state.value[e];
	!a && !p && (r.state.value[e] = {});
	let m;
	function h(t) {
		let n;
	...
	let v = (t, n = "") => {
		...
		let i = function() {
			...
			return l instanceof Promise ? l.then((e) => (ju(a, e), e)).catch((e) => (ju(o, e), Promise.reject(e))) : (ju(a, l), l);
		};
		return i[Nu] = !0, i[Pu] = n, i;
	}, y = /* @__PURE__ */ Lt({
		_p: r,
		$id: e,
		...
		$reset: g,
		$subscribe(t, n = {}) {
			let i = Au(d, t, n.detached, () => a()), a = o.run(() => pr(() => r.state.value[e], (r) => {
				(n.flush === "sync" ? u : l) && t({
					storeId: e,
					type: hu.direct,
					events: void 0
	...
	r._s.set(e, y);
	let b = (r._a && r._a.runWithContext || Mu)(() => r._e.run(() => (o = De()).run(() => t({ action: v }))));
	for (let t in b) {
		let n = b[t];
		/* @__PURE__ */ q(n) && !zu(n) || /* @__PURE__ */ Ht(n) ? a || (p && Lu(n) && (/* @__PURE__ */ q(n) ? n.value = p[t] : Fu(n, p[t])), r.state.value[e][t] = n) : typeof n == "function" && (b[t] = v(n, t), s.actions[t] = n);
	}
	return Ru(y, b), Ru(/* @__PURE__ */ K(y), b), Object.defineProperty(y, "$state", {
		get: () => r.state.value[e],
		set: (e) => {
			h((t) => {
				Ru(t, e);
...
function Hu(e, t, n) {
	...
	function a(n, a) {
		let o = J();
		return n ||= o ? sr(pu, null) : null, n && fu(n), n = du, n._s.has(e) || (i ? Vu(e, t, r, n) : Bu(e, r, n)), n._s.get(e);
	}
	return a.$id = e, a;
}
function Uu(e) {
...
function qu(e, t) {
	return Yo(), es("svg", Ku, [...t[0] ||= [ss("path", {
		fill: "currentColor",
...
}, sd = { supportedFileExtensions: [".nsd", ".nsdoc"] }, cd = {
	singletonElements: id,
	elements: $u,
	namespaces: { default: {
		uri: "http://www.iec.ch/61850/2016/NSD",
		prefix: ""
...
function pd(e, t) {
	let n = fd[e], r = {
		...
		detail: t.detail,
		method: md((/* @__PURE__ */ Error()).stack),
		ref: t.ref,
		cause: t.cause
	}, i = Error(t.detail);
	throw i.cause = r, i;
...
function xd(e) {
	...
	return gd(r) ? r : Object.entries(r).map(([e, r]) => ({
		name: e,
		value: r,
...
function Sd(e) {
	let { dialecteConfig: t, hooks: n, record: r } = e, { id: i, tagName: a, attributes: o, namespace: s, value: c } = r, l = i ?? crypto.randomUUID(), u = o ? xd({
		tagName: a,
		attributes: o,
		dialecteConfig: t
	}) : [], d = {
...
function wd(e) {
	...
	for (let [e, i] of r) i.query && (Cd(t[e], i.query, e, "query"), t[e] = {
		...t[e],
		...i.query
	}), i.transaction && (Cd(n[e], i.transaction, e, "transaction"), n[e] = {
		...n[e],
		...i.transaction
	});
	return {
...
function Ed(e) {
	...
	for (let e = t.length - 1; e >= 0; e--) {
		let i = t[e];
		if (r === void 0) {
			if ((i.status === "created" || i.status === "updated") && _d(i.newRecord, n)) return {
				...i.newRecord,
				status: i.status
			};
			if (i.status === "deleted" && _d(i.oldRecord, n)) return {
				...i.oldRecord,
				status: "deleted"
			};
			continue;
		...
		if (i.status === "created" && i.newRecord.id === r) {
			...
			return e !== n && pd("ELEMENT_TAGNAME_MISMATCH", {
...
async function $(e) {
	...
	let r;
	if (n.id === void 0) {
		let e = `__singleton_${n.tagName}`, i = kf(t) ? t.recordCache.get(e) : void 0;
		i ? r = i : (r = (await t.store.getByTagNameInDocument(n.tagName, t.documentId))[0], r && kf(t) && (t.recordCache.set(r.id, r), t.recordCache.set(e, r)));
	} else {
		let e = kf(t) ? t.recordCache.get(n.id) : void 0;
		e ? r = e : (r = await t.store.get(n.id, t.documentId), r && kf(t) && t.recordCache.set(n.id, r));
	}
	if (r) return {
		...r,
		status: "unchanged"
...
async function kd(e) {
	...
	for (let e of r) kf(t) && t.recordCache.set(e.id, e);
	return Dd({
		rawRecords: r,
		stagedOperations: t.stagedOperations,
		tagName: n
...
async function Nd(e) {
	let { context: t, tagName: n, attributes: r } = e, i = await kd({
		context: t,
		tagName: n
	}), a = [];
	for (let e of i) Pd({
...
async function Fd(e) {
	let { context: t, ref: n, options: r } = e, { collect: i, omit: a } = r, o = Id(a), s = Rd(i), c = /* @__PURE__ */ new Map();
	for (let e of s.allTags) c.set(e, /* @__PURE__ */ new Map());
	let l = await $({
		context: t,
		ref: n
	});
	return l && (s.mode === "flat" ? await Vd({
		context: t,
		rootId: l.id,
		collectSpec: s,
		omitSpec: o,
...
function Ld(e) {
	...
	for (let e of n.conditional) if (e.tagName === t.tagName && Pd({
		record: t,
...
async function Wd(e) {
	...
	for (let e of r) {
		...
		for (let n of r) a.get(e.tagName).set(n.id, n), !e.isLeaf && e.children.length > 0 && await Wd({
			context: t,
			record: n,
...
async function ef(e) {
	let { context: t, record: n, select: r, compiledOmit: i, dialecteConfig: a } = e;
	if (tf({
		record: n,
		compiledOmit: i
	})) return bd({ record: n });
	...
	return bd({
		record: n,
		tree: (await Promise.all(o.map(({ record: e, select: n }) => ef({
			context: t,
			record: e,
			select: n,
			compiledOmit: i,
...
function tf(e) {
	...
	return n.conditional.some((e) => e.scope === "children" && e.tagName === t.tagName && Pd({
		record: t,
		attributeFilter: e.where
	}));
}
function nf(e) {
	let { record: t, compiledOmit: n } = e;
	return n.unconditional.has(t.tagName) ? !0 : n.conditional.some((e) => e.scope === "self" && e.tagName === t.tagName && Pd({
		record: t,
		attributeFilter: e.where
	}));
}
async function rf(e) {
	...
	if (!n.children?.length) return [];
	let o = r ? sf(r) : void 0;
	if (o && r && a && r.recursive !== !1) {
		let e = n.tagName, t = a.children[e], i = r[e] !== void 0;
		t?.includes(e) && !i && o.add(e);
	}
	let s = n.children.filter((e) => af({
		tagName: e.tagName,
		compiledOmit: i,
		selectKeys: o
	}));
	return s.length ? cf({
		children: (await Promise.all(s.map((e) => $({
			context: t,
			ref: Q(e)
		})))).filter((e) => e !== void 0).filter((e) => !nf({
			record: e,
			compiledOmit: i
		})),
		select: r,
...
function af(e) {
	let { tagName: t, compiledOmit: n, selectKeys: r } = e;
	return !(n.unconditional.has(t) || r && !r.has(t));
}
var of = /* @__PURE__ */ new Set(["where", "recursive"]);
function sf(e) {
	let t = /* @__PURE__ */ new Set();
	for (let n of Object.keys(e)) of.has(n) || t.add(n);
	return t;
}
function cf(e) {
	let { children: t, select: n, record: r, dialecteConfig: i } = e;
	if (!n) return t.map((e) => ({
		record: e,
		select: void 0
	}));
...
function lf(e) {
	...
	if (!(!r || n.recursive === !1 || !r.children[t.tagName]?.includes(t.tagName)) && !(n.where && !Pd({
		record: t,
...
var pf = class {
	...
	get any() {
		return this._any ??= new pf(() => this.context, this.dialecteConfig);
	}
	getOperations() {
		return [];
	}
...
function hf(e) {
	...
	r && (o = vd(r)), i && (s = vd(i)), a && (c = vd(a)), n === "created" ? (Z(o, {
...
async function vf(e) {
	let { dialecteConfig: t, hooks: n, context: r, query: i, parentRef: a, record: o, cumulativeCloneMappings: s } = e, c = [], l = await yf({
		dialecteConfig: t,
		hooks: n,
		context: r,
		query: i,
...
async function xf(e) {
	...
	for (let e of n.children) {
		...
		n && (n.children.length > 0 && await xf({
			context: t,
			record: n
		}), hf({
			context: t,
...
async function Sf(e) {
	let { dialecteConfig: t, hooks: n, context: r, query: i, parentRef: a, params: o } = e, s = Cf(o.attributes);
	if (s) {
		let [e] = await Nd({
			context: r,
			tagName: o.tagName,
...
async function Df(e) {
	let { stagedOperations: t, store: n, documentId: r, documentState: i } = e, { creates: a, updates: o, deletes: s } = Ef(t), c = a.length + o.length + s.length;
...
var Of = class extends mf {
	...
	get any() {
		return this._anyTx ??= new Tf(() => this.context, this.dialecteConfig, this.hooks, this);
	}
	getOperations() {
...
var Af = class {
	...
	withQueryExtensions(e) {
		let t = Td(this.extensionsRegistry?.query, e);
		return Object.assign(e, t);
	}
	withAllExtensions(e) {
		let t = Td(this.extensionsRegistry?.query, e), n = Td(this.extensionsRegistry?.transaction, e);
		return Object.assign(e, t, n);
	}
	createQuery() {
		return new mf(this.store, this.config, this.documentId);
	}
	get query() {
		return this.withQueryExtensions(this.createQuery());
	}
	createTransaction() {
		return new Of(this.store, this.config, this.documentId, this.state, this.hooks);
	}
	async transaction(e, t) {
		this.activeTransactions > 0 && pd("CONCURRENT_TRANSACTION", { detail: `${this.activeTransactions} transaction(s) already active. Concurrent transactions risk lost updates — serialize them or implement a transaction queue.` }), this.activeTransactions++, this.state.loading = !0, this.state.error = null;
		...
		try {
			...
			throw this.state.progress = null, this.state.error ?? pd("UNKNOWN", {
	...
	async prepare(e, t) {
		...
		try {
			...
			throw this.activeTransactions--, this.state.loading = !1, this.state.error ?? pd("UNKNOWN", {
				detail: e instanceof Error ? e.message : String(e),
				cause: e instanceof Error ? e : void 0
			});
		}
			...
			commit: async () => {
				if (!a) {
					...
					try {
						...
						throw this.state.error ?? pd("UNKNOWN", {
							detail: e instanceof Error ? e.message : String(e),
							cause: e instanceof Error ? e : void 0
						});
					} finally {
...
}, jf = "_documents", Mf = "_changeLog", Nf = "_meta", Pf = "xel_";
function Ff(e) {
	return `${Pf}${e}`;
}
var If = {
	...
	compoundIndexes: [],
	arrayIndexes: []
}, zf = typeof globalThis < "u" ? globalThis : typeof window < "u" ? window : typeof global < "u" ? global : typeof self < "u" ? self : {};
function Bf(e) {
...
var Hf = { exports: {} }, Uf = Hf.exports, Wf;
function Gf() {
	return Wf || (Wf = 1, (function(e, t) {
		(function(t, n) {
			...
			var r = typeof globalThis < "u" ? globalThis : typeof self < "u" ? self : typeof window < "u" ? window : zf, i = Object.keys, a = Array.isArray;
			function o(e, t) {
...
var Kf = /* @__PURE__ */ Bf(Gf()), qf = /* @__PURE__ */ Symbol.for("Dexie"), Jf = globalThis[qf] || (globalThis[qf] = Kf);
if (Kf.semVer !== Jf.semVer) throw Error(`Two different versions of Dexie loaded in the same app: ${Kf.semVer} and ${Jf.semVer}`);
var { liveQuery: Yf, mergeRanges: Xf, rangesOverlap: Zf, RangeSet: Qf, cmp: $f, Entity: ep, PropModification: tp, replacePrefix: np, add: rp, remove: ip, DexieYProvider: ap } = Jf;
function op(e) {
...
var sp = {
	...
	constructor(e, t) {
		this.schemaVersion = 1, this.knownDocuments = /* @__PURE__ */ new Map(), this.schemaLock = Promise.resolve(), this.name = e, this.dexieRecordSchema = op(t?.recordSchema ?? sp), this.db = new Jf(e);
	}
	async open() {
		let e = new Jf(this.name);
		e.version(1).stores({
			[jf]: op(If),
			[Mf]: op(Lf),
			[Nf]: op(Rf)
		...
		try {
			await e.open();
			let t = await e.table(jf).toArray(), n = await e.table(Nf).get("schemaVersion");
			e.close();
		...
		this.db = new Jf(this.name), this.db.version(this.schemaVersion).stores(this.buildStores()), await this.db.open();
	}
	close() {
		this.db.close();
	}
	async destroy() {
		this.db.isOpen() && (this.db.close(), await lp()), await Jf.delete(this.name), this.knownDocuments.clear();
	}
	async registerDocument(e) {
		await this.withSchemaLock(async () => {
			this.knownDocuments.set(e.id, e), await this.reopenWithNewSchema(), await this.db.table(jf).add(e);
		});
	}
	async getDocument(e) {
		return this.db.table(jf).get(e);
	}
	async getDocuments() {
		return this.db.table(jf).toArray();
	}
	async updateDocument(e, t) {
		await this.db.table(jf).update(e, t);
	...
	async removeDocument(e) {
		await this.withSchemaLock(async () => {
			...
			this.db.tables.some((e) => e.name === t) && await this.db.table(t).clear(), await this.db.table(Mf).where({ documentId: e }).delete(), await this.db.table(Nf).delete(`head:${e}`), await this.db.table(jf).delete(e), this.knownDocuments.delete(e), await this.reopenWithNewSchema({ drop: e });
		});
	}
	async get(e, t) {
		...
		try {
			await this.db.transaction("rw", o, this.db.table(Mf), this.db.table(Nf), async () => {
				...
				if (i.length > 0) try {
					...
					pd("STORE_DELETE_FAILED", {
						detail: e instanceof Error ? e.message : String(e),
						cause: e instanceof Error ? e : void 0
					});
				}
				let u = await this.getHead(t), d = await this.db.table(Mf).where({ documentId: t }).filter((e) => e.sequenceNumber > u).toArray();
				...
				await this.db.table(Mf).add(p), await this.setHead(t, f);
			});
		} catch (e) {
			if (e instanceof Error && e.message.includes("dialecte")) throw e;
			pd("STORE_COMMIT_FAILED", {
				detail: e instanceof Error ? e.message : String(e),
				cause: e instanceof Error ? e : void 0
			});
		}
	...
	async undo(e) {
		...
		if (t === 0) return;
		let n = await this.db.table(Mf).where({
			documentId: e,
			sequenceNumber: t
		}).first();
		if (!n) return;
		let r = this.db.table(this.resolveTableName(e));
		await this.db.transaction("rw", r, this.db.table(Nf), async () => {
	...
	async redo(e) {
		let t = await this.getHead(e) + 1, n = await this.db.table(Mf).where({
			documentId: e,
			sequenceNumber: t
		}).first();
		if (!n) return;
	...
	async getChangeLog(e) {
		return this.db.table(Mf).where({ documentId: e }).sortBy("sequenceNumber");
	}
	getDatabaseInstance() {
		return this.db;
	}
	...
	buildStores(e) {
		...
		for (let e of this.knownDocuments.keys()) t[this.resolveTableName(e)] = this.dexieRecordSchema;
		return e?.drop && (t[this.resolveTableName(e.drop)] = null), t;
	}
	async reopenWithNewSchema(e) {
		this.db.close(), await lp(), this.schemaVersion++, this.db = new Jf(this.name), this.db.version(this.schemaVersion).stores(this.buildStores(e)), await this.db.open(), await this.db.table(Nf).put({
			key: "schemaVersion",
...
function up(e, t, n) {
	return t.type === "local" ? new cp(e, { recordSchema: n.database.recordSchema }) : t.store;
}
var dp = { exports: {} }, fp = { exports: {} }, pp;
function mp() {
	return pp || (pp = 1, (function(e, t) {
...
var hp = dp.exports, gp;
function _p() {
	return gp || (gp = 1, (function(e, t) {
		var n = hp && hp.__importDefault || function(e) {
		...
		p.minify = (e, t = {}) => p(e, Object.assign(Object.assign({}, t), {
			indentation: "",
			lineSeparator: ""
		})), e.exports = p, t.default = p;
	})(dp, dp.exports)), dp.exports;
}
var vp = /* @__PURE__ */ Bf(/* @__PURE__ */ _p());
function yp(e) {
	return vp(e);
}
async function bp(e) {
	let { extension: t, xmlDocument: n, filename: r } = e, i = yp("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" + new XMLSerializer().serializeToString(n)), a = new Blob([i], { type: "application/xml" });
	if ("showSaveFilePicker" in window) try {
		...
		await e.write(a), await e.close();
	} catch (e) {
		e.name !== "AbortError" && console.error("Save failed:", e);
	}
	else {
		let e = URL.createObjectURL(a), t = document.createElement("a");
		t.href = e, t.download = r, document.body.appendChild(t), t.click(), t.remove(), URL.revokeObjectURL(e);
	}
}
function xp(e) {
	let { records: t, config: n, withDatabaseIds: r = !1 } = e, i = /* @__PURE__ */ new Map(), a;
	for (let e of t) i.set(e.id, e), e.tagName === n.rootElementName && (a = e);
	Z(a, {
		detail: `No ${n.rootElementName} root element found in records`,
		key: "EXPORT_ROOT_NOT_FOUND"
	});
	let o = n.namespaces.default, s = document.implementation.createDocument(o.uri, null, null), c = s.createElementNS(a.namespace.uri, a.tagName);
	return c.setAttribute("xmlns", a.namespace.uri), a.attributes && wp({
		config: n,
		document: s,
		element: c,
	...
	}), a.value && (c.textContent = a.value.trim()), r && c.setAttribute("_temp-idb-id", a.id), s.appendChild(c), Sp({
		index: i,
		config: n,
		withDatabaseIds: r,
		xmlDocument: s,
...
function Sp(e) {
	let { index: t, config: n, withDatabaseIds: r, xmlDocument: i, parentRecord: a, parentElement: o } = e;
...
function Cp(e) {
	let { config: t, document: n, record: r, defaultNamespace: i, withDatabaseIds: a } = e, o = r.namespace.uri === i.uri, s;
	return !o && r.namespace.prefix && r.namespace.prefix !== "xmlns" ? (Tp({
		config: t,
		document: n,
		namespace: r.namespace
	}), s = n.createElementNS(r.namespace.uri, `${r.namespace.prefix}:${r.tagName}`)) : s = n.createElementNS(r.namespace.uri, r.tagName), r.attributes && wp({
		config: t,
		document: n,
		element: s,
		...
		tagName: r.tagName,
		isRoot: !1
	}), r.value && (s.textContent = r.value.trim()), a && s.setAttribute("_temp-idb-id", r.id), s;
}
function wp(e) {
	let { config: t, document: n, element: r, attributes: i, tagName: a, isRoot: o } = e;
	for (let e of i) {
		if (Ap(e) || !o && jp({
			config: t,
			tagName: a,
...
function Tp(e) {
	let { config: t, document: n, namespace: r } = e, i = n.documentElement;
	if (!i || !r.prefix || r.prefix === "xmlns") return;
	let a = "http://www.w3.org/2000/xmlns/";
	i.getAttributeNS(a, r.prefix) === null && (i.setAttributeNS(a, `xmlns:${r.prefix}`, r.uri), Ep({
		config: t,
		rootElement: i,
		namespace: r
	}));
...
function Dp(e) {
	let { parentTagName: t, availableChildren: n, childrenRecords: r } = e, i = new Set(n[t]);
	if (!i.size) return r;
	let a = /* @__PURE__ */ new Map(), o = [];
	for (let e of i) a.set(e, []);
	for (let e of r) i.has(e.tagName) ? a.get(e.tagName)?.push(e) : o.push(e);
	let s = [];
	for (let e of i) {
		let t = a.get(e);
		t && t.length && s.push(...t);
...
function Ap(e) {
	return !!(e.name === "xmlns" || e.name.startsWith("xmlns:") || kp(e) && e.namespace?.prefix === "xmlns");
}
function jp(e) {
	...
	return !(!a || a.required || a.default === void 0 || String(r.value) !== a.default || i.attributes.identityFields?.includes(r.name));
}
var Mp = class {
	constructor() {
...
var Pp = {}, Fp = /* @__PURE__ */ Vf(/* @__PURE__ */ Object.freeze(/* @__PURE__ */ Object.defineProperty({
	__proto__: null,
	default: {}
...
function zp(e) {
	...
	o.onopentag = (e) => a = Bp({
		...
		text: e,
		state: a
	}), o.onclosetag = () => ({updatedState: a} = Hp({
		state: a,
		ioHooks: i,
		session: r
	})), o.onerror = Up;
...
function Bp(e) {
	let { node: t, state: n, dialecteConfig: r, useCustomRecordsIds: i } = e, a = { ...n }, o = Wp(t);
	a.defaultNamespace ||= Gp({
		element: t,
		defaultNamespace: r.namespaces.default,
		rootElementName: r.rootElementName
	});
	let s = Kp(t, a.defaultNamespace), c = {
		id: Yp({
			attributes: t.attributes,
...
function Yp(e) {
	let { attributes: t, useCustomRecordsIds: n } = e, r = t[hd];
	return n && r && r.value ? r.value : crypto.randomUUID();
}
function Xp(e) {
	let { attributes: t, useCustomRecordsIds: n } = e;
	return n ? Object.values(t).filter((e) => e.name !== hd) : Object.values(t);
}
var Zp = 32 * 1024, Qp = 2e3;
async function $p(e) {
	let { file: t, documentId: n, store: r, config: i, useCustomRecordsIds: a = !1, chunkOptions: o } = e, { supportedFileExtensions: s } = i.io;
	if (Z(s.some((e) => t.name.toLowerCase().endsWith(e)), {
		key: "ASSERTION_FAILED",
		detail: `Unsupported file type: ${t.name}`
	}), t.size === 0) return {
		documentId: n,
		recordCount: 0
	};
	let c = o?.chunkSize ?? Zp, l = o?.batchSize ?? Qp, u = new Mp();
	return {
		documentId: n,
		recordCount: await em({
			file: t,
			sax: zp({
				dialecteConfig: i,
...
async function em(e) {
	...
	for (; !f;) {
		let e = await l.read();
		if (f = e.done, f) {
			d.length > 0 && n.parser.write(u.decode(d)), n.parser.close(), c += await rm({
				sax: n,
				session: r,
				store: i,
				documentId: a,
		...
		if (e.value) for (d = nm(d, e.value); d.length >= o;) {
			let e = u.decode(d.slice(0, o), { stream: !0 });
			d = d.slice(o), n.parser.write(e), c += await rm({
				sax: n,
				session: r,
				store: i,
				documentId: a,
...
async function im(e) {
	...
	let c = r[s.document.configKey], l = xp({
		records: await i.getByDocumentId(t),
		config: c,
		withDatabaseIds: o?.withDatabaseIds
	}), u = `${s.document.name}${s.document.extension}`;
	return o?.withDownload && await bp({
...
function om(e, t) {
	...
	for (let n of t) e.has(n.id) || e.set(n.id, am(n));
...
var lm = class {
	constructor(e) {
		...
		this.storage = e.storage, this.configs = e.configs, this.defaultConfigKey = e.defaultConfigKey ?? t[0], this.mergedExtensions = e.extensions ? wd({
	...
	async open(e) {
		...
		let t = up(e, this.storage, this.configs[this.defaultConfigKey]);
		await t.open(), this._store = t;
		let n = await t.getDocuments();
		for (let e of n) this.state.documents.set(e.id, am(e));
		return this;
	}
	close() {
	...
	async import(e, t) {
		let n = await Promise.all(e.map((e) => sm({
			file: e,
			store: this.store,
			configs: this.configs,
			defaultConfigKey: this.defaultConfigKey,
	...
	openDocument(e) {
		...
		let n = this.configs[t.document.configKey];
		return new Af(this.store, n, e, this.mergedExtensions, this.hooks, this.channel);
	}
	getDocumentConfig(e) {
		let t = this.state.documents.get(e);
		if (t) return this.configs[t.document.configKey];
	}
	async undo(e) {
...
var dm = "SET-LIBRARY-NSD", fm = null;
function pm() {
	return fm ||= um().open(dm), fm;
}
var mm = /* @__PURE__ */ Jt(0);
function hm() {
	mm.value++;
}
//#endregion
...
function Em() {}
//#endregion
export { De as $, es as A, Ni as B, Y as C, ss as D, Us as E, Ws as F, Qi as G, Yo as H, sr as I, ur as J, Wi as K, _a as L, X as M, Kr as N, ts as O, Cs as P, an as Q, _s as R, Kl as S, us as T, or as U, Fi as V, Xi as W, rr as X, dr as Y, ir as Z, Hu as _, vm as a, Yt as at, nu as b, gm as c, en as ct, hm as d, F as dt, Oe as et, sd as f, ue as ft, Ou as g, Wu as h, ym as i, Jt as it, ds as j, ps as k, pm as l, Qt as lt, Ju as m, t as mt, Em as n, ke as nt, bm as o, K as ot, Qu as p, Se as pt, pr as q, wm as r, zt as rt, _m as s, ln as st, Tm as t, q as tt, mm as u, $t as ut, Uu as v, Wo as w, Ml as x, cu as y, zn as z };

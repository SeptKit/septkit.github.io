...
}, ne = /-\w/g, O = te((e) => e.replace(ne, (e) => e.slice(1).toUpperCase())), k = /\B([A-Z])/g, A = te((e) => e.replace(k, "-$1").toLowerCase()), re = te((e) => e.charAt(0).toUpperCase() + e.slice(1)), j = te((e) => e ? `on${re(e)}` : ""), M = (e, t) => !Object.is(e, t), N = (e, ...t) => {
...
function pe(e) {
	let t = {};
	return e.replace(fe, "").split(de).forEach((e) => {
		if (e) {
			let n = e.split(P);
...
function me(e) {
	...
	return t && !y(t) && (e.class = F(t)), n && (e.style = ue(n)), e;
}
...
var xe = (e) => !!(e && e.__v_isRef === !0), Se = (e) => y(e) ? e : e == null ? "" : p(e) || x(e) && (e.toString === C || !v(e.toString)) ? xe(e) ? Se(e.value) : JSON.stringify(e, Ce, 2) : String(e), Ce = (e, t) => xe(t) ? Ce(e, t.value) : m(t) ? { [`Map(${t.size})`]: [...t.entries()].reduce((e, [t, n], r) => (e[we(t, r) + " =>"] = n, e), {}) } : h(t) ? { [`Set(${t.size})`]: [...t.values()].map((e) => we(e)) } : b(t) ? we(t) : x(t) && !p(t) && !E(t) ? String(t) : t, we = (e, t = "") => b(e) ? `Symbol(${e.description ?? t})` : e;
function Te(e) {
...
var _t = class {
	...
	set(e, t, n, r) {
		...
		return e === /* @__PURE__ */ K(r) && (o ? M(n, i) && rt(e, "set", t, n, i) : rt(e, "add", t, n)), s;
	}
	deleteProperty(e, t) {
...
function Et(e, t) {
	...
	return l(n, e ? {
		...
		add(e) {
			...
			return r.has.call(n, a) || M(e, a) && r.has.call(n, e) || M(i, a) && r.has.call(n, i) || (n.add(a), rt(n, "add", a, a)), this;
		},
		set(e, n) {
			...
			let s = a.call(r, e);
			return r.set(e, n), o ? M(n, s) && rt(r, "set", e, n, s) : rt(r, "add", e, n), this;
		},
		delete(e) {
...
function Gt(e) {
	return !f(e, "__v_skip") && Object.isExtensible(e) && ie(e, "__v_skip", !0), e;
}
...
var Zt = class {
	...
	set value(e) {
		...
		e = n ? e : /* @__PURE__ */ K(e), M(e, t) && (this._rawValue = e, this._value = n ? e : Kt(e), this.dep.trigger());
	}
};
function Qt(e) {
	e.dep && e.dep.trigger();
...
function hr(e, t, n) {
	...
	let o = Es(this), s = mr(i, a.bind(r), n);
	return o(), s;
}
function gr(e, t) {
	let n = t.split(".");
...
var Pr = [Function, Array], Fr = {
	...
	setup(e, { slots: t }) {
		...
		return () => {
			...
			if (u && u.type !== Y && !rs(u, c) && Ir(n).type !== Y) {
				let e = Vr(u, o, r, n);
				if (Wr(u, e), s === "out-in" && c.type !== Y) return r.isLeaving = !0, e.afterLeave = () => {
...
function Vr(e, t, n, r, i) {
	let { appear: a, mode: o, persisted: s = !1, onBeforeEnter: c, onEnter: l, onAfterEnter: u, onEnterCancelled: d, onBeforeLeave: f, onLeave: m, onAfterLeave: h, onLeaveCancelled: g, onBeforeAppear: _, onAppear: v, onAfterAppear: y, onAppearCancelled: b } = t, x = String(e.key), S = Br(n, e), C = (e, t) => {
		...
		beforeEnter(t) {
			...
			t[jr] && t[jr](!0);
			let i = S[x];
			i && rs(e, i) && i.el[jr] && i.el[jr](), C(r, [t]);
		},
		enter(t) {
			if (S[x] === e) return;
			let r = l, i = u, o = d;
...
function Hr(e) {
	if (xi(e)) return e = us(e), e.children = null, e;
}
function Ur(e) {
...
function Gr(e, t = !1, n) {
	...
	for (let a = 0; a < e.length; a++) {
		...
		o.type === Wo ? (o.patchFlag & 128 && i++, r = r.concat(Gr(o.children, t, s))) : (t || o.type !== Y) && r.push(s == null ? o : us(o, { key: s }));
	}
...
function Qr(e, t, n, i, a = !1) {
	...
	let s = i.shapeFlag & 4 ? Bs(i.component) : i.el, c = a ? null : s, { i: l, r: d } = e, m = t && t.r, h = l.refs === r ? l.refs = {} : l.refs, g = l.setupState, _ = /* @__PURE__ */ K(g), b = g === r ? o : (e) => Xr(h, e) ? !1 : f(_, e), x = (e, t) => !(t && Xr(h, t));
	if (m != null && m !== d) {
...
function oi(e) {
	let { mt: t, p: n, o: { patchProp: r, createText: i, nextSibling: a, parentNode: o, remove: c, insert: l, createComment: u } } = e, d = (e, t) => {
		...
		d ||= !!r.dynamicChildren;
		let b = ai(n) && n.data === "[", x = () => g(n, r, s, c, u, b), { type: S, ref: C, shapeFlag: w, patchFlag: T } = r, E = n.nodeType;
		r.el = n, T === -2 && (d = !1, r.dynamicChildren = null);
		let D = null;
		switch (S) {
			case Go:
				E === 3 ? (n.data !== r.children && (ti(), n.data = r.children), D = a(n)) : r.children === "" ? (l(r.el = i(""), o(n), n), D = n) : D = x();
				break;
			case Y:
			...
			default: if (w & 1) D = (E !== 1 || r.type.toLowerCase() !== n.tagName.toLowerCase()) && !y(n) ? x() : p(n, r, s, c, u, d);
				...
				r.slotScopeIds = u;
				let e = o(n);
				if (D = b ? _(n) : ai(n) && n.data === "teleport start" ? _(n, n.data, "teleport end") : a(n), t(r, e, null, s, c, ii(e), d), vi(r) && !r.type.__asyncResolved) {
					let t;
					b ? (t = X(Wo), t.anchor = D ? D.previousSibling : e.lastChild) : t = n.nodeType === 3 ? ds("") : X("div"), t.el = n, r.component.subTree = t;
				}
			} else w & 64 ? D = E === 8 ? r.type.hydrate(n, r, s, c, u, d, e, m) : x() : w & 128 && (D = r.type.hydrate(n, r, s, c, ii(o(n)), u, d, e, f));
		}
		return C != null && Qr(C, null, c, r), D;
	}, p = (e, t, n, i, a, o) => {
		o ||= !!t.dynamicChildren;
		...
		if (g || d !== -1) {
			...
			let _;
			(_ = u && u.onVnodeBeforeMount) && vs(_, n, t), p && ar(t, null, n, "beforeMount"), ((_ = u && u.onVnodeMounted) || p || l) && Vo(() => {
				_ && vs(_, n, t), l && h.enter(e), p && ar(t, null, n, "mounted");
			}, i);
		}
		...
		for (let t = 0; t < p; t++) {
			let m = u ? d[t] : d[t] = ms(d[t]), h = m.type === Go;
			e ? (h && !u && t + 1 < p && ms(d[t + 1]).type === Go && (l(i(e.data.slice(m.children.length)), r, a(e)), e.data = m.children), e = f(e, m, o, s, c, u)) : h && !m.children ? l(m.el = i(""), r) : (li(r, 1) || ti(), n(null, m, r, null, o, s, ii(r), c));
		}
		return e;
	}, h = (e, t, n, r, i, s) => {
...
var ui = ce().requestIdleCallback || ((e) => setTimeout(e, 1)), di = ce().cancelIdleCallback || ((e) => clearTimeout(e)), fi = (e = 1e4) => (t) => {
...
function yi(e) {
	...
	return /* @__PURE__ */ Kr({
		...
		setup() {
			...
			if (s && e.suspense || ks) return p().then((t) => () => bi(t, e)).catch((e) => (t(e), () => r ? X(r, { error: e }) : null));
...
var xi = (e) => e.type.__isKeepAlive, Si = {
	...
	setup(e, { slots: t }) {
		...
		function m(e) {
			i.forEach((t, n) => {
				let r = Vs(vi(t) ? t.type.__asyncResolved || {} : t.type);
				r && !e(r) && h(n);
			});
		}
		function h(e) {
			let t = i.get(e);
			t && (!o || !rs(t, o)) ? p(t) : o && Oi(o), i.delete(e), a.delete(e);
		}
		...
		return Ni(_), Fi(_), Ii(() => {
			...
			if (!ns(r) || !(r.shapeFlag & 4) && !(r.shapeFlag & 128)) return o = null, r;
			let s = ki(r);
			if (s.type === Y) return o = null, s;
			let c = s.type, l = Vs(vi(s) ? s.type.__asyncResolved || {} : c), { include: u, exclude: d, max: f } = e;
			if (u && (!l || !Ci(u, l)) || d && l && Ci(d, l)) return s.shapeFlag &= -257, o = s, r;
			let p = s.key == null ? c : s.key, m = i.get(p);
			return s.el && (s = us(s), r.shapeFlag & 128 && (r.ssContent = s)), g = p, m ? (s.el = m.el, s.component = m.component, s.transition && Wr(s, s.transition), s.shapeFlag |= 512, a.delete(p), a.add(p)) : (a.add(p), f && a.size > parseInt(f, 10) && h(a.values().next().value)), s.shapeFlag |= 256, o = s, jo(r.type) ? r : s;
		};
	}
};
function Ci(e, t) {
...
function Ai(e, t, n = Ss, r = !1) {
	if (n) {
		let i = n[e] || (n[e] = []), a = t.__weh ||= (...r) => {
			Ke();
			let i = Es(n), a = kn(t, n, e, r);
			return i(), B(), a;
		};
...
function Ji(e, t, n = !0, r = !1) {
	...
	if (i) {
		...
		if (e === Hi) {
			let e = Vs(n, !1);
			if (e && (e === t || e === O(t) || e === re(O(t)))) return n;
		}
...
function Qi(e, t, n = {}, r, i) {
	if (Zn.ce || Zn.parent && vi(Zn.parent) && Zn.parent.ce) {
		...
		return t !== "default" && (n.name = t), Yo(), ts(Wo, null, [X("slot", n, r && r())], e ? -2 : 64);
	}
	let a = e[t];
	a && a._c && (a._d = !1), Yo();
	let o = a && $i(a(n)), s = n.key || o && o.key, c = ts(Wo, { key: (s && !b(s) ? s : `_${t}`) + (!o && r ? "_fb" : "") }, o || (r ? r() : []), o && e._ === 1 ? 64 : -2);
	return !i && c.scopeId && (c.slotScopeIds = [c.scopeId + "-s"]), a && a._c && (a._d = !0), c;
}
function $i(e) {
	return e.some((e) => ns(e) ? !(e.type === Y || e.type === Wo && !$i(e.children)) : !0) ? e : null;
}
function ea(e, t) {
	let n = {};
...
var ta = (e) => e ? Os(e) ? Bs(e) : ta(e.parent) : null, na = /* @__PURE__ */ l(/* @__PURE__ */ Object.create(null), {
	$: (e) => e,
	$el: (e) => e.vnode.el,
	$data: (e) => e.data,
	$props: (e) => e.props,
...
function Sa(e) {
	...
	let { data: i, computed: o, methods: s, watch: c, provide: l, inject: u, created: d, beforeMount: f, mounted: m, beforeUpdate: h, updated: g, activated: _, deactivated: y, beforeDestroy: b, beforeUnmount: S, destroyed: C, unmounted: w, render: T, renderTracked: E, renderTriggered: D, errorCaptured: ee, serverPrefetch: te, expose: ne, inheritAttrs: O, components: k, directives: A, filters: re } = t;
	...
	if (j(Mi, f), j(Ni, m), j(Pi, h), j(Fi, g), j(wi, _), j(Ti, y), j(Vi, ee), j(Bi, E), j(zi, D), j(Ii, S), j(Li, w), j(Ri, te), p(ne)) if (ne.length) {
		let t = e.exposed ||= {};
		ne.forEach((e) => {
	...
	T && e.render === a && (e.render = T), O != null && (e.inheritAttrs = O), k && (e.components = k), A && (e.directives = A), te && Jr(e);
}
function Ca(e, t, n = a) {
	p(e) && (e = ja(e));
	for (let n in e) {
...
var za = null;
function Ba(e, t, n = r) {
	let i = Cs(), a = O(t), o = A(t), s = Va(e, a), c = an((s, c) => {
		let l, u = r, d;
		return fr(() => {
			let t = e[a];
			M(l, t) && (l = t, c());
...
var Va = (e, t) => t === "modelValue" || t === "model-value" ? e.modelModifiers : e[`${t}Modifiers`] || e[`${O(t)}Modifiers`] || e[`${A(t)}Modifiers`];
function Ha(e, t, ...n) {
	if (e.isUnmounted) return;
	let i = e.vnode.props || r, a = n, o = t.startsWith("update:"), s = o && Va(i, t.slice(7));
	s && (s.trim && (a = n.map((e) => y(e) ? e.trim() : e)), s.number && (a = n.map(ae)));
	let c, l = i[c = j(t)] || i[c = j(O(t))];
	!l && o && (l = i[c = j(A(t))]), l && kn(l, e, 6, a);
	let u = i[c + "Once"];
	if (u) {
...
function Ka(e) {
	...
	try {
		...
		qo.length = 0, An(t, e, 1), v = X(Y);
	}
	let b = v;
	if (y && g !== !1) {
		let e = Object.keys(y), { shapeFlag: t } = b;
		e.length && t & 7 && (a && e.some(c) && (y = Ya(y, a)), b = us(b, y, !1, !0));
	}
	return n.dirs && (b = us(b, null, !1, !0), b.dirs = b.dirs ? b.dirs.concat(n.dirs) : n.dirs), n.transition && Wr(b, n.transition), v = b, $n(_), v;
}
function qa(e, t = !0) {
	let n;
...
function Qa(e, t, n) {
	let r = e[n], i = t[n];
	return n === "style" && x(r) && x(i) ? !ye(r, i) : r !== i;
}
...
function io(e, t, n, r) {
	...
	if ((r || o > 0) && !(o & 16)) {
		...
		ao(e, t, i, a) && (l = !0);
		let r;
		for (let a in s) (!t || !f(t, a) && ((r = A(a)) === a || !f(t, r))) && (c ? n && (n[a] !== void 0 || n[r] !== void 0) && (i[a] = oo(c, s, a, void 0, e, !0)) : delete i[a]);
...
function ao(e, t, n, i) {
	...
	if (t) for (let r in t) {
		if (ee(r)) continue;
		let l = t[r], u;
		a && f(a, u = O(r)) ? !o || !o.includes(u) ? n[u] = l : (c ||= {})[u] = l : Ga(e.emitsOptions, r) || (!(r in i) || l !== i[r]) && (i[r] = l, s = !0);
	}
	if (o) {
...
var uo = (e) => e === "_" || e === "_ctx" || e === "$stable", fo = (e) => p(e) ? e.map(ms) : [ms(e)], po = (e, t, n) => {
	if (t._n) return t;
	let r = rr((...e) => fo(t(...e)), n);
	return r._c = !1, r;
}, mo = (e, t, n) => {
	...
	if (e.vnode.shapeFlag & 32) {
		let e = t._;
		e ? (go(r, t, n), n && ie(r, "_", e, !0)) : mo(t, r);
	} else t && ho(e, t);
}, vo = (e, t, n) => {
...
function So(e, t) {
	...
	let { insert: o, remove: s, patchProp: c, createElement: l, createText: u, createComment: d, setText: f, setElementText: p, parentNode: m, nextSibling: h, setScopeId: g = a, insertStaticContent: _ } = e, v = (e, t, n, r = null, i = null, a = null, o = void 0, s = null, c = !!t.dynamicChildren) => {
		if (e === t) return;
		e && !rs(e, t) && (r = F(e), ue(e, i, a, !0), e = null), t.patchFlag === -2 && (c = !1, t.dynamicChildren = null);
		...
		if (d = e.el = l(e.type, a, m && m.is, m), h & 8 ? p(d, e.children) : h & 16 && D(e.children, d, null, r, i, Co(e, a), s, u), _ && ar(e, null, r, "created"), E(d, e, e.scopeId, s, r), m) {
		...
		v && g.beforeEnter(d), o(d, t, n), ((f = m && m.onVnodeMounted) || v || _) && yo(() => {
			try {
				f && vs(f, r, e), v && g.enter(d), _ && ar(e, null, r, "mounted");
			} finally {}
		}, i);
	}, E = (e, t, n, r, i) => {
		...
		if (n && wo(n, !1), (g = h.onVnodeBeforeUpdate) && vs(g, n, t, e), f && ar(t, e, n, "beforeUpdate"), n && wo(n, !0), (m.innerHTML && h.innerHTML == null || m.textContent && h.textContent == null) && p(l, ""), d ? ne(e.dynamicChildren, d, l, n, i, Co(t, a), o) : s || ae(e, t, l, null, n, i, Co(t, a), o, !1), u > 0) {
			if (u & 16) O(l, m, h, n, a);
		...
		((g = h.onVnodeUpdated) || f) && yo(() => {
			g && vs(g, n, t, e), f && ar(t, e, n, "updated");
		}, i);
	}, ne = (e, t, n, r, i, a, o) => {
		for (let s = 0; s < t.length; s++) {
			let c = e[s], l = t[s];
			v(c, l, c.el && (c.type === Wo || !rs(c, l) || c.shapeFlag & 198) ? m(c.el) : n, null, r, i, a, o, !0);
		}
	}, O = (e, t, n, i, a) => {
		if (t !== n) {
		...
		h && (c = c ? c.concat(h) : h), e == null ? (o(d, n, r), o(f, n, r), D(t.children || [], n, f, i, a, s, c, l)) : p > 0 && p & 64 && m && e.dynamicChildren && e.dynamicChildren.length === m.length ? (ne(e.dynamicChildren, m, n, i, a, s, c), (t.key != null || i && t === i.subTree) && Eo(e, t, !0)) : ae(e, t, n, f, i, a, s, c, l);
	}, A = (e, t, n, r, i, a, o, s, c) => {
		t.slotScopeIds = s, e == null ? t.shapeFlag & 512 ? i.ctx.activate(t, n, r, o, c) : re(t, n, r, i, a, o, c) : j(e, t, c);
	}, re = (e, t, n, r, i, a, o) => {
		let s = e.component = xs(e, r, i);
		if (xi(e) && (s.ctx.renderer = ge), As(s, !1, o), s.asyncDep) {
		...
		let s = () => {
			if (e.isMounted) {
				...
				let u = t, d;
				wo(e, !1), t ? (t.el = c.el, ie(e, t, o)) : t = c, n && N(n), (d = t.props && t.props.onVnodeBeforeUpdate) && vs(d, s, t, c), wo(e, !0);
				let f = Ka(e), p = e.subTree;
				e.subTree = f, v(p, f, m(p.el), F(p), e, i, a), t.el = f.el, u === null && $a(e, f.el), r && yo(r, i), (d = t.props && t.props.onVnodeUpdated) && yo(() => vs(d, s, t, c), i);
			} else {
				let o, { el: s, props: c } = t, { bm: l, m: u, parent: d, root: f, type: p } = e, m = vi(t);
				if (wo(e, !1), l && N(l), !m && (o = c && c.onVnodeBeforeMount) && vs(o, d, t), wo(e, !0), s && ve) {
					let t = () => {
						e.subTree = Ka(e), ve(s, e.subTree, e, i, null);
					};
		...
		m & 8 ? (u & 16 && pe(l, i, a), d !== l && p(n, d)) : u & 16 ? m & 16 ? se(l, d, n, r, i, a, o, s, c) : pe(l, i, a, !0) : (u & 8 && p(n, ""), m & 16 && D(d, n, r, i, a, o, s, c));
	}, oe = (e, t, n, r, a, o, s, c, l) => {
		e ||= i, t ||= i;
		...
		u > d ? pe(e, a, o, !0, !1, f) : D(t, n, r, a, o, s, c, l, f);
	}, se = (e, t, n, r, a, o, s, c, l) => {
		let u = 0, d = t.length, f = e.length - 1, p = d - 1;
		for (; u <= f && u <= p;) {
			let r = e[u], i = t[u] = l ? hs(t[u]) : ms(t[u]);
			if (rs(r, i)) v(r, i, n, null, a, o, s, c, l);
			else break;
			u++;
		}
		for (; u <= f && u <= p;) {
		...
		if (u > f) {
			...
			for (u = m; u <= f; u++) {
				...
				else for (_ = h; _ <= p; _++) if (C[_ - h] === 0 && rs(r, t[_])) {
					i = _;
					break;
				}
		...
		if (g && (_ = o && o.onVnodeBeforeUnmount) && vs(_, t, e), u & 6) fe(e.component, n, r);
		else {
			if (u & 128) {
				e.suspense.unmount(n, r);
				return;
			}
			h && ar(e, null, t, "beforeUnmount"), u & 64 ? e.type.remove(e, t, n, ge, r) : l && !l.hasOnce && (a !== Wo || d > 0 && d & 64) ? pe(l, t, n, !1, !0) : (a === Wo && d & 384 || !i && u & 16) && pe(c, t, n), r && de(e);
		}
		let v = m != null && p == null;
		(g && (_ = o && o.onVnodeUnmounted) || h || v) && yo(() => {
			_ && vs(_, t, e), h && ar(e, null, t, "unmounted"), v && (e.el = null);
		}, n);
	}, de = (e) => {
		...
		ko(c), ko(l), r && N(r), i.stop(), a && (a.flags |= 8, ue(o, e, t, n)), s && yo(s, t), yo(() => {
			e.isUnmounted = !0;
		}, t);
		...
		let r;
		e == null ? t._vnode && (ue(t._vnode, null, null, !0), r = t._vnode.component) : v(t._vnode || null, e, t, null, null, null, n), t._vnode = e, me ||= (me = !0, Wn(r), Gn(), !1);
	}, ge = {
		p: v,
		um: ue,
		m: le,
...
function Eo(e, t, n = !1) {
	...
	if (p(r) && p(i)) for (let e = 0; e < r.length; e++) {
		let t = r[e], a = i[e];
		a.shapeFlag & 1 && !a.dynamicChildren && ((a.patchFlag <= 0 || a.patchFlag === 32) && (a = i[e] = hs(i[e]), a.el = t.el), !n && a.patchFlag !== -2 && Eo(t, a)), a.type === Go && (a.patchFlag === -1 && (a = i[e] = hs(a)), a.el = t.el), a.type === Y && !a.el && (a.el = t.el);
	}
}
function Do(e) {
...
function Io(e, t, n, r, i, a, o, s, { p: c, um: l, o: { createElement: u } }) {
	...
	if (h) d.pendingBranch = f, rs(h, f) ? (c(h, f, d.hiddenContainer, null, i, d, a, o, s), d.deps <= 0 ? d.resolve() : g && (_ || (c(m, p, n, r, i, null, a, o, s), Ho(d, p)))) : (d.pendingId = Mo++, _ ? (d.isHydrating = !1, d.activeBranch = h) : l(h, i, d), d.deps = 0, d.effects.length = 0, d.hiddenContainer = u("div"), g ? (c(null, f, d.hiddenContainer, null, i, d, a, o, s), d.deps <= 0 ? d.resolve() : (c(m, p, n, r, i, null, a, o, s), Ho(d, p))) : m && rs(m, f) ? (c(m, f, n, r, i, d, a, o, s), d.resolve(!0)) : (c(null, f, d.hiddenContainer, null, i, d, a, o, s), d.deps <= 0 && d.resolve()));
	else if (m && rs(m, f)) c(m, f, n, r, i, d, a, o, s), Ho(d, f);
...
function Lo(e, t, n, r, i, a, o, s, c, l, u = !1) {
	...
	let y = e.props ? oe(e.props.timeout) : void 0, b = a, x = {
		vnode: e,
		parent: t,
		parentComponent: n,
		namespace: o,
...
function zo(e) {
	...
	e.ssContent = Bo(r ? n.default : n), e.ssFallback = r ? Bo(n.fallback) : X(Y);
}
function Bo(e) {
	let t;
	if (v(e)) {
		let n = Zo && e._c;
		n && (e._d = !1, Yo()), e = e(), n && (e._d = !0, t = Jo, Xo());
	}
	return p(e) && (e = qa(e)), e = ms(e), t && !e.dynamicChildren && (e.dynamicChildren = t.filter((t) => t !== e)), e;
}
function Vo(e, t) {
...
var Wo = /* @__PURE__ */ Symbol.for("v-fgt"), Go = /* @__PURE__ */ Symbol.for("v-txt"), Y = /* @__PURE__ */ Symbol.for("v-cmt"), Ko = /* @__PURE__ */ Symbol.for("v-stc"), qo = [], Jo = null;
function Yo(e = !1) {
	qo.push(Jo = e ? null : []);
}
function Xo() {
...
var Zo = 1;
function Qo(e, t = !1) {
	Zo += e, e < 0 && Jo && t && (Jo.hasOnce = !0);
}
function $o(e) {
	return e.dynamicChildren = Zo > 0 ? Jo || i : null, Xo(), Zo > 0 && Jo && Jo.push(e), e;
}
function es(e, t, n, r, i, a) {
	return $o(ss(e, t, n, r, i, a, !0));
}
function ts(e, t, n, r, i) {
	return $o(X(e, t, n, r, i, !0));
}
function ns(e) {
...
function is(e) {}
var as = ({ key: e }) => e ?? null, os = ({ ref: e, ref_key: t, ref_for: n }) => (typeof e == "number" && (e = "" + e), e == null ? null : y(e) || /* @__PURE__ */ q(e) || v(e) ? {
	i: Zn,
	r: e,
	k: t,
	f: !!n
} : e);
function ss(e, t = null, n = null, r = 0, i = null, a = e === Wo ? 0 : 1, o = !1, s = !1) {
	let c = {
		__v_isVNode: !0,
		__v_skip: !0,
		type: e,
	...
	return s ? (gs(c, n), a & 128 && e.normalize(c)) : n && (c.shapeFlag |= y(n) ? 8 : 16), Zo > 0 && !o && Jo && (c.patchFlag > 0 || a & 6) && c.patchFlag !== 32 && Jo.push(c), c;
}
var X = cs;
function cs(e, t = null, n = null, r = 0, i = null, a = !1) {
	if ((!e || e === Gi) && (e = Y), ns(e)) {
		let r = us(e, t, !0);
		return n && gs(r, n), Zo > 0 && !a && Jo && (r.shapeFlag & 6 ? Jo[Jo.indexOf(e)] = r : Jo.push(r)), r.patchFlag = -2, r;
	}
	if (Hs(e) && (e = e.__vccOpts), t) {
		t = ls(t);
		let { class: e, style: n } = t;
		e && !y(e) && (t.class = F(e)), x(n) && (/* @__PURE__ */ G(n) && !p(n) && (n = l({}, n)), t.style = ue(n));
	}
	let o = y(e) ? 1 : jo(e) ? 128 : yr(e) ? 64 : x(e) ? 4 : v(e) ? 2 : 0;
	return ss(e, t, n, r, i, o, a, !0);
}
function ls(e) {
...
function us(e, t, n = !1, r = !1) {
	let { props: i, ref: a, patchFlag: o, children: s, transition: c } = e, l = t ? _s(i || {}, t) : i, u = {
		...
		props: l,
		key: l && as(l),
		ref: t && t.ref ? n && a ? p(a) ? a.concat(os(t)) : [a, os(t)] : os(t) : a,
		scopeId: e.scopeId,
...
function ps(e = "", t = !1) {
	return t ? (Yo(), ts(Y, null, e)) : X(Y, null, e);
}
function ms(e) {
	return e == null || typeof e == "boolean" ? X(Y) : p(e) ? X(Wo, null, e.slice()) : ns(e) ? hs(e) : X(Go, null, String(e));
}
function hs(e) {
...
function js(e, t) {
	...
	if (r) {
		Ke();
		let n = e.setupContext = r.length > 1 ? zs(e) : null, i = Es(e), a = On(r, e, 0, [e.props, n]), o = S(a);
...
function Ms(e, t, n) {
	v(t) ? e.type.__ssrInlineRender ? e.ssrRender = t : e.render = t : x(t) && (e.setupState = nn(t)), Ls(e, n);
}
var Ns, Ps;
function Fs(e) {
	Ns = e, Ps = (e) => {
...
var Us = (e, t) => /* @__PURE__ */ fn(e, t, ks);
function Ws(e, t, n) {
	try {
		Qo(-1);
		let r = arguments.length;
		return r === 2 ? x(t) && !p(t) ? ns(t) ? X(e, null, [t]) : X(e, t) : X(e, null, t) : (r > 3 ? n = Array.prototype.slice.call(arguments, 2) : r === 3 && ns(n) && (n = [n]), X(e, t, n));
	} finally {
		Qo(1);
	}
}
...
function qs(e, t) {
	...
	return Zo > 0 && Jo && Jo.push(e), !0;
}
var Js = "3.5.32", Ys = a, Xs = Dn, Zs = Jn, Qs = Xn, $s = {
...
var nc = ec ? (e) => ec.createHTML(e) : (e) => e, rc = "http://www.w3.org/2000/svg", ic = "http://www.w3.org/1998/Math/MathML", ac = typeof document < "u" ? document : null, oc = ac && /* @__PURE__ */ ac.createElement("template"), sc = {
	...
	leaveToClass: String
}, fc = /* @__PURE__ */ l({}, Fr, dc), pc = /* @__PURE__ */ ((e) => (e.displayName = "Transition", e.props = fc, e))((e, { slots: t }) => Ws(zr, gc(e), t)), mc = (e, t = []) => {
...
function Ic(e, t) {
	...
	else if (e.type === Wo) e.children.forEach((e) => Ic(e, t));
	else if (e.type === Ko) {
		let { el: n, anchor: r } = e;
...
function Vc(e, t, n) {
	if (p(n)) n.forEach((n) => Vc(e, t, n));
		...
		let r = Wc(e, t);
		Bc.test(n) ? e.setProperty(A(r), n.replace(Bc, ""), "important") : e[r] = n;
	}
}
var Hc = [
	"Webkit",
...
function Kc(e, t, n, r, i, a = ge(t)) {
	r && t.startsWith("xlink:") ? n == null ? e.removeAttributeNS(Gc, t.slice(6, t.length)) : e.setAttributeNS(Gc, t, n) : n == null || a && !_e(n) ? e.removeAttribute(t) : e.setAttribute(t, a ? "" : b(n) ? String(n) : n);
}
...
var al = (e) => e.charCodeAt(0) === 111 && e.charCodeAt(1) === 110 && e.charCodeAt(2) > 96 && e.charCodeAt(2) < 123, ol = (e, t, n, r, i, a) => {
	let o = i === "svg";
	t === "class" ? Oc(e, r, o) : t === "style" ? zc(e, n, r) : s(t) ? c(t) || Zc(e, t, n, r, a) : (t[0] === "." ? (t = t.slice(1), !0) : t[0] === "^" ? (t = t.slice(1), !1) : sl(e, t, r, o)) ? (qc(e, t, r), !e.tagName.includes("-") && (t === "value" || t === "checked" || t === "selected") && Kc(e, t, r, o, a, t !== "value")) : e._isVueCE && (cl(e, t) || e._def.__asyncLoader && (/[A-Z]/.test(t) || !y(r))) ? qc(e, O(t), r, a, t) : (t === "true-value" ? e._trueValue = r : t === "false-value" && (e._falseValue = r), Kc(e, t, r, o));
};
function sl(e, t, n, r) {
...
var dl = /* @__NO_SIDE_EFFECTS__ */ ((e, t) => /* @__PURE__ */ ul(e, t, ru)), fl = typeof HTMLElement < "u" ? HTMLElement : class {}, pl = class e extends fl {
	...
	_setAttr(e) {
		...
		let t = this.hasAttribute(e), n = t ? this.getAttribute(e) : ll, r = O(e);
...
var _l = /* @__PURE__ */ new WeakMap(), vl = /* @__PURE__ */ new WeakMap(), yl = /* @__PURE__ */ Symbol("_moveCb"), bl = /* @__PURE__ */ Symbol("_enterCb"), xl = /* @__PURE__ */ ((e) => (delete e.props.mode, e))({
	...
	setup(e, { slots: t }) {
		...
		return Fi(() => {
			...
			let o = /* @__PURE__ */ K(e), s = gc(o), c = o.tag || Wo;
			if (i = [], a) for (let e = 0; e < a.length; e++) {
				let t = a[e];
				t.el && t.el instanceof Element && (i.push(t), Wr(t, Vr(t, s, r, n)), _l.set(t, Tl(t.el)));
			}
...
var Fl = {
	created(e, { value: t }, n) {
		e.checked = ye(t, n.props.value), e[Al] = Dl(n), Jc(e, "change", () => {
			e[Al](Rl(e));
		});
	},
	beforeUpdate(e, { value: t, oldValue: n }, r) {
		e[Al] = Dl(r), t !== n && (e.checked = ye(t, r.props.value));
	}
}, Il = {
	deep: !0,
	created(e, { value: t, modifiers: { number: n } }, r) {
		let i = h(t);
		Jc(e, "change", () => {
			let t = Array.prototype.filter.call(e.options, (e) => e.selected).map((e) => n ? ae(Rl(e)) : Rl(e));
			e[Al](e.multiple ? i ? new Set(t) : t : t[0]), e._assigning = !0, zn(() => {
				e._assigning = !1;
			});
		}), e[Al] = Dl(r);
	},
...
function Ul() {
	Ml.getSSRProps = ({ value: e }) => ({ value: e }), Fl.getSSRProps = ({ value: e }, t) => {
		if (t.props && ye(t.props.value, e)) return { checked: !0 };
...
var ou = !1, su = () => {
	...
	withModifiers: () => Kl,
	withScopeId: () => nr
}), lu = () => {}, uu = typeof window < "u", du, fu = (e) => du = e, pu = Symbol();
function mu(e) {
...
var gu = typeof window == "object" && window.window === window ? window : typeof self == "object" && self.self === self ? self : typeof global == "object" && global.global === global ? global : typeof globalThis == "object" ? globalThis : { HTMLElement: null };
function _u(e, { autoBom: t = !1 } = {}) {
...
var xu = typeof navigator == "object" ? navigator : { userAgent: "" }, Su = /Macintosh/.test(xu.userAgent) && /AppleWebKit/.test(xu.userAgent) && !/Safari/.test(xu.userAgent), Cu = uu ? typeof HTMLAnchorElement < "u" && "download" in HTMLAnchorElement.prototype && !Su ? wu : "msSaveOrOpenBlob" in xu ? Tu : Eu : () => {};
function wu(e, t = "download", n) {
	let r = document.createElement("a");
	r.download = t, r.rel = "noopener", typeof e == "string" ? (r.href = e, r.origin === location.origin ? bu(r) : yu(r.href) ? vu(e, t, n) : (r.target = "_blank", bu(r))) : (r.href = URL.createObjectURL(e), setTimeout(function() {
		URL.revokeObjectURL(r.href);
	}, 4e4), setTimeout(function() {
		bu(r);
	}, 0));
}
function Tu(e, t = "download", n) {
	if (typeof e == "string") if (yu(e)) vu(e, t, n);
	else {
	...
	else navigator.msSaveOrOpenBlob(_u(e, n), t);
}
function Eu(e, t, n, r) {
	if (r ||= open("", "_blank"), r && (r.document.title = r.document.body.innerText = "downloading..."), typeof e == "string") return vu(e, t, n);
	let i = e.type === "application/octet-stream", a = /constructor/i.test(String(gu.HTMLElement)) || "safari" in gu, o = /CriOS\/[\d]+/.test(navigator.userAgent);
	if ((o || i && a || Su) && typeof FileReader < "u") {
...
var { assign: Du } = Object;
function Ou() {
	let e = De(!0), t = e.run(() => /* @__PURE__ */ Jt({})), n = [], r = [], i = Gt({
		install(e) {
			fu(i), i._a = e, e.provide(pu, i), e.config.globalProperties.$pinia = i, r.forEach((e) => n.push(e)), r = [];
		},
		use(e) {
...
var Nu = (e) => e(), Pu = Symbol(), Fu = Symbol();
function Iu(e, t) {
	e instanceof Map && t instanceof Map ? t.forEach((t, n) => e.set(n, t)) : e instanceof Set && t instanceof Set && t.forEach(e.add, e);
	for (let n in t) {
		if (!t.hasOwnProperty(n)) continue;
		let r = t[n], i = e[n];
		mu(i) && mu(r) && e.hasOwnProperty(n) && !/* @__PURE__ */ q(r) && !/* @__PURE__ */ Ht(r) ? e[n] = Iu(i, r) : e[n] = r;
	}
	return e;
}
var Lu = Symbol();
function Ru(e) {
	return !mu(e) || !Object.prototype.hasOwnProperty.call(e, Lu);
}
var { assign: zu } = Object;
function Bu(e) {
...
function Vu(e, t, n, r) {
	...
	function l() {
		return s || (n.state.value[e] = i ? i() : {}), zu(/* @__PURE__ */ on(n.state.value[e]), a, Object.keys(o || {}).reduce((t, r) => (t[r] = Gt(Us(() => {
			fu(n);
			let t = n._s.get(e);
			return o[r].call(t, t);
		})), t), {}));
...
function Hu(e, t, n = {}, r, i, a) {
	let o, s = zu({ actions: {} }, n), c = { deep: !0 }, l, u, d = /* @__PURE__ */ new Set(), f = /* @__PURE__ */ new Set(), p = r.state.value[e];
	!a && !p && (r.state.value[e] = {});
	let m;
	function h(t) {
		let n;
	...
	let v = (t, n = "") => {
		...
		let i = function() {
			...
			return l instanceof Promise ? l.then((e) => (Mu(a, e), e)).catch((e) => (Mu(o, e), Promise.reject(e))) : (Mu(a, l), l);
		};
		return i[Pu] = !0, i[Fu] = n, i;
	}, y = /* @__PURE__ */ Lt({
		_p: r,
		$id: e,
		$onAction: ju.bind(null, f),
		$patch: h,
		$reset: g,
		$subscribe(t, n = {}) {
			let i = ju(d, t, n.detached, () => a()), a = o.run(() => pr(() => r.state.value[e], (r) => {
				(n.flush === "sync" ? u : l) && t({
					storeId: e,
					type: hu.direct,
					events: void 0
	...
	r._s.set(e, y);
	let b = (r._a && r._a.runWithContext || Nu)(() => r._e.run(() => (o = De()).run(() => t({ action: v }))));
	for (let t in b) {
		let n = b[t];
		/* @__PURE__ */ q(n) && !Bu(n) || /* @__PURE__ */ Ht(n) ? a || (p && Ru(n) && (/* @__PURE__ */ q(n) ? n.value = p[t] : Iu(n, p[t])), r.state.value[e][t] = n) : typeof n == "function" && (b[t] = v(n, t), s.actions[t] = n);
	}
	return zu(y, b), zu(/* @__PURE__ */ K(y), b), Object.defineProperty(y, "$state", {
		get: () => r.state.value[e],
		set: (e) => {
			h((t) => {
				zu(t, e);
...
function Uu(e, t, n) {
	...
	function a(n, a) {
		let o = J();
		return n ||= o ? sr(pu, null) : null, n && fu(n), n = du, n._s.has(e) || (i ? Hu(e, t, r, n) : Vu(e, r, n)), n._s.get(e);
	}
	return a.$id = e, a;
}
function Wu(e) {
...
function Ju(e, t) {
	return Yo(), es("svg", qu, [...t[0] ||= [ss("path", {
		fill: "currentColor",
...
var Yu = /* @__PURE__ */ Gu(Ku, [["render", Ju]]), Xu = {}, Zu = {
	viewBox: "0 -960 960 960",
	"aria-hidden": "true",
	focusable: "false"
};
function Qu(e, t) {
	return Yo(), es("svg", Zu, [...t[0] ||= [ss("path", {
		fill: "currentColor",
		d: "M280-120q-33 0-56.5-23.5T200-200v-520h-40v-80h200v-40h240v40h200v80h-40v520q0 33-23.5 56.5T680-120H280Zm400-600H280v520h400v-520ZM360-280h80v-360h-80v360Zm160 0h80v-360h-80v360ZM280-720v520-520Z"
	}, null, -1)]]);
}
var $u = /* @__PURE__ */ Gu(Xu, [["render", Qu]]), ed = {
	UNKNOWN: {
		code: "D0001",
...
//#endregion
//#region node_modules/.pnpm/@dialecte+core@0.2.22/node_modules/@dialecte/core/dist/helpers.js
var ad = `${{
...
function pd(e) {
	...
	return sd(r) ? r : Object.entries(r).map(([e, r]) => ({
		name: e,
		value: r,
...
function Q(e) {
	return Z(e, { detail: "The record or ref is undefined" }), {
		id: e.id,
		tagName: e.tagName
	};
}
function md(e) {
	let { dialecteConfig: t, hooks: n, record: r } = e, { id: i, tagName: a, attributes: o, namespace: s, value: c } = r, l = i ?? crypto.randomUUID(), u = o ? pd({
		tagName: a,
		attributes: o,
		dialecteConfig: t
	}) : [], d = {
...
function gd(e) {
	...
	for (let [e, i] of r) i.query && (hd(t[e], i.query, e, "query"), t[e] = {
		...t[e],
		...i.query
	}), i.transaction && (hd(n[e], i.transaction, e, "transaction"), n[e] = {
		...n[e],
		...i.transaction
	});
	return {
...
}, Td = { supportedFileExtensions: [".nsd", ".nsdoc"] }, Ed = {
	singletonElements: Sd,
	elements: _d,
	namespaces: {
		default: {
			uri: "http://www.iec.ch/61850/2016/NSD",
...
}, kd = {}, Ad = Object.create, jd = Object.defineProperty, Md = Object.getOwnPropertyDescriptor, Nd = Object.getOwnPropertyNames, Pd = Object.getPrototypeOf, Fd = Object.prototype.hasOwnProperty, Id = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), Ld = (e, t, n, r) => {
	if (t && typeof t == "object" || typeof t == "function") for (var i = Nd(t), a = 0, o = i.length, s; a < o; a++) s = i[a], !Fd.call(e, s) && s !== n && jd(e, s, {
		get: ((e) => t[e]).bind(null, s),
		enumerable: !(r = Md(t, s)) || r.enumerable
	});
	return e;
}, Rd = (e, t, n) => (n = e == null ? {} : Ad(Pd(e)), Ld(t || !e || !e.__esModule ? jd(n, "default", {
	value: e,
	enumerable: !0
}) : n, e));
function zd(e, t) {
...
function Bd(e) {
	...
	for (let e = t.length - 1; e >= 0; e--) {
		let i = t[e];
		if (r === void 0) {
			if ((i.status === "created" || i.status === "updated") && cd(i.newRecord, n)) return {
				...i.newRecord,
				status: i.status
			};
			if (i.status === "deleted" && cd(i.oldRecord, n)) return {
				...i.oldRecord,
				status: "deleted"
			};
			continue;
		...
		if (i.status === "created" && i.newRecord.id === r) {
			...
			return e !== n && td("ELEMENT_TAGNAME_MISMATCH", {
...
async function $(e) {
	...
	let r;
	if (n.id === void 0) {
		let e = `__singleton_${n.tagName}`, i = Rp(t) ? t.recordCache.get(e) : void 0;
		i ? r = i : (r = (await t.store.getByTagNameInDocument(n.tagName, t.documentId))[0], r && Rp(t) && (t.recordCache.set(r.id, r), t.recordCache.set(e, r)));
	} else {
		let e = Rp(t) ? t.recordCache.get(n.id) : void 0;
		e ? r = e : (r = await t.store.get(n.id, t.documentId), r && Rp(t) && t.recordCache.set(n.id, r));
	}
	if (r) return {
		...r,
		status: "unchanged"
...
async function Gd(e) {
	...
	for (let e of r) Rp(t) && t.recordCache.set(e.id, e);
	return Vd({
		rawRecords: r,
		stagedOperations: t.stagedOperations,
		tagName: n
...
async function Yd(e) {
	let { context: t, tagName: n, attributes: r } = e, i = await Gd({
		context: t,
		tagName: n
	}), a = [];
	for (let e of i) Xd({
...
async function Zd(e) {
	let { context: t, ref: n, options: r } = e, { collect: i, omit: a } = r, o = Qd(a), s = ef(i), c = /* @__PURE__ */ new Map();
	for (let e of s.allTags) c.set(e, /* @__PURE__ */ new Map());
	let l = await $({
		context: t,
		ref: n
	});
	return l && (s.mode === "flat" ? await rf({
		context: t,
		rootId: l.id,
		collectSpec: s,
		omitSpec: o,
...
function $d(e) {
	...
	for (let e of n.conditional) if (e.tagName === t.tagName && Xd({
		record: t,
...
async function sf(e) {
	...
	for (let e of r) {
		...
		for (let n of r) a.get(e.tagName).set(n.id, n), !e.isLeaf && e.children.length > 0 && await sf({
			context: t,
			record: n,
...
function _f(e) {
	...
	return n.unconditional.has(t.tagName) ? !0 : n.conditional.some((e) => e.scope === "self" && e.tagName === t.tagName && Xd({
		record: t,
		attributeFilter: e.where
	}));
}
function vf(e) {
	let { record: t, compiledOmit: n } = e;
	return n.conditional.some((e) => e.scope === "children" && e.tagName === t.tagName && Xd({
		record: t,
		attributeFilter: e.where
	}));
}
...
async function xf(e) {
	let { context: t, ref: n, options: r = {}, dialecteConfig: i } = e, { select: a, omit: o, unwrap: s } = r, c = await $({
		context: t,
		ref: n
	});
	Z(c, {
	...
	let l = gf(o), u = t.dialecteConfig.transparentElements, d = await Sf({
		context: t,
		record: c,
		select: a,
		compiledOmit: l,
...
async function Sf(e) {
	...
	return fd({
		record: n,
		tree: (await Promise.all(s.map(({ record: e, select: n }) => Sf({
			context: t,
			record: e,
			select: n,
			compiledOmit: i,
...
var Tf = new Set(["where", "recursive"]);
function Ef(e) {
	let t = /* @__PURE__ */ new Set();
	for (let n of Object.keys(e)) Tf.has(n) || t.add(n);
	return t;
}
function Df(e) {
...
function Of(e) {
	...
	if (!(!r || n.recursive === !1) && r.children[t.tagName]?.includes(t.tagName) && !(n.where && !Xd({
		record: t,
...
async function jf(e) {
	...
	if (!n && i === void 0) return Mf({
		context: t,
		includeDeleted: a
	});
	let o = e.siblings ?? !1, s = o === !0 || typeof o == "object" && !!o, c = typeof o == "object" && !!o && o.expand === !0, l = n ?? { tagName: t.dialecteConfig.rootElementName }, u = /* @__PURE__ */ new Map(), d = /* @__PURE__ */ new Map(), f = a ? Ud(t.stagedOperations) : void 0, p = (e) => {
...
async function Mf(e) {
	let { context: t, includeDeleted: n = !1 } = e, { live: r, deleted: i } = Hd({
...
})), If = /* @__PURE__ */ Rd((/* @__PURE__ */ Id(((e, t) => {
...
function Lf(e) {
	return (0, If.default)(e);
}
function Rf(e) {
	return Lf("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" + new XMLSerializer().serializeToString(e));
}
async function zf(e) {
	let { extension: t, xmlDocument: n, filename: r } = e, i = Rf(n);
	await id({
...
function Bf(e) {
	let { records: t, config: n, withDatabaseIds: r = !1, rootId: i } = e, a = /* @__PURE__ */ new Map(), o;
	for (let e of t) a.set(e.id, e), e.tagName === n.rootElementName && (o = e);
	let s = i ? a.get(i) : o;
	Z(s, {
		detail: i ? `No record found for rootId "${i}"` : `No ${n.rootElementName} root element found in records`,
		key: "EXPORT_ROOT_NOT_FOUND"
	});
	let c = s.tagName !== n.rootElementName, l = n.namespaces.default, u = document.implementation.createDocument(l.uri, null, null), d = u.createElementNS(s.namespace.uri, s.tagName);
	return d.setAttribute("xmlns", s.namespace.uri), s.attributes && Uf({
		config: n,
		document: u,
		element: d,
	...
	}), s.value && (d.textContent = s.value.trim()), r && d.setAttribute("_temp-idb-id", s.id), u.appendChild(d), Vf({
		index: a,
		config: n,
		withDatabaseIds: r,
		xmlDocument: u,
...
function Hf(e) {
	...
	return !s && r.namespace.prefix && r.namespace.prefix !== "xmlns" ? (Wf({
		config: t,
		document: n,
		namespace: r.namespace,
		isFragment: o
	}), c = n.createElementNS(r.namespace.uri, `${r.namespace.prefix}:${r.tagName}`)) : c = n.createElementNS(r.namespace.uri, r.tagName), r.attributes && Uf({
		config: t,
		document: n,
		element: c,
...
function Wf(e) {
	...
	a.getAttributeNS(o, r.prefix) === null && (a.setAttributeNS(o, `xmlns:${r.prefix}`, r.uri), i || Gf({
		config: t,
		rootElement: a,
		namespace: r
	}));
...
function Jf(e) {
	return !!(e.name === "xmlns" || e.name.startsWith("xmlns:") || qf(e) && e.namespace?.prefix === "xmlns");
}
function Yf(e) {
	let { config: t, tagName: n, attribute: r } = e;
	if (!t.elements.includes(n)) return !1;
	let i = t.definition[n];
	if (!i) return !1;
	let a = i.attributes.details[r.name];
	return !(!a || a.required || i.attributes.identityFields?.includes(r.name));
}
var Xf = /* @__PURE__ */ Id(((e, t) => {
	t.exports = {};
})), Zf = /* @__PURE__ */ Rd((/* @__PURE__ */ Id(((e) => {
	(function(e) {
		...
		function O(e, t) {
			if (!(!e.strict || !e.encoding || !t || t.name !== "xml")) {
				var n = ee(t.body);
				n && !ne(e.encoding, n) && N(e, "XML declaration encoding " + n + " does not match detected stream encoding " + e.encoding.toUpperCase());
			}
		}
		function k(e, t, n) {
			e.textNode && A(e), D(e, t, n);
		}
		function A(e) {
			e.textNode = re(e.opt, e.textNode), e.textNode && D(e, "ontext", e.textNode), e.textNode = "";
		}
		function re(e, t) {
		...
		function M(e) {
			return e.sawRoot && !e.closedRoot && N(e, "Unclosed root tag"), e.state !== T.BEGIN && e.state !== T.BEGIN_WHITESPACE && e.state !== T.TEXT && j(e, "Unexpected end"), A(e), e.c = "", e.closed = !0, D(e, "onend"), n.call(e, e.strict, e.opt), e;
		}
		function N(e, t) {
		...
		function P(t) {
			...
			for (var i = 0, a = ""; a = de(t, i++), n.c = a, a;) switch (n.trackPosition && (n.position++, a === "\n" ? (n.line++, n.column = 0) : n.column++), n.state) {
				case T.BEGIN:
				...
				case T.TEXT:
					if (n.sawRoot && !n.closedRoot) {
						for (var o = i - 1; a && a !== "<" && a !== "&";) a = de(t, i++), a && n.trackPosition && (n.position++, a === "\n" ? (n.line++, n.column = 0) : n.column++);
				...
				case T.COMMENT_ENDED:
					...
					continue;
				case T.CDATA:
					for (var o = i - 1; a && a !== "]";) a = de(t, i++), a && n.trackPosition && (n.position++, a === "\n" ? (n.line++, n.column = 0) : n.column++);
				...
				case T.PROC_INST_ENDING:
					if (a === ">") {
						...
						O(n, e), k(n, "onprocessinginstruction", e), n.procInstName = n.procInstBody = "", n.state = T.TEXT;
					} else n.procInstBody += "?" + a, n.state = T.PROC_INST_BODY;
					continue;
				case T.OPEN_TAG:
					C(_, a) ? n.tagName += a : (ie(n), a === ">" ? se(n) : a === "/" ? n.state = T.OPEN_TAG_SLASH : (b(a) || N(n, "Invalid character in tag name"), n.state = T.ATTRIB));
					continue;
				case T.OPEN_TAG_SLASH:
					a === ">" ? (se(n, !0), ce(n)) : (N(n, "Forward-slash in opening tag not followed by >"), n.state = T.ATTRIB);
					continue;
				case T.ATTRIB:
					if (b(a)) continue;
					a === ">" ? se(n) : a === "/" ? n.state = T.OPEN_TAG_SLASH : C(g, a) ? (n.attribName = a, n.attribValue = "", n.state = T.ATTRIB_NAME) : N(n, "Invalid attribute name");
					continue;
				case T.ATTRIB_NAME:
					a === "=" ? n.state = T.ATTRIB_VALUE : a === ">" ? (N(n, "Attribute without value"), n.attribValue = n.attribName, oe(n), se(n)) : b(a) ? n.state = T.ATTRIB_NAME_SAW_WHITE : C(_, a) ? n.attribName += a : N(n, "Invalid attribute name");
					continue;
				case T.ATTRIB_NAME_SAW_WHITE:
					if (a === "=") n.state = T.ATTRIB_VALUE;
						...
						name: n.attribName,
						value: ""
					}), n.attribName = "", a === ">" ? se(n) : C(g, a) ? (n.attribName = a, n.state = T.ATTRIB_NAME) : (N(n, "Invalid attribute name"), n.state = T.ATTRIB);
					continue;
				case T.ATTRIB_VALUE:
					if (b(a)) continue;
				...
				case T.ATTRIB_VALUE_CLOSED:
					b(a) ? n.state = T.ATTRIB : a === ">" ? se(n) : a === "/" ? n.state = T.OPEN_TAG_SLASH : C(g, a) ? (N(n, "No whitespace between attributes"), n.attribName = a, n.attribValue = "", n.state = T.ATTRIB_NAME) : N(n, "Invalid attribute name");
					continue;
				case T.ATTRIB_VALUE_UNQUOTED:
					...
					oe(n), a === ">" ? se(n) : n.state = T.ATTRIB;
					continue;
				case T.CLOSE_TAG:
					if (n.tagName) a === ">" ? ce(n) : C(_, a) ? n.tagName += a : n.script ? (n.script += "</" + n.tagName + a, n.tagName = "", n.state = T.SCRIPT) : (b(a) || N(n, "Invalid tagname in closing tag"), n.state = T.CLOSE_TAG_SAW_WHITE);
					else {
						if (b(a)) continue;
				...
				case T.CLOSE_TAG_SAW_WHITE:
					if (b(a)) continue;
					a === ">" ? ce(n) : N(n, "Invalid characters in closing tag");
					continue;
				case T.TEXT_ENTITY:
...
function ep(e) {
	let { dialecteConfig: t, useCustomRecordsIds: n, session: r } = e, i = t.io.hooks, a = {
	...
	o.onopentag = (e) => a = tp({
		...
		text: e,
		state: a
	}), o.onclosetag = () => ({updatedState: a} = rp({
		state: a,
		ioHooks: i,
		session: r
	})), o.onerror = ip;
...
function tp(e) {
	let { node: t, state: n, dialecteConfig: r, useCustomRecordsIds: i } = e, a = { ...n }, o = ap(t);
	a.defaultNamespace ||= op({
		element: t,
		defaultNamespace: r.namespaces.default,
		rootElementName: r.rootElementName
	});
	let s = sp(t, a.defaultNamespace), c = {
		id: up({
...
function rp(e) {
	let { state: t, ioHooks: n, session: r } = e, i = t.stack.at(-1), a = t.stack.slice(0, -1), o = [...t.recordsBatch];
	if (i) {
		...
		} else i.parent && r.registerPendingChild(i.parent.id, {
			id: i.id,
			tagName: i.tagName
		});
		o.push(i);
...
function op(e) {
	...
	return Z(t.name === r, { detail: `Expected root element <${r}>, got <${t.name}>` }), t.attributes?.xmlns?.value ? {
		prefix: "",
...
function up(e) {
	let { attributes: t, useCustomRecordsIds: n } = e, r = t[ad];
	return n && r && r.value ? r.value : crypto.randomUUID();
}
function dp(e) {
	let { attributes: t, useCustomRecordsIds: n } = e;
	return n ? Object.values(t).filter((e) => e.name !== ad) : Object.values(t);
}
var fp = 32 * 1024, pp = 2e3;
async function mp(e) {
	let { documentId: t, store: n, config: r, useCustomRecordsIds: i = !1, chunkOptions: a } = e, { file: o } = e, { supportedFileExtensions: s } = r.io;
	if (Z(s.some((e) => o.name.toLowerCase().endsWith(e)), {
		key: "ASSERTION_FAILED",
		detail: `Unsupported file type: ${o.name}`
	}), o.size === 0) return {
		documentId: t,
		recordCount: 0
	};
	let c = r.io.hooks?.beforeImport;
	if (c) {
		let e = c(await o.text());
		o = new File([e], o.name, { type: o.type });
	}
	let l = a?.chunkSize ?? fp, u = a?.batchSize ?? pp, d = new Qf(), f = ep({
		dialecteConfig: r,
		useCustomRecordsIds: i,
		session: d
	});
...
async function hp(e) {
	...
	for (; !f;) {
		let e = await l.read();
		if (f = e.done, f) {
			d.length > 0 && n.parser.write(u.decode(d)), n.parser.close(), c += await vp({
				sax: n,
				session: r,
				store: i,
				documentId: a,
		...
		if (e.value) for (d = _p(d, e.value); d.length >= o;) {
			let e = u.decode(d.slice(0, o), { stream: !0 });
			d = d.slice(o), n.parser.write(e), c += await vp({
				sax: n,
				session: r,
				store: i,
				documentId: a,
...
async function gp(e) {
	let { config: t, store: n, documentId: r } = e;
	if (!t.io.hooks?.afterImport) return 0;
	let { creates: i, updates: a, deletes: o } = await t.io.hooks.afterImport();
...
async function yp(e) {
	let { context: t, options: n = {} } = e, { ref: r, ancestors: i, siblings: a, depth: o, includeDeleted: s, omit: c, unwrap: l, as: u = "tree" } = n, d = await jf({
		context: t,
		ref: r ? Q(r) : void 0,
		ancestors: i,
		siblings: a,
...
var Sp = class {
	...
	async findDescendants(e) {
		let t = Q(e), n = this.dialecteConfig.descendants[t.tagName] ?? [];
		return Zd({
			context: this.getContext(),
			ref: t,
			options: { collect: n }
	...
	get any() {
		return this._any ??= new Sp(() => this.context, this.dialecteConfig);
	}
	getOperations() {
		return [];
	}
...
function wp(e) {
	...
	r && (o = ud(r)), i && (s = ud(i)), a && (c = ud(a)), n === "created" ? (Z(o, {
...
async function Ep(e) {
	let { dialecteConfig: t, hooks: n, context: r, query: i, parentRef: a, params: o } = e, { id: s, tagName: c, attributes: l, namespace: u, value: d } = o, f = await $({
		context: r,
		ref: a
	});
	Z(f, {
...
async function Dp(e) {
	let { dialecteConfig: t, hooks: n, context: r, query: i, parentRef: a, record: o, cumulativeCloneMappings: s } = e, c = [], l = await Op({
		dialecteConfig: t,
		hooks: n,
		context: r,
		query: i,
...
async function kp(e) {
	let { hooks: t, context: n, query: r, ref: i } = e, a = await $({
		context: n,
		ref: i
	});
	Z(a, {
...
async function Ap(e) {
	...
	for (let e of n.children) {
		...
		n && (n.children.length > 0 && await Ap({
			context: t,
			record: n
		}), wp({
			context: t,
...
async function jp(e) {
	let { dialecteConfig: t, hooks: n, context: r, query: i, parentRef: a, params: o } = e, s = Mp(o.attributes);
	if (s) {
		let [e] = await Yd({
			context: r,
			tagName: o.tagName,
...
async function Np(e) {
	let { dialecteConfig: t, hooks: n, context: r, query: i, ref: a, params: o } = e, { attributes: s, value: c } = o, l = await $({
		context: r,
		ref: a
	});
	Z(l, {
...
async function Ip(e) {
	let { stagedOperations: t, store: n, documentId: r, documentState: i } = e, { creates: a, updates: o, deletes: s } = Fp(t), c = a.length + o.length + s.length;
...
var Lp = class extends Cp {
	...
	get any() {
		return this._anyTx ??= new Pp(() => this.context, this.dialecteConfig, this.hooks, this);
	}
	getOperations() {
...
var zp = class {
	...
	withQueryExtensions(e) {
		let t = zd(this.extensionsRegistry?.query, e);
		return Object.assign(e, t);
	}
	withAllExtensions(e) {
		let t = zd(this.extensionsRegistry?.query, e), n = zd(this.extensionsRegistry?.transaction, e), r = {};
	...
	createQuery() {
		return new Cp(this.store, this.config, this.documentId);
	}
	get query() {
		return this.withQueryExtensions(this.createQuery());
	}
	createTransaction() {
		return new Lp(this.store, this.config, this.documentId, this.state, this.hooks);
	}
	async transaction(e, t) {
		this.activeTransactions > 0 && td("CONCURRENT_TRANSACTION", { detail: `${this.activeTransactions} transaction(s) already active. Concurrent transactions risk lost updates — serialize them or implement a transaction queue.` }), this.activeTransactions++, this.state.loading = !0, this.state.error = null;
		let n = this.withAllExtensions(this.createTransaction());
		try {
			let r = await e(n);
			return await n.commit(), this.channel.postMessage({
				type: "commit",
				documentId: this.documentId,
				timestamp: Date.now()
			...
			throw this.state.progress = null, this.state.error ?? td("UNKNOWN", {
	...
	async prepare(e, t) {
		...
		try {
			...
			throw this.activeTransactions--, this.state.loading = !1, this.state.error ?? td("UNKNOWN", {
				detail: e instanceof Error ? e.message : String(e),
				cause: e instanceof Error ? e : void 0
			});
		}
		...
		return {
			...
			commit: async () => {
				if (!a) {
					...
					try {
						await n.commit(), this.channel.postMessage({
							type: "commit",
							documentId: this.documentId,
							timestamp: Date.now()
						}), n.clearStagedOperations(), n.clearRecordCache(), n.clearCumulativeCloneMappings(), this.state.history.push({
						...
						throw this.state.error ?? td("UNKNOWN", {
							detail: e instanceof Error ? e.message : String(e),
							cause: e instanceof Error ? e : void 0
						});
					} finally {
...
}, Bp = "_documents", Vp = "_changeLog", Hp = "_meta", Up = "xel_";
function Wp(e) {
	return `${Up}${e}`;
}
var Gp = "_blobs", Kp = "blob_";
function qp(e) {
	return `${Kp}${e}`;
}
var Jp = {
	...
	(function(n, r) {
		...
		var O = typeof Symbol < "u" ? Symbol.iterator : "@@iterator", k = typeof O == "symbol" ? function(e) {
			var t;
		...
		function ce(e, t, n, r) {
			this.failures = t, this.failedKeys = r, this.successCount = n, this.message = se(e, t);
		}
		function le(e, t) {
			this.name = "BulkError", this.failures = Object.keys(t).map(function(e) {
				return t[e];
			}), this.failuresByPos = t, this.message = se(e, this.failures);
		}
		p(oe).from(Error).extend({ toString: function() {
			return this.name + ": " + this.message;
		} }), p(ce).from(oe), p(le).from(oe);
		var ue = ie.reduce(function(e, t) {
			return e[t] = t + "Error", e;
		}, {}), de = oe, P = ie.reduce(function(e, t) {
			var n = t + "Error";
			function r(e, r) {
			...
			return p(r).from(de), e[t] = r, e;
		}, {});
		P.Syntax = SyntaxError, P.Type = TypeError, P.Range = RangeError;
		var fe = N.reduce(function(e, t) {
			return e[t + "Error"] = P[t], e;
		}, {}), pe = ie.reduce(function(e, t) {
			return [
				"Syntax",
				"Type",
				"Range"
			].indexOf(t) === -1 && (e[t + "Error"] = P[t]), e;
		}, {});
		function F() {}
		function me(e) {
			return e;
		...
		function ye(e, t) {
			return e === F ? t : function(n) {
				var r = e.apply(this, arguments);
				o(n, r);
				var i = this.onsuccess, a = this.onerror;
				return this.onsuccess = null, this.onerror = null, n = t.apply(this, arguments), i && (this.onsuccess = this.onsuccess ? ge(i, this.onsuccess) : i), a && (this.onerror = this.onerror ? ge(a, this.onerror) : a), r === void 0 ? n === void 0 ? void 0 : n : o(r, n);
			};
		}
		function be(e, t) {
			return e === F ? t : function() {
		...
		pe.ModifyError = ce, pe.DexieError = oe, pe.BulkError = le;
		...
		}(), N = T[0], ie = T[1], T = T[2], ie = ie && ie.then, I = N && N.constructor, Ee = !!T, De = function(e, t) {
			Ne.push([e, t]), ke &&= (queueMicrotask(He), !1);
		}, Oe = !0, ke = !0, L = [], Ae = [], je = me, Me = {
			id: "global",
			global: !0,
			ref: 0,
			unhandleds: [],
		...
		function Ve(e, t, n) {
			try {
				var r, i = t._value;
				!t._state && Ae.length && (Ae = []), r = Se && t._consoleTask ? t._consoleTask.run(function() {
					return e(i);
		...
		("" + ie).indexOf("[native code]") === -1 && (et = tt = F);
		...
		var Ct = (U.prototype._trans = function(e, t, n) {
			var r = this._tx || R.trans, i = this.name, a = Se && typeof console < "u" && console.createTask && console.createTask(`Dexie: ${e === "readonly" ? "read" : "write"} ${this.name}`);
			function o(e, n, r) {
				if (!r.schema[i]) throw new P.NotFound("Table " + i + " not part of transaction");
				...
				var c = r && r.db._novip === this.db._novip ? r === R.trans ? r._promise(e, o, n) : $e(function() {
					...
					if (t.idbdb && (t._state.openComplete || R.letThrough || t._vip)) {
						...
						try {
							...
							return a.name === ue.InvalidState && t.isOpen() && 0 < --t._state.PR1398_maxLoop ? (console.warn("Dexie: Need to reopen db"), t.close({ disableAutoOpen: !1 }), t.open().then(function() {
								return e(t, n, r, i);
							})) : V(a);
						}
					...
					if (t._state.openComplete) return V(new P.DatabaseClosed(t._state.dbOpenError));
					if (!t._state.isBeingOpened) {
						if (!t._state.autoOpen) return V(new P.DatabaseClosed());
						t.open().catch(F);
					}
			...
			var n = this;
			return e && e.constructor === Object ? this.where(e).first(t) : e == null ? V(new P.Type("Invalid argument to Table.get()")) : this._trans("readonly", function(t) {
				return n.core.get({
					trans: t,
					key: e
				}).then(function(e) {
			...
			!n && Se && console.warn(`The query ${JSON.stringify(e)} on ${this.name} would benefit from a compound index [${t.join("+")}]`);
			...
			return typeof e != "object" || a(e) ? this.where(":id").equals(e).modify(t) : (e = b(e, this.schema.primKey.keyPath), e === void 0 ? V(new P.InvalidArgument("Given object does not contain its primary key")) : this.where(":id").equals(e).modify(t));
			...
			return this._trans("readwrite", function(t) {
				...
				if (n && i) throw new P.InvalidArgument("bulkAdd(): keys argument invalid on tables with inbound keys");
				if (i && i.length !== e.length) throw new P.InvalidArgument("Arguments objects and keys must have the same length");
				...
				return r.core.mutate({
					...
					if (t === 0) return a ? n : i;
					throw new le(`${r.name}.bulkAdd(): ${t} of ${s} operations failed`, e);
				});
			});
			...
			return this._trans("readwrite", function(t) {
				var n = r.schema.primKey, o = n.auto, n = n.keyPath;
				if (n && i) throw new P.InvalidArgument("bulkPut(): keys argument invalid on tables with inbound keys");
				if (i && i.length !== e.length) throw new P.InvalidArgument("Arguments objects and keys must have the same length");
				var s = e.length, n = n && o ? e.map(vt(n)) : e;
				return r.core.mutate({
					trans: t,
					...
					var t = e.numFailures, n = e.results, i = e.lastResult, e = e.failures;
					if (t === 0) return a ? n : i;
					throw new le(`${r.name}.bulkPut(): ${t} of ${s} operations failed`, e);
				});
			});
			...
			return this._trans("readwrite", function(o) {
				return n.getMany({
						...
						if (o) {
							for (var u = 0, d = Object.keys(i); u < d.length; u++) {
								...
								if (f === t.schema.primKey.keyPath) {
									if (H(p, r) !== 0) throw new P.Constraint("Cannot update primary key in bulkUpdate()");
								} else x(o, f, p);
							}
					...
					return n.mutate({
						...
						throw new le(`${t.name}.bulkUpdate(): ${n} of ${u} operations failed`, r);
					});
				});
			});
			...
			return this._trans("readwrite", function(n) {
				...
				if (r === 0) return i;
				throw new le(`${t.name}.bulkDelete(): ${r} of ${n} operations failed`, e);
			});
		}, U);
		function U() {}
		function wt(e) {
			...
			function s(e, r, o) {
				...
				i(c = e).forEach(function(e) {
					...
					if (a(t)) s(e, c[e][0], c[e][1]);
						...
						if (t !== "asap") throw new P.InvalidArgument("Invalid event config");
		...
		function kt(e, t) {
			...
			if (!n) throw new P.Schema("KeyPath " + e.index + " on object store " + t.name + " is not indexed");
			return n;
		}
		function At(e, t, n) {
			var r = kt(e, t.schema);
			...
			return this._write(function(r) {
				...
				return t.clone().primaryKeys().then(function(t) {
					...
					return i(0).then(function() {
						if (0 < m.length) throw new ce("Error modifying one or more objects", m, h, g);
						return t.length;
					});
				});
			});
			...
			return !Et(e) || e.table.schema.yProps || !e.isPrimKey && t.type !== 3 ? this.modify(It) : this._write(function(n) {
				...
				return e.table.core.count({
					...
					return e.table.core.mutate({
						...
						if (e) throw new ce("Could not delete some values", Object.keys(n).map(function(e) {
							return n[e];
						}), t - e);
						return t - e;
					});
		...
		var Wt = (Object.defineProperty(G.prototype, "Collection", {
			...
			})) return zt(this, "First argument to inAnyRange() must be an Array of two-value Arrays [lower,upper] where upper must not be lower than lower", P.InvalidArgument);
		...
		var Kt = "storagemutated", qt = "x-storagemutated-1", q = wt(null, Kt), Jt = (Yt.prototype._lock = function() {
			...
			if (v(!this.idbtrans), !e && !n) switch (r && r.name) {
				case "DatabaseClosedError": throw new P.DatabaseClosed(r);
				case "MissingAPIError": throw new P.MissingAPI(r.message, r);
				default: throw new P.OpenFailed(r);
			}
			...
			return v(this._completion._state === null), (e = this.idbtrans = e || (this.db.core || n).transaction(this.storeNames, this.mode, { durability: this.chromeTransactionDurability })).onerror = B(function(n) {
				...
				Gt(n), t.active && t._reject(new P.Abort(e.error)), t.active = !1, t.on("abort").fire(n);
			...
			var r = this;
			if (e === "readwrite" && this.mode !== "readwrite") return V(new P.ReadOnly("Transaction is readonly"));
			if (!this.active) return V(new P.TransactionInactive());
			...
			if (l(t, e)) return t[e];
			var n = this.schema[e];
			if (!n) throw new P.NotFound("Table " + e + " not part of transaction");
					...
					return a = t, s = o, c = n, l = [], t = (r = e)._versions, u = r._dbSchema = _n(0, r.idbdb, c), (t = t.filter(function(e) {
						...
						l.push(function() {
							...
							o.add.forEach(function(e) {
								...
								if (e.recreate) throw new P.Upgrade("Not yet support for changing primary key");
			...
			for (var r = 0, i = pn(n, e._dbSchema).change; r < i.length; r++) {
				var a = function(e) {
					...
					e.add.forEach(function(t) {
						Se && console.debug(`Dexie upgrade patch: Creating missing index ${e.name}.${t.src}`), gn(n, t);
					});
				}(i[r]);
		...
		function hn(e, t) {
			i(e).forEach(function(n) {
				t.db.objectStoreNames.contains(n) || (Se && console.debug("Dexie: Creating missing table", n), mn(t, n, e[n].primKey, e[n].indexes));
			});
		}
		function gn(e, t) {
		...
		var bn = (xn.prototype._createTableSchema = Qt, xn.prototype._parseIndexSyntax = yn, xn.prototype._parseStoresSpec = function(e, t) {
			...
			i(e).forEach(function(r) {
				if (e[r] !== null) {
					...
					if (!a) throw new P.Schema("Invalid schema for table " + r + ": " + e[r]);
					if (a.unique = !0, a.multi) throw new P.Schema("Primary key cannot be multiEntry*");
					i.forEach(function(e) {
						if (e.auto) throw new P.Schema("Only primary key can be marked as autoIncrement (++)");
						if (!e.keyPath) throw new P.Schema("Index must have a name and cannot be an empty string");
			...
			return this._cfg.contentUpgrade = xe(this._cfg.contentUpgrade || F, e), this;
		}, xn);
		function xn() {}
		function Sn(e, t) {
			var n = e._dbNamesDB;
		...
		function Vn(e) {
			...
			function s() {
				if (t.openCanceller !== r) throw new P.DatabaseClosed("db.open() was cancelled");
			}
			function c() {
				return new z(function(r, l) {
					if (s(), !n) throw new P.MissingAPI();
					var u = e.name, p = t.autoSchema || !a ? n.open(u) : n.open(u, a);
					if (!p) throw new P.MissingAPI();
					p.onerror = K(l), p.onblocked = B(e._fireOnBlocked), p.onupgradeneeded = B(function(r) {
						...
						d = p.transaction, t.autoSchema && !e._options.allowEmptyDB ? (p.onerror = Gt, d.abort(), p.result.close(), (i = n.deleteDatabase(u)).onsuccess = i.onerror = B(function() {
							l(new P.NoSuchDatabase(`Database ${u} doesnt exist`));
						...
						ft.push(e), _.onversionchange = B(function(n) {
							...
							e.on("close").fire(t);
						}), f && (h = e._deps, y = u, _ = h.indexedDB, h = h.IDBKeyRange, Cn(_) || y === pt || Sn(_, h).put({ name: y }).catch(F)), r();
					}, l);
				}).catch(function(e) {
					switch (e?.name) {
						case "UnknownError":
			...
			return z.race([r, (typeof navigator > "u" ? z.resolve() : !navigator.userAgentData && /Safari\//.test(navigator.userAgent) && !/Chrom(e|ium)\//.test(navigator.userAgent) && indexedDB.databases ? new Promise(function(e) {
				...
				return s(), t.onReadyBeingFired = [], z.resolve(wn(function() {
					...
					if (0 < t.onReadyBeingFired.length) {
						var r = t.onReadyBeingFired.reduce(xe, F);
		...
		function Gn(e, t, n, r) {
			return n ||= {}, r ||= "", i(e).forEach(function(i) {
				var a, o, s;
				l(t, i) ? (a = e[i], o = t[i], typeof a == "object" && typeof o == "object" && a && o ? (s = ne(a)) === ne(o) ? s === "Object" ? Gn(a, o, n, r + i + ".") : a !== o && (n[r + i] = t[i]) : n[r + i] = t[i] : a !== o && (n[r + i] = t[i])) : n[r + i] = void 0;
			...
			create: function(e) {
				...
				return t(t({}, e), {
					transaction: function(t, n, r) {
						if (R.subscr && n !== "readonly") throw new P.ReadOnly(`Readwrite transaction in liveQuery context. Querier source: ${R.querier}`);
								...
								if (a.abort(), r === "readwrite") {
									for (var o = /* @__PURE__ */ new Set(), c = 0, l = t; c < l.length; c++) {
										...
										if (d) {
											...
											if (s._explicit && i && s.mutatedParts) for (var m = 0, h = Object.values(d.queries.query); m < h.length; m++) for (var g = 0, _ = (b = h[m]).slice(); g < _.length; g++) Pn((x = _[g]).obsSet, s.mutatedParts) && (A(b, x), x.subscribers.forEach(function(e) {
												return o.add(e);
											}));
											else if (0 < p.length) {
												...
												for (var v = 0, y = Object.values(d.queries.query); v < y.length; v++) for (var b, x, S, C = 0, w = (b = y[v]).slice(); C < w.length; C++) (x = w[C]).res != null && s.mutatedParts && (i && !x.dirty ? (S = Object.isFrozen(x.res), S = tr(x.res, x.req, p, f, x, S), x.dirty ? (A(b, x), x.subscribers.forEach(function(e) {
													return o.add(e);
												})) : S !== x.res && (x.res = S, x.promise = z.resolve({ result: S }))) : (x.dirty && A(b, x), x.subscribers.forEach(function(e) {
													return o.add(e);
												})));
											}
										}
						...
						return t(t({}, i), {
							mutate: function(e) {
								...
								return s ? (o = i.mutate(e), e.type !== "add" && e.type !== "put" || !(50 <= e.values.length || Kn(a, e).some(function(e) {
									...
									0 < t.numFailures && (A(s.optimisticOps, e), (t = $n(0, e, t)) && s.optimisticOps.push(t), e.mutatedParts && Rn(e.mutatedParts));
								}), o.catch(function() {
									A(s.optimisticOps, e), e.mutatedParts && Rn(e.mutatedParts);
								})) : o.then(function(n) {
		...
		var sr = (J.prototype.version = function(e) {
			if (isNaN(e) || e < .1) throw new P.Type("Given version is not a positive number");
			if (e = Math.round(10 * e) / 10, this.idbdb || this._state.isBeingOpened) throw new P.Schema("Cannot add version when database is open");
			...
			return this.idbdb && (this._state.openComplete || R.letThrough || this._vip) ? e() : new z(function(e, n) {
				if (t._state.openComplete) return n(new P.DatabaseClosed(t._state.dbOpenError));
				if (!t._state.isBeingOpened) {
					if (!t._state.autoOpen) return void n(new P.DatabaseClosed());
					t.open().catch(F);
				}
			...
			t ? (e.isBeingOpened && e.cancelOpen(new P.DatabaseClosed()), this._close(), e.autoOpen = !1, e.dbOpenError = new P.DatabaseClosed()) : (this._close(), e.autoOpen = this._options.autoOpen || e.isBeingOpened, e.openComplete = !1, e.dbOpenError = null);
			...
			return new z(function(i, a) {
				function o() {
					...
					n.onsuccess = B(function() {
						...
						e = e.IDBKeyRange, Cn(r) || n === pt || Sn(r, e).delete(n).catch(F), i();
					}), n.onerror = K(a), n.onblocked = t._fireOnBlocked;
				}
				if (n) throw new P.InvalidArgument("Invalid closeOptions argument to db.delete()");
			...
			var e = function(e, t, n) {
				...
				if (r < 2) throw new P.InvalidArgument("Too few arguments");
			...
			try {
				if (o = t.map(function(e) {
					...
					if (e != "rw" && e != ht) throw new P.InvalidArgument("Invalid transaction mode: " + e);
					a = ht;
				}
				if (i) {
					if (i.mode === mt && a === ht) {
						if (!s) throw new P.SubTransaction("Cannot enter a sub-transaction with READWRITE mode when parent transaction is READONLY");
						i = null;
					}
					i && o.forEach(function(e) {
						if (i && i.storeNames.indexOf(e) === -1) {
							if (!s) throw new P.SubTransaction("Table " + e + " not included in parent transaction.");
							i = null;
						}
					}), s && i && !i.active && (i = null);
				}
			...
			var c = function e(t, n, r, i, a) {
				return z.resolve().then(function() {
					...
					if (s.explicit = !0, o = {
						...
						return i.name === ue.InvalidState && t.isOpen() && 0 < --t._state.PR1398_maxLoop ? (console.warn("Dexie: Need to reopen db"), t.close({ disableAutoOpen: !1 }), t.open().then(function() {
					...
					return l && et(), o = z.follow(function() {
						...
						return s.active ? e : V(new P.PrematureCommit("Transaction committed too early. See http://bit.ly/2kdckMn"));
					}) : o.then(function() {
						return c;
					})).then(function(e) {
			...
			if (!l(this._allTables, e)) throw new P.InvalidTable(`Table ${e} does not exist`);
		...
		function J(e, n) {
			...
			u.dbReadyPromise = new z(function(e) {
				...
				u.cancelOpen = t;
			}), this._state = u, this.name = e, this.on = wt(this, "populate", "blocked", "versionchange", "close", { ready: [xe, F] }), this.once = function(e, t) {
				var n = function() {
					var i = [...arguments];
				...
				if (this.db = l, this._ctx = {
					...
					return H(e, t) < 0 ? e : t;
				}, this._IDBKeyRange = l._deps.IDBKeyRange, !this._IDBKeyRange) throw new P.MissingAPI();
		...
		var cr, ie = typeof Symbol < "u" && "observable" in Symbol ? Symbol.observable : "@@observable", lr = (ur.prototype.subscribe = function(e, t, n) {
			return this._subscribe(e && typeof e != "function" ? e : {
				next: e,
				error: t,
				complete: n
			});
		}, ur.prototype[ie] = function() {
			return this;
		}, ur);
		function ur(e) {
			this._subscribe = e;
		...
		return typeof BroadcastChannel < "u" && ((gr = function() {
			...
			if (!sr.disableBfCache && e.persisted) {
				Se && console.debug("Dexie: handling persisted pagehide"), mr?.close();
				for (var t = 0, n = ft; t < n.length; t++) n[t].close({ disableAutoOpen: !1 });
			}
		}), addEventListener("pageshow", function(e) {
			!sr.disableBfCache && e.persisted && (Se && console.debug("Dexie: handling persisted pageshow"), gr(), pr({ all: new En(-Infinity, [[]]) }));
		})), z.rejectionMapper = function(e, t) {
			return !e || e instanceof oe || e instanceof TypeError || e instanceof SyntaxError || !e.name || !fe[e.name] ? e : (t = new fe[e.name](t || e.message, e), "stack" in e && f(t, "stack", { get: function() {
				return this.inner.stack;
			} }), t);
		}, Ce(Se), t(sr, Object.freeze({
			__proto__: null,
			Dexie: sr,
			liveQuery: dr,
			Entity: yt,
...
})))(), 1), em = Symbol.for("Dexie"), tm = globalThis[em] || (globalThis[em] = $p.default);
if ($p.default.semVer !== tm.semVer) throw Error(`Two different versions of Dexie loaded in the same app: ${$p.default.semVer} and ${tm.semVer}`);
var { liveQuery: nm, mergeRanges: rm, rangesOverlap: im, RangeSet: am, cmp: om, Entity: sm, PropModification: cm, replacePrefix: lm, add: um, remove: dm, DexieYProvider: fm } = tm;
function pm(e) {
...
var mm = {
	...
	constructor(e, t) {
		this.schemaVersion = 1, this.knownDocuments = /* @__PURE__ */ new Map(), this.schemaLock = Promise.resolve(), this.name = e, this.dexieRecordSchema = pm(t?.recordSchema ?? mm), this.db = new tm(e);
	}
	async open() {
		let e = new tm(this.name);
		e.version(1).stores({
			[Bp]: pm(Jp),
			[Vp]: pm(Yp),
			[Hp]: pm(Xp),
		...
		try {
			await e.open();
			let t = await e.table(Bp).toArray(), n = await e.table(Hp).get("schemaVersion");
			e.close();
			for (let e of t) this.knownDocuments.set(e.id, e);
			this.schemaVersion = n?.value ?? 1;
		} catch {
			e.close();
		}
		this.db = new tm(this.name), this.db.version(this.schemaVersion).stores(this.buildStores()), await this.db.open();
	}
	close() {
		this.db.close();
	}
	async destroy() {
		this.db.isOpen() && (this.db.close(), await gm()), await tm.delete(this.name), this.knownDocuments.clear();
	}
	async registerDocument(e) {
		await this.withSchemaLock(async () => {
			this.knownDocuments.set(e.id, e), await this.reopenWithNewSchema(), await this.db.table(Bp).add(e);
		});
	}
	async getDocument(e) {
		return this.db.table(Bp).get(e);
	}
	async getDocuments() {
		return this.db.table(Bp).toArray();
	}
	async updateDocument(e, t) {
		await this.db.table(Bp).update(e, t);
	...
	async removeDocument(e) {
		await this.withSchemaLock(async () => {
			...
			let n = qp(e);
			this.db.tables.some((e) => e.name === n) && await this.db.table(n).clear(), await this.db.table(Gp).where({ documentId: e }).delete(), await this.db.table(Vp).where({ documentId: e }).delete(), await this.db.table(Hp).delete(`head:${e}`), await this.db.table(Bp).delete(e), this.knownDocuments.delete(e), await this.reopenWithNewSchema({ drop: e });
		});
	}
	async get(e, t) {
		if (t) return this.db.table(this.resolveTableName(t)).get(e);
	...
	async getByDocumentId(e) {
		return this.db.table(this.resolveTableName(e)).toArray();
	}
	async getByTagNameInDocument(e, t) {
		return this.db.table(this.resolveTableName(t)).where({ tagName: e }).toArray();
	}
	async bulkWrite(e, t) {
		...
		try {
			await this.db.transaction("rw", o, this.db.table(Vp), this.db.table(Hp), async () => {
				...
				if (i.length > 0) try {
					...
					td("STORE_DELETE_FAILED", {
						detail: e instanceof Error ? e.message : String(e),
						cause: e instanceof Error ? e : void 0
					});
				}
				let u = await this.getHead(t), d = await this.db.table(Vp).where({ documentId: t }).filter((e) => e.sequenceNumber > u).toArray();
				...
				await this.db.table(Vp).add(p), await this.setHead(t, f);
			});
		} catch (e) {
			if (e instanceof Error && e.message.includes("dialecte")) throw e;
			td("STORE_COMMIT_FAILED", {
				detail: e instanceof Error ? e.message : String(e),
				cause: e instanceof Error ? e : void 0
			});
		}
	...
	async undo(e) {
		...
		if (t === 0) return;
		let n = await this.db.table(Vp).where({
			documentId: e,
			sequenceNumber: t
		}).first();
		if (!n) return;
		let r = this.db.table(this.resolveTableName(e));
		await this.db.transaction("rw", r, this.db.table(Hp), async () => {
	...
	async redo(e) {
		let t = await this.getHead(e) + 1, n = await this.db.table(Vp).where({
			documentId: e,
			sequenceNumber: t
		}).first();
		if (!n) return;
	...
	async getChangeLog(e) {
		return this.db.table(Vp).where({ documentId: e }).sortBy("sequenceNumber");
	}
	async addBlob(e, t) {
		_m(this.knownDocuments, e.documentId);
		let n = this.db.table(qp(e.documentId));
		await this.db.transaction("rw", this.db.table(Gp), n, async () => {
			await this.db.table(Gp).put(e), await n.put({
				id: e.id,
				data: t
			});
		});
	...
	async getBlob(e) {
		let t = await this.db.table(Gp).get(e);
		if (!t) return;
		let n = await this.db.table(qp(t.documentId)).get(e);
		if (n) return {
			entry: t,
			data: n.data
		};
	...
	async getBlobsByDocument(e) {
		return (await this.db.table(Gp).toArray()).filter((t) => t.attachedTo.some((t) => t.documentId === e));
	}
	async getBlobsByRecord(e, t) {
		return (await this.db.table(Gp).toArray()).filter((n) => n.attachedTo.some((n) => n.documentId === e && n.recordRef === t));
	}
	async getStandaloneBlobs() {
		return (await this.db.table(Gp).toArray()).filter((e) => e.attachedTo.length === 0);
	}
	async attachBlob(e, t) {
		let n = await this.db.table(Gp).get(e);
		if (n || td("STORE_BLOB_NOT_FOUND", { detail: `Blob "${e}" not found` }), n.attachedTo.some((e) => e.documentId === t.documentId && e.recordRef === t.recordRef && e.attribute === t.attribute)) return;
		let r = [...n.attachedTo, t];
		await this.db.table(Gp).update(e, { attachedTo: r });
	}
	async detachBlob(e, t) {
		let n = await this.db.table(Gp).get(e);
		n || td("STORE_BLOB_NOT_FOUND", { detail: `Blob "${e}" not found` });
	...
	async removeBlob(e) {
		let t = await this.db.table(Gp).get(e);
		if (!t) return;
		let n = this.db.table(qp(t.documentId));
		await this.db.transaction("rw", this.db.table(Gp), n, async () => {
			await n.delete(e), await this.db.table(Gp).delete(e);
		});
	}
	getDatabaseInstance() {
		return this.db;
	...
	buildStores(e) {
		...
		for (let e of this.knownDocuments.keys()) t[this.resolveTableName(e)] = this.dexieRecordSchema, t[qp(e)] = n;
		return e?.drop && (t[this.resolveTableName(e.drop)] = null, t[qp(e.drop)] = null), t;
	}
	async reopenWithNewSchema(e) {
		this.db.close(), await gm(), this.schemaVersion++, this.db = new tm(this.name), this.db.version(this.schemaVersion).stores(this.buildStores(e)), await this.db.open(), await this.db.table(Hp).put({
			key: "schemaVersion",
...
function _m(e, t) {
	e.has(t) || td("DOCUMENT_NOT_REGISTERED", { detail: `Cannot add blob: owner document "${t}" is not registered` });
}
var vm = class {
	constructor(e, t) {
	...
	async registerDocument(e) {
		this.guardWritable(), this.documents.set(e.id, e), this.records.set(Wp(e.id), /* @__PURE__ */ new Map()), this.blobData.set(e.id, /* @__PURE__ */ new Map());
	}
	async getDocument(e) {
	...
	async removeDocument(e) {
		this.guardWritable(), this.documents.delete(e), this.records.delete(Wp(e)), this.changelog.delete(e), this.heads.delete(e), this.blobData.delete(e);
	...
	async addBlob(e, t) {
		this.guardWritable(), this.documents.has(e.documentId) || td("DOCUMENT_NOT_REGISTERED", { detail: `Cannot add blob: owner document "${e.documentId}" is not registered` }), this.blobs.set(e.id, e), this.getBlobTable(e.documentId).set(e.id, t);
	}
	async getBlob(e) {
	...
	async attachBlob(e, t) {
		...
		n || td("STORE_BLOB_NOT_FOUND", { detail: `Blob "${e}" not found` }), !n.attachedTo.some((e) => e.documentId === t.documentId && e.recordRef === t.recordRef && e.attribute === t.attribute) && this.blobs.set(e, {
			...n,
	...
	getTable(e) {
		let t = Wp(e), n = this.records.get(t);
		return n || (n = /* @__PURE__ */ new Map(), this.records.set(t, n)), n;
	}
	guardWritable() {
		this.writable || td("STORE_NOT_WRITABLE", { detail: "In-memory store is read-only. Hydrate with a real document before writing." });
	}
};
function ym(e, t, n) {
	return t.type === "local" ? new hm(e, { recordSchema: n.database.recordSchema }) : t.type === "inMemory" ? new vm(e, { writable: t.writable ?? !0 }) : t.store;
}
async function bm(e) {
...
async function xm(e) {
	...
	let a = i.entry.name;
	return r?.withDownload && await id({
		data: i.data,
		filename: a
	}), {
		entry: i.entry,
...
function Cm(e, t) {
	...
	for (let n of t) e.has(n.id) || e.set(n.id, Sm(n));
	for (let t of e.keys()) n.has(t) || e.delete(t);
	return e;
}
async function wm(e) {
	let { file: t, store: n, configs: r, defaultConfigKey: i, options: a } = e, o = a?.configKey ?? i, s = r[o];
	Z(s, {
		key: "UNKNOWN_CONFIG_KEY",
		detail: `Unknown configKey: "${o}". Available: ${Object.keys(r).join(", ")}`
	});
	let c = crypto.randomUUID(), l = t.name.includes(".") ? `.${t.name.split(".").pop()}` : s.io.supportedFileExtensions[0], u = {
		id: c,
	...
	await n.registerDocument(u);
	let { recordCount: d } = await mp({
		file: t,
		documentId: c,
		store: n,
		config: s,
...
async function Tm(e) {
	let { store: t, configs: n, defaultConfigKey: r, options: i } = e, a = i?.configKey ?? r, o = n[a];
	Z(o, {
		key: "UNKNOWN_CONFIG_KEY",
		detail: `Unknown configKey: "${a}". Available: ${Object.keys(n).join(", ")}`
	});
	let s = i?.extension ?? o.io.supportedFileExtensions[0], c = i?.name ?? "untitled", l = crypto.randomUUID(), u = {
		id: l,
		name: c,
		extension: s,
		configKey: a,
	...
	await t.registerDocument(u);
	let d = o.definition[o.rootElementName], f = (d?.attributes.sequence ?? []).map((e) => ({
		name: e,
		...d.attributes.details[e]
	})).filter((e) => e.required && (e.fixed ?? e.default) !== void 0).map(({ name: e, fixed: t, default: n, namespace: r }) => {
		let i = {
			name: e,
			value: t ?? n
		};
		return r && (i.namespace = r), i;
	}), p = {
		id: crypto.randomUUID(),
		tagName: o.rootElementName,
		namespace: o.namespaces.default,
		attributes: f,
		value: "",
		parent: null,
		children: []
	};
	return await t.bulkWrite(l, { creates: [p] }), {
		documentId: l,
		record: u,
		documentState: Sm(u)
	};
...
var Em = class {
	...
	constructor(e) {
		...
		this.storage = e.storage, this.configs = e.configs, this.defaultConfigKey = e.defaultConfigKey ?? t[0], this.mergedExtensions = e.extensions ? gd({
			base: e.extensions.base,
			custom: e.extensions.custom
		}) : void 0, this.hooks = e.hooks;
	}
	async open(e) {
		this._name = e, this._channel = new BroadcastChannel(`dialecte::project::${e}`), this._channel.onmessage = (e) => {
			let { type: t } = e.data ?? {};
			(t === "init-empty-document" || t === "document-removed" || t === "document-imported") && this.refreshState();
		};
		let t = ym(e, this.storage, this.configs[this.defaultConfigKey]);
		await t.open(), this._store = t;
		let n = await t.getDocuments();
		for (let e of n) this.state.documents.set(e.id, Sm(e));
		return this;
	}
	close() {
	...
	async initEmptyDocument(e) {
		...
		return this.state.documents.set(t.documentId, t.documentState), this.channel.postMessage({
			type: "init-empty-document",
			documentId: t.documentId
		}), t.documentId;
	}
	async removeDocument(e) {
		await this.store.removeDocument(e), this.state.documents.delete(e), this.channel.postMessage({
			type: "document-removed",
			documentId: e
		});
	}
	async import(e, t) {
		let n = await Promise.all(e.map((e) => wm({
			file: e,
			store: this.store,
			configs: this.configs,
			defaultConfigKey: this.defaultConfigKey,
		...
		for (let e of n) this.state.documents.set(e.documentId, e.documentState), this.channel.postMessage({
	...
	openDocument(e) {
		...
		return new zp(this.store, n, e, this.mergedExtensions, this.hooks, this.channel);
	}
	getDocumentConfig(e) {
		let t = this.state.documents.get(e);
	...
	async undo(e) {
		Z(this.state.documents.get(e), {
			key: "DOCUMENT_NOT_REGISTERED",
			detail: `Document "${e}" not registered in project "${this.name}"`
		}), await this.store.undo(e), this.channel.postMessage({
			type: "commit",
			documentId: e,
			timestamp: Date.now()
		});
	...
	async redo(e) {
		Z(this.state.documents.get(e), {
			key: "DOCUMENT_NOT_REGISTERED",
			detail: `Document "${e}" not registered in project "${this.name}"`
		}), await this.store.redo(e), this.channel.postMessage({
			type: "commit",
			documentId: e,
			timestamp: Date.now()
		});
	...
	async addBlob(e, t, n = []) {
		...
		return await this.store.addBlob(r, t), this.channel.postMessage({
			type: "blob-added",
			blobId: r.id,
			documentId: e
		}), r.id;
	...
	async attachBlob(e, t) {
		await this.store.attachBlob(e, t), this.channel.postMessage({
			type: "blob-attached",
			blobId: e,
			ref: t
		});
	...
	async detachBlob(e, t) {
		await this.store.detachBlob(e, t), this.channel.postMessage({
			type: "blob-detached",
			blobId: e,
			ref: t
		});
	...
	async removeBlob(e) {
		await this.store.removeBlob(e), this.channel.postMessage({
			type: "blob-removed",
			blobId: e
		});
	}
	...
	async refreshState() {
		...
		Cm(this.state.documents, e);
	}
};
//#endregion
//#region node_modules/.pnpm/@dialecte+nsd@0.1.2/node_modules/@dialecte/nsd/dist/v2017A/index.js
function Dm(e) {
...
var Om = "SET-LIBRARY-NSD", km = null;
function Am() {
	return km ||= Dm().open(Om), km;
}
var jm = /* @__PURE__ */ Jt(0);
function Mm() {
	jm.value++;
}
//#endregion
...
function zm() {}
//#endregion
export { pr as $, us as A, Ws as B, cu as C, Y as D, Kl as E, es as F, Ni as G, _a as H, ds as I, or as J, Fi as K, X as L, ss as M, ts as N, Wo as O, ps as P, qr as Q, Kr as R, Wu as S, Ml as T, _s as U, sr as V, zn as W, Qi as X, Xi as Y, Wi as Z, Yu as _, $t as _t, Lm as a, De as at, Uu as b, Se as bt, Am as c, ke as ct, Td as d, Jt as dt, ur as et, ud as f, Yt as ft, $u as g, Qt as gt, Z as h, en as ht, Fm as i, an as it, Us as j, Or as k, jm as l, Lt as lt, ld as m, ln as mt, zm as n, rr as nt, Pm as o, Oe as ot, od as p, K as pt, Yo as q, Im as r, ir as rt, Nm as s, q as st, Rm as t, dr as tt, Mm as u, zt as ut, Gu as v, F as vt, nu as w, ku as x, t as xt, Ou as y, ue as yt, Cs as z };

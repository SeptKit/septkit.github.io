...
function Ge(t, n, r) {
	...
	}, { flush: o }), a ? e(() => (u.value = !0, d.value)) : d;
}
...
function Ye(e, t = {}) {
	...
	if (U) {
		let s = typeof t == "function" ? { onDrop: t } : t, c = s.multiple ?? !0, l = s.preventDefaultForUnhandled ?? !1, u = (e) => {
			...
			if (s.checkValidity) return s.checkValidity(e);
			let t = d(Array.from(e ?? []).map((e) => e.type)), n = c || e.length <= 1;
			return t && n;
		}, p = () => /^(?:(?!chrome|android).)*safari/i.test(navigator.userAgent) && !("chrome" in window), m = (e, t) => {
			let r = e.dataTransfer?.items;
			if (o = (r && f(r)) ?? !1, l && e.preventDefault(), !p() && !o) {
			...
			switch (t) {
				case "enter":
					var d;
					a += 1, n.value = !0, (d = s.onEnter) == null || d.call(s, null, e);
					break;
				case "over":
					var m;
					(m = s.onOver) == null || m.call(s, null, e);
					break;
				case "leave":
					var h;
					--a, a === 0 && (n.value = !1), (h = s.onLeave) == null || h.call(s, null, e);
					break;
				case "drop":
					if (a = 0, n.value = !1, o) {
						var g;
						i.value = c, (g = s.onDrop) == null || g.call(s, c, e);
					}
					break;
			}
		};
...
var ht = { class: "modal-box import-nsd-dialog bg-base-100" }, gt = ["disabled"], _t = { class: "import-nsd-dialog__body" }, vt = { class: "import-nsd-dialog__tableArea" }, yt = { class: "import-nsd-dialog__messages" }, $ = {
	...
	setup(e, { expose: t }) {
		...
		async function b(e) {
			...
			if (!t.length) {
				o.value = [`Unsupported file type. Supported: ${g.join(", ")}`];
				return;
			}
			await l(t);
		}

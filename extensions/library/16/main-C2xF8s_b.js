...
function xd(e) {
	let { dialecteConfig: t, hooks: n, record: r } = e, { id: i, tagName: a, attributes: o, namespace: s, value: c } = r, l = i ?? crypto.randomUUID(), u = o ? yd({
		tagName: a,
		attributes: o,
		dialecteConfig: t
	}) : [], d = {
...
}, Nd = { supportedFileExtensions: [".nsd", ".nsdoc"] }, Pd = {
	singletonElements: Ad,
	elements: Td,
	namespaces: {
		default: {
			uri: "http://www.iec.ch/61850/2016/NSD",
...
}, Ld = {}, Rd = Object.create, zd = Object.defineProperty, Bd = Object.getOwnPropertyDescriptor, Vd = Object.getOwnPropertyNames, Hd = Object.getPrototypeOf, Ud = Object.prototype.hasOwnProperty, Wd = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), Gd = (e, t, n, r) => {
	if (t && typeof t == "object" || typeof t == "function") for (var i = Vd(t), a = 0, o = i.length, s; a < o; a++) s = i[a], !Ud.call(e, s) && s !== n && zd(e, s, {
		get: ((e) => t[e]).bind(null, s),
		enumerable: !(r = Bd(t, s)) || r.enumerable
	});
	return e;
}, Kd = (e, t, n) => (n = e == null ? {} : Rd(Hd(e)), Gd(t || !e || !e.__esModule ? zd(n, "default", {
	value: e,
	enumerable: !0
}) : n, e));
function qd(e, t) {
...
function Jd(e, t) {
	...
	for (let r of Object.keys(e)) {
		let i = e[r];
		n[r] = typeof i == "function" ? (...e) => i(t, ...e) : Jd(i, t);
	}
	return n;
}
function Yd(e) {
...
async function $(e) {
	...
	let r;
	if (n.id === void 0) {
		let e = `__singleton_${n.tagName}`, i = Qp(t) ? t.recordCache.get(e) : void 0;
		i ? r = i : (r = (await t.store.getByTagNameInDocument(n.tagName, t.documentId))[0], r && Qp(t) && (t.recordCache.set(r.id, r), t.recordCache.set(e, r)));
	} else {
		let e = Qp(t) ? t.recordCache.get(n.id) : void 0;
		e ? r = e : (r = await t.store.get(n.id, t.documentId), r && Qp(t) && t.recordCache.set(n.id, r));
	}
...
async function ef(e) {
	...
	for (let e of r) Qp(t) && t.recordCache.set(e.id, e);
	return Xd({
		rawRecords: r,
		stagedOperations: t.stagedOperations,
		tagName: n
...
async function af(e) {
	let { context: t, tagName: n, attributes: r } = e, i = await ef({
		context: t,
		tagName: n
	}), a = [];
	for (let e of i) of({
...
async function sf(e) {
	let { context: t, ref: n, options: r } = e, { collect: i, omit: a } = r, o = cf(a), s = uf(i), c = /* @__PURE__ */ new Map();
	for (let e of s.allTags) c.set(e, /* @__PURE__ */ new Map());
	let l = await $({
		context: t,
		ref: n
	});
	return l && (s.mode === "flat" ? await pf({
		context: t,
		rootId: l.id,
		collectSpec: s,
		omitSpec: o,
...
function lf(e) {
	...
	for (let e of n.conditional) if (e.tagName === t.tagName && of({
		record: t,
...
async function gf(e) {
	...
	for (let e of r) {
		...
		for (let n of r) a.get(e.tagName).set(n.id, n), !e.isLeaf && e.children.length > 0 && await gf({
			context: t,
			record: n,
...
async function bf(e) {
	let { context: t, ref: n, name: r, namespace: i, defaults: a = "optional" } = e, o = await $({
		context: t,
		ref: n
	}), s = o?.attributes ?? [], c = Sf(t.dialecteConfig, r, i), l = s.find((e) => e.name === c);
...
async function xf(e) {
	let { context: t, ref: n, name: r, namespace: i, defaults: a = "optional" } = e, { dialecteConfig: o } = t, s = await $({
		context: t,
		ref: n
	}), c = s?.attributes ?? [], l = Sf(o, r, i), u = c.find((e) => e.name === l);
	if (u) return u;
	if (!s || a === "none") return;
	let d = id({
		dialecteConfig: o,
...
async function Cf(e) {
	let { context: t, ref: n, namespace: r, defaults: i = "optional" } = e, { dialecteConfig: a } = t, o = await $({
		...
		let { prefix: n, local: r, isXmlns: i } = Tf(t.name);
		return i || n !== c || (e[r] = t.value ?? ""), e;
	}, {});
	if (o && i !== "none") {
		let e = a.definition[o.tagName]?.attributes.sequence ?? [];
		for (let t of e) {
			let { prefix: e, local: n, isXmlns: r } = Tf(t);
...
function Of(e) {
	...
	return n.unconditional.has(t.tagName) ? !0 : n.conditional.some((e) => e.scope === "self" && e.tagName === t.tagName && of({
		record: t,
		attributeFilter: e.where
	}));
}
function kf(e) {
	let { record: t, compiledOmit: n } = e;
	return n.conditional.some((e) => e.scope === "children" && e.tagName === t.tagName && of({
		record: t,
		attributeFilter: e.where
	}));
}
...
async function Mf(e) {
	...
	let l = Df(o), u = t.dialecteConfig.transparentElements, d = await Nf({
		context: t,
		record: c,
		select: a,
		compiledOmit: l,
...
async function Nf(e) {
	...
	return vd({
		record: n,
		tree: (await Promise.all(s.map(({ record: e, select: n }) => Nf({
			context: t,
			record: e,
			select: n,
			compiledOmit: i,
...
var If = new Set(["where", "recursive"]);
function Lf(e) {
	let t = /* @__PURE__ */ new Set();
	for (let n of Object.keys(e)) If.has(n) || t.add(n);
	return t;
}
function Rf(e) {
...
function zf(e) {
	...
	if (!(!r || n.recursive === !1) && r.children[t.tagName]?.includes(t.tagName) && !(n.where && !of({
		record: t,
...
async function Hf(e) {
	...
	if (!n && i === void 0) return Uf({
		context: t,
		includeDeleted: a
	});
	let o = e.siblings ?? !1, s = o === !0 || typeof o == "object" && !!o, c = typeof o == "object" && !!o && o.expand === !0, l = n ?? { tagName: t.dialecteConfig.rootElementName }, u = /* @__PURE__ */ new Map(), d = /* @__PURE__ */ new Map(), f = a ? Qd(t.stagedOperations) : void 0, p = (e) => {
...
async function Uf(e) {
	let { context: t, includeDeleted: n = !1 } = e, { live: r, deleted: i } = Zd({
...
})), qf = /* @__PURE__ */ Kd((/* @__PURE__ */ Wd(((e, t) => {
...
function Yf(e, t = {}) {
	...
	return Jf(n ? "<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" + r : r);
}
async function Xf(e) {
	let { extension: t, xmlDocument: n, filename: r } = e, i = Yf(n);
	await fd({
...
function Zf(e) {
	...
	let l = c.tagName !== n.rootElementName, u = n.namespaces.default, d = document.implementation.createDocument(u.uri, null, null), f = $f({
		document: d,
		record: c,
		defaultNamespace: u,
		declareNamespaces: a
	});
	return a && f.setAttribute("xmlns", c.namespace.uri), c.attributes && tp({
		config: n,
		document: d,
		element: f,
	...
	}), c.value && (f.textContent = c.value.trim()), r && f.setAttribute("_temp-idb-id", c.id), d.appendChild(f), Qf({
		index: o,
		config: n,
		withDatabaseIds: r,
		xmlDocument: d,
...
function ep(e) {
	let { config: t, document: n, record: r, defaultNamespace: i, withDatabaseIds: a, isFragment: o, declareNamespaces: s } = e, c = r.namespace.uri === i.uri, l = $f({
		document: n,
		record: r,
		defaultNamespace: i,
		declareNamespaces: s
	});
	return s && !c && r.namespace.prefix && r.namespace.prefix !== "xmlns" && np({
		config: t,
		document: n,
...
function np(e) {
	...
	a.getAttributeNS(o, r.prefix) === null && (a.setAttributeNS(o, `xmlns:${r.prefix}`, r.uri), i || rp({
		config: t,
		rootElement: a,
		namespace: r
	}));
...
function ip(e) {
	...
	if (s) for (let [e, c] of Object.entries(s)) {
		...
		let l = ad(e);
		(c.namespace ? r.hasAttributeNS(c.namespace.uri, l) : r.hasAttribute(l)) || (c.namespace && c.namespace.prefix && c.namespace.prefix !== "xmlns" ? (o && np({
			config: t,
			document: n,
			namespace: c.namespace,
			isFragment: a
...
function op(e) {
	return !!(e.name === "xmlns" || e.name.startsWith("xmlns:") || ap(e) && e.namespace?.prefix === "xmlns");
}
var sp = /* @__PURE__ */ Wd(((e, t) => {
	t.exports = {};
})), cp = /* @__PURE__ */ Kd((/* @__PURE__ */ Wd(((e) => {
	(function(e) {
...
function dp(e) {
	...
	o.onopentag = (e) => a = fp({
		...
		text: e,
		state: a
	}), o.onclosetag = () => ({updatedState: a} = mp({
		state: a,
		hooks: i,
		session: r,
		dialecteConfig: t
...
function fp(e) {
	let { node: t, state: n, dialecteConfig: r, useCustomRecordsIds: i } = e, a = { ...n }, o = gp(t);
	a.defaultNamespace ||= _p({
		element: t,
		defaultNamespace: r.namespaces.default,
		rootElementName: r.rootElementName
	});
	let s = vp(t, a.defaultNamespace), c = {
		id: xp({
...
async function Tp(e) {
	...
	let u = a?.chunkSize ?? Cp, d = a?.batchSize ?? wp, f = new lp(), p = dp({
		dialecteConfig: r,
		useCustomRecordsIds: i,
		session: f,
		hooks: o
...
async function Ep(e) {
	...
	for (; !f;) {
		let e = await l.read();
		if (f = e.done, f) {
			d.length > 0 && n.parser.write(u.decode(d)), n.parser.close(), c += await kp({
				sax: n,
				session: r,
				store: i,
				documentId: a,
		...
		if (e.value) for (d = Op(d, e.value); d.length >= o;) {
			let e = u.decode(d.slice(0, o), { stream: !0 });
			d = d.slice(o), n.parser.write(e), c += await kp({
				sax: n,
				session: r,
				store: i,
				documentId: a,
...
async function Ap(e) {
	let { context: t, options: n = {} } = e, { ref: r, ancestors: i, siblings: a, depth: o, includeDeleted: s, omit: c, unwrap: l, as: u = "tree" } = n, d = await Hf({
		context: t,
		ref: r ? Q(r) : void 0,
		ancestors: i,
		siblings: a,
	...
	if (u === "xml") return Mp(t, d, n.declareNamespaces, n.includeXmlDeclaration);
	let f = jp(t, d, {
		omit: c,
		unwrap: l
	});
	return u === "tree" ? f : {
		tree: f,
		xmlString: Mp(t, d, n.declareNamespaces, n.includeXmlDeclaration)
	};
}
function jp(e, t, n) {
	let r = Gf(t);
...
var Np = class {
	...
	get any() {
		return this._any ??= new Np(() => this.context, this.dialecteConfig);
	}
	getOperations() {
		return [];
	}
...
function Fp(e) {
	...
	r && (o = gd(r)), i && (s = gd(i)), a && (c = gd(a)), n === "created" ? (Z(o, {
...
async function zp(e) {
	let { dialecteConfig: t, hooks: n, context: r, query: i, parentRef: a, record: o, cumulativeCloneMappings: s } = e, c = [], l = await Bp({
		dialecteConfig: t,
		hooks: n,
		context: r,
		query: i,
...
async function Hp(e) {
	...
	for (let e of n.children) {
		...
		n && (n.children.length > 0 && await Hp({
			context: t,
			record: n
		}), Fp({
			context: t,
...
async function Up(e) {
	let { dialecteConfig: t, hooks: n, context: r, query: i, parentRef: a, params: o } = e, s = Wp(o.attributes), c = await nf({
		context: r,
		ref: a,
		tagName: o.tagName
	});
	return (s ? c.find((e) => of({
		record: e,
		attributeFilter: s
	})) : o.id === void 0 ? c[0] : c.find((e) => e.id === o.id)) || Lp({
		dialecteConfig: t,
		hooks: n,
		context: r,
		query: i,
...
function Kp(e, t) {
	return e.value !== t.value || e.attributes.length !== t.attributes.length ? !1 : e.attributes.every((e, n) => qp(e, t.attributes[n]));
}
function qp(e, t) {
...
async function Xp(e) {
	let { stagedOperations: t, store: n, documentId: r, documentState: i } = e, { creates: a, updates: o, deletes: s } = Yp(t), c = a.length + o.length + s.length;
...
var Zp = class extends Pp {
	...
	get any() {
		return this._anyTx ??= new Jp(() => this.context, this.dialecteConfig, this.hooks, this);
	}
	getOperations() {
...
var $p = class {
	...
	withQueryExtensions(e) {
		let t = qd(this.extensionsRegistry?.query, e);
		return Object.assign(e, t);
	}
	withAllExtensions(e) {
		let t = qd(this.extensionsRegistry?.query, e), n = qd(this.extensionsRegistry?.transaction, e), r = {};
	...
	createQuery() {
		return new Pp(this.store, this.config, this.documentId);
	}
	get query() {
		return this.withQueryExtensions(this.createQuery());
	}
	createTransaction() {
		return new Zp(this.store, this.config, this.documentId, this.state, this.hooks);
	}
...
}, em = "_documents", tm = "_changeLog", nm = "_meta", rm = "xel_";
function im(e) {
	return `${rm}${e}`;
}
var am = "_blobs", om = "blob_";
function sm(e) {
	return `${om}${e}`;
}
var cm = {
	...
	compoundIndexes: [],
	arrayIndexes: []
}, pm = /* @__PURE__ */ Kd((/* @__PURE__ */ Wd(((e, t) => {
	(function(n, r) {
...
})))(), 1), mm = Symbol.for("Dexie"), hm = globalThis[mm] || (globalThis[mm] = pm.default);
if (pm.default.semVer !== hm.semVer) throw Error(`Two different versions of Dexie loaded in the same app: ${pm.default.semVer} and ${hm.semVer}`);
var { liveQuery: gm, mergeRanges: _m, rangesOverlap: vm, RangeSet: ym, cmp: bm, Entity: xm, PropModification: Sm, replacePrefix: Cm, add: wm, remove: Tm, DexieYProvider: Em } = hm;
function Dm(e) {
...
var Om = {
	...
	constructor(e, t) {
		this.schemaVersion = 1, this.knownDocuments = /* @__PURE__ */ new Map(), this.schemaLock = Promise.resolve(), this.stale = !1, this.name = e, this.dexieRecordSchema = Dm(t?.recordSchema ?? Om), this.db = new hm(e);
	}
	async open() {
	...
	async destroy() {
		this.db.isOpen() && (this.db.close(), await Am()), await hm.delete(this.name), this.knownDocuments.clear();
	}
	async reconcile() {
	...
	async registerDocument(e) {
		await this.withSchemaLock(async () => {
			this.stale && await this.reloadFromPersisted(), this.knownDocuments.set(e.id, e), await this.reopenWithNewSchema(), await this.db.table(em).add(e);
		});
	}
	async getDocument(e) {
		return await this.ensureCurrentSchema(), this.db.table(em).get(e);
	}
	async getDocuments() {
		return await this.ensureCurrentSchema(), this.db.table(em).toArray();
	}
	async updateDocument(e, t) {
		await this.ensureCurrentSchema(), await this.db.table(em).update(e, t);
	...
	async removeDocument(e) {
		await this.withSchemaLock(async () => {
			...
			let n = sm(e);
			this.db.tables.some((e) => e.name === n) && await this.db.table(n).clear(), await this.db.table(am).where({ documentId: e }).delete(), await this.db.table(tm).where({ documentId: e }).delete(), await this.db.table(nm).delete(`head:${e}`), await this.db.table(em).delete(e), this.knownDocuments.delete(e), await this.reopenWithNewSchema({ drop: e });
		});
	}
	async get(e, t) {
	...
	async commit(e) {
		...
		try {
			await this.db.transaction("rw", o, this.db.table(tm), this.db.table(nm), async () => {
				...
				let u = await this.getHead(t), d = await this.db.table(tm).where({ documentId: t }).filter((e) => e.sequenceNumber > u).toArray();
				...
				await this.db.table(tm).add(p), await this.setHead(t, f);
			});
		} catch (e) {
	...
	async undo(e) {
		...
		if (t === 0) return;
		let n = await this.db.table(tm).where({
			documentId: e,
			sequenceNumber: t
		}).first();
		if (!n) return;
		let r = this.db.table(this.resolveTableName(e));
		await this.db.transaction("rw", r, this.db.table(nm), async () => {
	...
	async redo(e) {
		await this.ensureCurrentSchema();
		let t = await this.getHead(e) + 1, n = await this.db.table(tm).where({
			documentId: e,
			sequenceNumber: t
		}).first();
		if (!n) return;
	...
	async getHistoryStatus(e) {
		await this.ensureCurrentSchema();
		let t = await this.getHead(e), n = await this.db.table(tm).where({
			documentId: e,
			sequenceNumber: t + 1
		}).first();
		return {
	...
	async getChangeLog(e) {
		return await this.ensureCurrentSchema(), this.db.table(tm).where({ documentId: e }).sortBy("sequenceNumber");
	}
	async addBlob(e, t) {
		await this.ensureCurrentSchema(), jm(this.knownDocuments, e.documentId);
		let n = this.db.table(sm(e.documentId));
		await this.db.transaction("rw", this.db.table(am), n, async () => {
			await this.db.table(am).put(e), await n.put({
				id: e.id,
				data: t
			});
		});
	...
	async getBlob(e) {
		await this.ensureCurrentSchema();
		let t = await this.db.table(am).get(e);
		if (!t) return;
		let n = await this.db.table(sm(t.documentId)).get(e);
		if (n) return {
			entry: t,
			data: n.data
		};
	...
	async getBlobsByDocument(e) {
		return await this.ensureCurrentSchema(), (await this.db.table(am).toArray()).filter((t) => t.attachedTo.some((t) => t.documentId === e));
	}
	async getBlobsByRecord(e, t) {
		return await this.ensureCurrentSchema(), (await this.db.table(am).toArray()).filter((n) => n.attachedTo.some((n) => n.documentId === e && n.recordRef === t));
	}
	async getStandaloneBlobs() {
		return await this.ensureCurrentSchema(), (await this.db.table(am).toArray()).filter((e) => e.attachedTo.length === 0);
	}
	async attachBlob(e, t) {
		await this.ensureCurrentSchema();
		let n = await this.db.table(am).get(e);
		...
		await this.db.table(am).update(e, { attachedTo: r });
	}
	...
	async removeBlob(e) {
		...
		let t = await this.db.table(am).get(e);
		if (!t) return;
		let n = this.db.table(sm(t.documentId));
		await this.db.transaction("rw", this.db.table(am), n, async () => {
			await n.delete(e), await this.db.table(am).delete(e);
		});
	}
	getDatabaseInstance() {
		return this.db;
	...
	buildStores(e) {
		...
		for (let e of this.knownDocuments.keys()) t[this.resolveTableName(e)] = this.dexieRecordSchema, t[sm(e)] = n;
		return e?.drop && (t[this.resolveTableName(e.drop)] = null, t[sm(e.drop)] = null), t;
	}
	async reopenWithNewSchema(e) {
		this.db.close(), await Am(), this.schemaVersion++, this.db = new hm(this.name), this.db.version(this.schemaVersion).stores(this.buildStores(e)), this.attachVersionChangeHandler(), await this.db.open(), await this.db.table(nm).put({
			key: "schemaVersion",
			value: this.schemaVersion
		}), this.stale = !1;
	}
	async reloadFromPersisted() {
		this.db.isOpen() && (this.db.close(), await Am());
		let e = new hm(this.name);
		e.version(1).stores({
			[em]: Dm(cm),
			[tm]: Dm(lm),
			[nm]: Dm(um),
		...
		try {
			await e.open();
			let t = await e.table(em).toArray(), n = await e.table(nm).get("schemaVersion");
			e.close(), this.knownDocuments = new Map(t.map((e) => [e.id, e])), this.schemaVersion = n?.value ?? 1;
		} catch {
			e.close();
		}
		this.db = new hm(this.name), this.db.version(this.schemaVersion).stores(this.buildStores()), this.attachVersionChangeHandler(), await this.db.open(), this.stale = !1;
	}
...
var Mm = class e {
	...
	async registerDocument(e) {
		this.guardWritable(), this.documents.set(e.id, e), this.records.set(im(e.id), /* @__PURE__ */ new Map()), this.blobData.set(e.id, /* @__PURE__ */ new Map());
	}
	async getDocument(e) {
	...
	async removeDocument(e) {
		this.guardWritable(), this.documents.delete(e), this.records.delete(im(e)), this.changelog.delete(e), this.heads.delete(e), this.blobData.delete(e);
	...
	getTable(e) {
		let t = im(e), n = this.records.get(t);
...
function Nm(e, t, n) {
	return t.type === "local" ? new km(e, { recordSchema: n.database.recordSchema }) : t.type === "inMemory" ? new Mm(e, { writable: t.writable ?? !0 }) : t.store;
}
async function Pm(e) {
...
function Lm(e, t) {
	...
	for (let n of t) e.has(n.id) || e.set(n.id, Im(n));
...
var Bm = class {
	...
	constructor(e) {
		...
		this.storage = e.storage, this.configs = e.configs, this.defaultConfigKey = e.defaultConfigKey ?? t[0], this.hooks = e.hooks, this.mergedExtensions = e.extensions ? wd({
	...
	async open(e) {
		...
		let t = Nm(e, this.storage, this.configs[this.defaultConfigKey]);
		await t.open(), this._store = t;
		let n = await t.getDocuments();
		for (let e of n) this.state.documents.set(e.id, Im(e));
	...
	async import(e, t) {
		let n = await Promise.all(e.map((e) => Rm({
			file: e,
			store: this.store,
			configs: this.configs,
			defaultConfigKey: this.defaultConfigKey,
	...
	openDocument(e) {
		...
		return new $p(this.store, n, e, this.mergedExtensions, this.hooks, {
			state: t,
...
var Hm = "SET-LIBRARY-NSD", Um = null;
function Wm() {
	return Um ||= Vm().open(Hm), Um;
}
var Gm = /* @__PURE__ */ Yt(0);
function Km() {
	Gm.value++;
}
//#endregion
...
function $m() {}
//#endregion
export { dr as $, cs as A, va as B, Nl as C, kr as D, Go as E, Y as F, Ii as G, Bn as H, qr as I, Zi as J, Xo as K, ws as L, ms as M, ts as N, ds as O, fs as P, mr as Q, Gs as R, ru as S, J as T, Pi as U, vs as V, Ri as W, Gi as X, $i as Y, Jr as Z, ku as _, en as _t, Zm as a, Oe as at, Gu as b, Ce as bt, Wm as c, Ae as ct, Nd as d, Yt as dt, fr as et, md as f, Xt as ft, Ku as g, $t as gt, Xu as h, tn as ht, Ym as i, on as it, ns as j, Ws as k, Gm as l, Rt as lt, ed as m, un as mt, $m as n, ar as nt, Jm as o, ke as ot, Z as p, G as pt, sr as q, Xm as r, qs as rt, qm as s, K as st, Qm as t, ir as tt, Km as u, Bt as ut, Wu as v, P as vt, ql as w, lu as x, t as xt, Au as y, de as yt, cr as z };

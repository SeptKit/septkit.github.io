...
function sd(e, t) {
	let n = t.flatMap((t) => e.filter((e) => e.name === t)), r = e.filter((e) => !t.includes(e.name)).sort(od);
	return [...n, ...r];
}
function Z(e, t) {
	if (e) return;
...
function vd(e) {
	...
	return (fd(r) ? r : Object.entries(r).map(([e, r]) => ({
		name: e,
		value: r,
...
function yd(e) {
	...
	if (!i && a !== -1) {
		...
		e !== "xmlns" && (i = ad(n, e), i || td("UNKNOWN_NAMESPACE_PREFIX", {
...
function bd(e) {
	let { dialecteConfig: t, hooks: n, record: r } = e, { id: i, tagName: a, attributes: o, namespace: s, value: c } = r, l = i ?? crypto.randomUUID(), u = o ? vd({
		tagName: a,
		attributes: o,
		dialecteConfig: t
	}) : [], d = {
...
function Sd(e) {
	...
	for (let [e, i] of r) i.query && (xd(t[e], i.query, e, "query"), t[e] = {
		...t[e],
		...i.query
	}), i.transaction && (xd(n[e], i.transaction, e, "transaction"), n[e] = {
		...n[e],
		...i.transaction
	});
	return {
...
}, jd = { supportedFileExtensions: [".nsd", ".nsdoc"] }, Md = {
	singletonElements: Od,
	elements: Cd,
	namespaces: {
		default: {
			uri: "http://www.iec.ch/61850/2016/NSD",
...
}, Fd = {}, Id = Object.create, Ld = Object.defineProperty, Rd = Object.getOwnPropertyDescriptor, zd = Object.getOwnPropertyNames, Bd = Object.getPrototypeOf, Vd = Object.prototype.hasOwnProperty, Hd = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), Ud = (e, t, n, r) => {
	if (t && typeof t == "object" || typeof t == "function") for (var i = zd(t), a = 0, o = i.length, s; a < o; a++) s = i[a], !Vd.call(e, s) && s !== n && Ld(e, s, {
		get: ((e) => t[e]).bind(null, s),
		enumerable: !(r = Rd(t, s)) || r.enumerable
	});
	return e;
}, Wd = (e, t, n) => (n = e == null ? {} : Id(Bd(e)), Ud(t || !e || !e.__esModule ? Ld(n, "default", {
	value: e,
	enumerable: !0
}) : n, e));
function Gd(e, t) {
...
function Kd(e) {
	...
	for (let e = t.length - 1; e >= 0; e--) {
		let i = t[e];
		if (r === void 0) {
			if ((i.status === "created" || i.status === "updated") && pd(i.newRecord, n)) return {
				...i.newRecord,
				status: i.status
			};
			if (i.status === "deleted" && pd(i.oldRecord, n)) return {
				...i.oldRecord,
				status: "deleted"
			};
			continue;
...
async function $(e) {
	...
	let r;
	if (n.id === void 0) {
		let e = `__singleton_${n.tagName}`, i = Gp(t) ? t.recordCache.get(e) : void 0;
		i ? r = i : (r = (await t.store.getByTagNameInDocument(n.tagName, t.documentId))[0], r && Gp(t) && (t.recordCache.set(r.id, r), t.recordCache.set(e, r)));
	} else {
		let e = Gp(t) ? t.recordCache.get(n.id) : void 0;
		e ? r = e : (r = await t.store.get(n.id, t.documentId), r && Gp(t) && t.recordCache.set(n.id, r));
	}
	if (r) return r.tagName !== n.tagName && td("ELEMENT_TAGNAME_MISMATCH", {
...
async function Zd(e) {
	...
	for (let e of r) Gp(t) && t.recordCache.set(e.id, e);
	return qd({
		rawRecords: r,
		stagedOperations: t.stagedOperations,
		tagName: n
...
async function tf(e) {
	let { context: t, tagName: n, attributes: r } = e, i = await Zd({
		context: t,
		tagName: n
	}), a = [];
	for (let e of i) nf({
...
async function rf(e) {
	let { context: t, ref: n, options: r } = e, { collect: i, omit: a } = r, o = af(a), s = sf(i), c = /* @__PURE__ */ new Map();
	for (let e of s.allTags) c.set(e, /* @__PURE__ */ new Map());
	let l = await $({
		context: t,
		ref: n
	});
	return l && (s.mode === "flat" ? await uf({
		context: t,
		rootId: l.id,
		collectSpec: s,
		omitSpec: o,
...
function of(e) {
	...
	for (let e of n.conditional) if (e.tagName === t.tagName && nf({
		record: t,
...
async function pf(e) {
	...
	for (let e of r) {
		...
		for (let n of r) a.get(e.tagName).set(n.id, n), !e.isLeaf && e.children.length > 0 && await pf({
			context: t,
			record: n,
...
function Cf(e) {
	...
	return n.unconditional.has(t.tagName) ? !0 : n.conditional.some((e) => e.scope === "self" && e.tagName === t.tagName && nf({
		record: t,
		attributeFilter: e.where
	}));
}
function wf(e) {
	let { record: t, compiledOmit: n } = e;
	return n.conditional.some((e) => e.scope === "children" && e.tagName === t.tagName && nf({
		record: t,
		attributeFilter: e.where
	}));
}
...
async function Df(e) {
	...
	let l = Sf(o), u = t.dialecteConfig.transparentElements, d = await Of({
		context: t,
		record: c,
		select: a,
		compiledOmit: l,
...
async function Of(e) {
	...
	return _d({
		record: n,
		tree: (await Promise.all(s.map(({ record: e, select: n }) => Of({
			context: t,
			record: e,
			select: n,
			compiledOmit: i,
...
var jf = new Set(["where", "recursive"]);
function Mf(e) {
	let t = /* @__PURE__ */ new Set();
	for (let n of Object.keys(e)) jf.has(n) || t.add(n);
	return t;
}
function Nf(e) {
...
function Pf(e) {
	...
	if (!(!r || n.recursive === !1) && r.children[t.tagName]?.includes(t.tagName) && !(n.where && !nf({
		record: t,
...
async function Lf(e) {
	...
	if (!n && i === void 0) return Rf({
		context: t,
		includeDeleted: a
	});
	let o = e.siblings ?? !1, s = o === !0 || typeof o == "object" && !!o, c = typeof o == "object" && !!o && o.expand === !0, l = n ?? { tagName: t.dialecteConfig.rootElementName }, u = /* @__PURE__ */ new Map(), d = /* @__PURE__ */ new Map(), f = a ? Yd(t.stagedOperations) : void 0, p = (e) => {
...
async function Rf(e) {
	let { context: t, includeDeleted: n = !1 } = e, { live: r, deleted: i } = Jd({
...
})), Hf = /* @__PURE__ */ Wd((/* @__PURE__ */ Hd(((e, t) => {
...
function Uf(e) {
	return (0, Hf.default)(e);
}
function Wf(e) {
	return Uf("<?xml version=\"1.0\" encoding=\"UTF-8\"?>\n" + new XMLSerializer().serializeToString(e));
}
async function Gf(e) {
	let { extension: t, xmlDocument: n, filename: r } = e, i = Wf(n);
	await ld({
...
function Kf(e) {
	...
	return d.setAttribute("xmlns", s.namespace.uri), s.attributes && Yf({
		config: n,
		document: u,
		element: d,
	...
	}), s.value && (d.textContent = s.value.trim()), r && d.setAttribute("_temp-idb-id", s.id), u.appendChild(d), qf({
		index: a,
		config: n,
		withDatabaseIds: r,
		xmlDocument: u,
...
function Jf(e) {
	...
	return !s && r.namespace.prefix && r.namespace.prefix !== "xmlns" ? (Xf({
		config: t,
		document: n,
		namespace: r.namespace,
		isFragment: o
	}), c = n.createElementNS(r.namespace.uri, `${r.namespace.prefix}:${r.tagName}`)) : c = n.createElementNS(r.namespace.uri, r.tagName), r.attributes && Yf({
		config: t,
		document: n,
		element: c,
...
function Xf(e) {
	...
	a.getAttributeNS(o, r.prefix) === null && (a.setAttributeNS(o, `xmlns:${r.prefix}`, r.uri), i || Zf({
		config: t,
		rootElement: a,
		namespace: r
	}));
...
function ep(e) {
	let { config: t, tagName: n, attribute: r } = e, i = rd({
		dialecteConfig: t,
		tagName: n,
...
var tp = /* @__PURE__ */ Hd(((e, t) => {
	t.exports = {};
})), np = /* @__PURE__ */ Wd((/* @__PURE__ */ Hd(((e) => {
	(function(e) {
...
function ap(e) {
	...
	o.onopentag = (e) => a = op({
		...
		text: e,
		state: a
	}), o.onclosetag = () => ({updatedState: a} = cp({
		state: a,
		hooks: i,
		session: r,
		dialecteConfig: t
...
function op(e) {
	let { node: t, state: n, dialecteConfig: r, useCustomRecordsIds: i } = e, a = { ...n }, o = up(t);
	a.defaultNamespace ||= dp({
		element: t,
		defaultNamespace: r.namespaces.default,
		rootElementName: r.rootElementName
	});
	let s = fp(t, a.defaultNamespace), c = {
		id: hp({
...
function hp(e) {
	let { attributes: t, useCustomRecordsIds: n } = e, r = t[ud];
	return n && r && r.value ? r.value : crypto.randomUUID();
}
function gp(e) {
	let { attributes: t, useCustomRecordsIds: n } = e;
	return n ? Object.values(t).filter((e) => e.name !== ud) : Object.values(t);
}
var _p = 32 * 1024, vp = 2e3;
async function yp(e) {
	...
	if (Z(c.some((e) => s.name.toLowerCase().endsWith(e)), {
	...
	let u = a?.chunkSize ?? _p, d = a?.batchSize ?? vp, f = new rp(), p = ap({
		dialecteConfig: r,
		useCustomRecordsIds: i,
		session: f,
		hooks: o
...
async function bp(e) {
	...
	for (; !f;) {
		let e = await l.read();
		if (f = e.done, f) {
			d.length > 0 && n.parser.write(u.decode(d)), n.parser.close(), c += await Cp({
				sax: n,
				session: r,
				store: i,
				documentId: a,
		...
		if (e.value) for (d = Sp(d, e.value); d.length >= o;) {
			let e = u.decode(d.slice(0, o), { stream: !0 });
			d = d.slice(o), n.parser.write(e), c += await Cp({
				sax: n,
				session: r,
				store: i,
				documentId: a,
...
async function wp(e) {
	let { context: t, options: n = {} } = e, { ref: r, ancestors: i, siblings: a, depth: o, includeDeleted: s, omit: c, unwrap: l, as: u = "tree" } = n, d = await Lf({
		context: t,
		ref: r ? Q(r) : void 0,
		ancestors: i,
		siblings: a,
...
var Dp = class {
	...
	get any() {
		return this._any ??= new Dp(() => this.context, this.dialecteConfig);
	}
	getOperations() {
		return [];
	}
...
function kp(e) {
	...
	r && (o = hd(r)), i && (s = hd(i)), a && (c = hd(a)), n === "created" ? (Z(o, {
...
async function Mp(e) {
	let { dialecteConfig: t, hooks: n, context: r, query: i, parentRef: a, record: o, cumulativeCloneMappings: s } = e, c = [], l = await Np({
		dialecteConfig: t,
		hooks: n,
		context: r,
		query: i,
...
async function Fp(e) {
	...
	for (let e of n.children) {
		...
		n && (n.children.length > 0 && await Fp({
			context: t,
			record: n
		}), kp({
			context: t,
...
async function Ip(e) {
	let { dialecteConfig: t, hooks: n, context: r, query: i, parentRef: a, params: o } = e, s = Lp(o.attributes), c = await $d({
		context: r,
		ref: a,
		tagName: o.tagName
	});
	return (s ? c.find((e) => nf({
		record: e,
		attributeFilter: s
	})) : o.id === void 0 ? c[0] : c.find((e) => e.id === o.id)) || jp({
		dialecteConfig: t,
		hooks: n,
		context: r,
		query: i,
...
function zp(e, t) {
	return e.value !== t.value || e.attributes.length !== t.attributes.length ? !1 : e.attributes.every((e, n) => Bp(e, t.attributes[n]));
}
function Bp(e, t) {
	return e.name === t.name && e.value === t.value && e.namespace?.uri === t.namespace?.uri && e.namespace?.prefix === t.namespace?.prefix;
}
var Vp = class extends Dp {
	constructor(e, t, n, r) {
...
async function Up(e) {
	let { stagedOperations: t, store: n, documentId: r, documentState: i } = e, { creates: a, updates: o, deletes: s } = Hp(t), c = a.length + o.length + s.length;
...
var Wp = class extends Op {
	...
	get any() {
		return this._anyTx ??= new Vp(() => this.context, this.dialecteConfig, this.hooks, this);
	}
	getOperations() {
...
var Kp = class {
	...
	withQueryExtensions(e) {
		let t = Gd(this.extensionsRegistry?.query, e);
		return Object.assign(e, t);
	}
	withAllExtensions(e) {
		let t = Gd(this.extensionsRegistry?.query, e), n = Gd(this.extensionsRegistry?.transaction, e), r = {};
	...
	createQuery() {
		return new Op(this.store, this.config, this.documentId);
	}
	get query() {
		return this.withQueryExtensions(this.createQuery());
	}
	createTransaction() {
		return new Wp(this.store, this.config, this.documentId, this.state, this.hooks);
	}
...
}, qp = "_documents", Jp = "_changeLog", Yp = "_meta", Xp = "xel_";
function Zp(e) {
	return `${Xp}${e}`;
}
var Qp = "_blobs", $p = "blob_";
function em(e) {
	return `${$p}${e}`;
}
var tm = {
	...
	compoundIndexes: [],
	arrayIndexes: []
}, om = /* @__PURE__ */ Wd((/* @__PURE__ */ Hd(((e, t) => {
	(function(n, r) {
...
})))(), 1), sm = Symbol.for("Dexie"), cm = globalThis[sm] || (globalThis[sm] = om.default);
if (om.default.semVer !== cm.semVer) throw Error(`Two different versions of Dexie loaded in the same app: ${om.default.semVer} and ${cm.semVer}`);
var { liveQuery: lm, mergeRanges: um, rangesOverlap: dm, RangeSet: fm, cmp: pm, Entity: mm, PropModification: hm, replacePrefix: gm, add: _m, remove: vm, DexieYProvider: ym } = cm;
function bm(e) {
...
var xm = {
	...
	constructor(e, t) {
		this.schemaVersion = 1, this.knownDocuments = /* @__PURE__ */ new Map(), this.schemaLock = Promise.resolve(), this.name = e, this.dexieRecordSchema = bm(t?.recordSchema ?? xm), this.db = new cm(e);
	}
	async open() {
		let e = new cm(this.name);
		e.version(1).stores({
			[qp]: bm(tm),
			[Jp]: bm(nm),
			[Yp]: bm(rm),
		...
		try {
			await e.open();
			let t = await e.table(qp).toArray(), n = await e.table(Yp).get("schemaVersion");
			e.close();
		...
		this.db = new cm(this.name), this.db.version(this.schemaVersion).stores(this.buildStores()), await this.db.open();
	}
	close() {
		this.db.close();
	}
	async destroy() {
		this.db.isOpen() && (this.db.close(), await Cm()), await cm.delete(this.name), this.knownDocuments.clear();
	}
	async registerDocument(e) {
		await this.withSchemaLock(async () => {
			this.knownDocuments.set(e.id, e), await this.reopenWithNewSchema(), await this.db.table(qp).add(e);
		});
	}
	async getDocument(e) {
		return this.db.table(qp).get(e);
	}
	async getDocuments() {
		return this.db.table(qp).toArray();
	}
	async updateDocument(e, t) {
		await this.db.table(qp).update(e, t);
	...
	async removeDocument(e) {
		await this.withSchemaLock(async () => {
			...
			let n = em(e);
			this.db.tables.some((e) => e.name === n) && await this.db.table(n).clear(), await this.db.table(Qp).where({ documentId: e }).delete(), await this.db.table(Jp).where({ documentId: e }).delete(), await this.db.table(Yp).delete(`head:${e}`), await this.db.table(qp).delete(e), this.knownDocuments.delete(e), await this.reopenWithNewSchema({ drop: e });
		});
	}
	async get(e, t) {
	...
	async commit(e) {
		...
		try {
			await this.db.transaction("rw", o, this.db.table(Jp), this.db.table(Yp), async () => {
				...
				let u = await this.getHead(t), d = await this.db.table(Jp).where({ documentId: t }).filter((e) => e.sequenceNumber > u).toArray();
				...
				await this.db.table(Jp).add(p), await this.setHead(t, f);
			});
		} catch (e) {
	...
	async undo(e) {
		...
		if (t === 0) return;
		let n = await this.db.table(Jp).where({
			documentId: e,
			sequenceNumber: t
		}).first();
		if (!n) return;
		let r = this.db.table(this.resolveTableName(e));
		await this.db.transaction("rw", r, this.db.table(Yp), async () => {
	...
	async redo(e) {
		let t = await this.getHead(e) + 1, n = await this.db.table(Jp).where({
			documentId: e,
			sequenceNumber: t
		}).first();
		if (!n) return;
	...
	async getHistoryStatus(e) {
		let t = await this.getHead(e), n = await this.db.table(Jp).where({
			documentId: e,
			sequenceNumber: t + 1
		}).first();
		return {
	...
	async getChangeLog(e) {
		return this.db.table(Jp).where({ documentId: e }).sortBy("sequenceNumber");
	}
	async addBlob(e, t) {
		wm(this.knownDocuments, e.documentId);
		let n = this.db.table(em(e.documentId));
		await this.db.transaction("rw", this.db.table(Qp), n, async () => {
			await this.db.table(Qp).put(e), await n.put({
				id: e.id,
				data: t
			});
		});
	...
	async getBlob(e) {
		let t = await this.db.table(Qp).get(e);
		if (!t) return;
		let n = await this.db.table(em(t.documentId)).get(e);
		if (n) return {
			entry: t,
			data: n.data
		};
	...
	async getBlobsByDocument(e) {
		return (await this.db.table(Qp).toArray()).filter((t) => t.attachedTo.some((t) => t.documentId === e));
	}
	async getBlobsByRecord(e, t) {
		return (await this.db.table(Qp).toArray()).filter((n) => n.attachedTo.some((n) => n.documentId === e && n.recordRef === t));
	}
	async getStandaloneBlobs() {
		return (await this.db.table(Qp).toArray()).filter((e) => e.attachedTo.length === 0);
	}
	async attachBlob(e, t) {
		let n = await this.db.table(Qp).get(e);
		...
		await this.db.table(Qp).update(e, { attachedTo: r });
	}
	...
	async removeBlob(e) {
		let t = await this.db.table(Qp).get(e);
		if (!t) return;
		let n = this.db.table(em(t.documentId));
		await this.db.transaction("rw", this.db.table(Qp), n, async () => {
			await n.delete(e), await this.db.table(Qp).delete(e);
		});
	}
	getDatabaseInstance() {
		return this.db;
	...
	buildStores(e) {
		...
		for (let e of this.knownDocuments.keys()) t[this.resolveTableName(e)] = this.dexieRecordSchema, t[em(e)] = n;
		return e?.drop && (t[this.resolveTableName(e.drop)] = null, t[em(e.drop)] = null), t;
	}
	async reopenWithNewSchema(e) {
		this.db.close(), await Cm(), this.schemaVersion++, this.db = new cm(this.name), this.db.version(this.schemaVersion).stores(this.buildStores(e)), await this.db.open(), await this.db.table(Yp).put({
			key: "schemaVersion",
...
var Tm = class {
	...
	async registerDocument(e) {
		this.guardWritable(), this.documents.set(e.id, e), this.records.set(Zp(e.id), /* @__PURE__ */ new Map()), this.blobData.set(e.id, /* @__PURE__ */ new Map());
	}
	async getDocument(e) {
	...
	async removeDocument(e) {
		this.guardWritable(), this.documents.delete(e), this.records.delete(Zp(e)), this.changelog.delete(e), this.heads.delete(e), this.blobData.delete(e);
	...
	getTable(e) {
		let t = Zp(e), n = this.records.get(t);
...
function Em(e, t, n) {
	return t.type === "local" ? new Sm(e, { recordSchema: n.database.recordSchema }) : t.type === "inMemory" ? new Tm(e, { writable: t.writable ?? !0 }) : t.store;
}
async function Dm(e) {
...
async function Om(e) {
	...
	let a = i.entry.name;
	return r?.withDownload && await ld({
		data: i.data,
		filename: a
	}), {
		entry: i.entry,
...
function Am(e, t) {
	...
	for (let n of t) e.has(n.id) || e.set(n.id, km(n));
...
var Nm = class {
	...
	get postChannel() {
		return Z(this._postChannel !== void 0, {
			key: "PROJECT_NOT_OPENED",
			detail: "Call project.open(name) before accessing project properties."
		}), this._postChannel;
	}
	...
	constructor(e) {
		...
		this.storage = e.storage, this.configs = e.configs, this.defaultConfigKey = e.defaultConfigKey ?? t[0], this.hooks = e.hooks, this.mergedExtensions = e.extensions ? Sd({
	...
	async open(e) {
		...
		let t = Em(e, this.storage, this.configs[this.defaultConfigKey]);
		await t.open(), this._store = t;
		let n = await t.getDocuments();
		for (let e of n) this.state.documents.set(e.id, km(e));
	...
	async import(e, t) {
		let n = await Promise.all(e.map((e) => jm({
			file: e,
			store: this.store,
			configs: this.configs,
			defaultConfigKey: this.defaultConfigKey,
	...
	openDocument(e) {
		...
		return new Kp(this.store, n, e, this.mergedExtensions, this.hooks, {
			state: t,
	...
	async refreshState() {
		...
		Am(this.state.documents, e);
	}
};
//#endregion
//#region node_modules/.pnpm/@dialecte+nsd@0.1.5/node_modules/@dialecte/nsd/dist/v2017A/index.js
function Pm(e) {
...
var Fm = "SET-LIBRARY-NSD", Im = null;
function Lm() {
	return Im ||= Pm().open(Fm), Im;
}
var Rm = /* @__PURE__ */ Jt(0);
function zm() {
	Rm.value++;
}
//#endregion
...
function Km() {}
//#endregion
export { qr as $, us as A, Ws as B, cu as C, t as Ct, Y as D, Kl as E, es as F, Ni as G, _a as H, ds as I, Yo as J, Li as K, X as L, ss as M, ts as N, Wo as O, ps as P, Wi as Q, Kr as R, Wu as S, Se as St, Ml as T, _s as U, sr as V, zn as W, Xi as X, or as Y, Qi as Z, Yu as _, en as _t, Wm as a, Ks as at, Uu as b, F as bt, Lm as c, Oe as ct, jd as d, Lt as dt, pr as et, md as f, zt as ft, $u as g, ln as gt, Z as h, K as ht, Hm as i, ir as it, Us as j, Or as k, Rm as l, q as lt, dd as m, Yt as mt, Km as n, dr as nt, Vm as o, an as ot, hd as p, Jt as pt, Fi as q, Um as r, rr as rt, Bm as s, De as st, Gm as t, ur as tt, zm as u, ke as ut, Gu as v, Qt as vt, nu as w, ku as x, ue as xt, Ou as y, $t as yt, Cs as z };

...
var ku = (e) => e(), Au = Symbol(), ju = Symbol();
function Mu(e, t) {
	e instanceof Map && t instanceof Map ? t.forEach((t, n) => e.set(n, t)) : e instanceof Set && t instanceof Set && t.forEach(e.add, e);
	for (let n in t) {
		if (!t.hasOwnProperty(n)) continue;
		let r = t[n], i = e[n];
		du(i) && du(r) && e.hasOwnProperty(n) && !/* @__PURE__ */ q(r) && !/* @__PURE__ */ Ht(r) ? e[n] = Mu(i, r) : e[n] = r;
	}
	return e;
}
var Nu = Symbol();
function Pu(e) {
	return !du(e) || !Object.prototype.hasOwnProperty.call(e, Nu);
}
...
function Lu(e, t, n, r) {
	...
	function l() {
		return s || (n.state.value[e] = i ? i() : {}), Fu(/* @__PURE__ */ on(n.state.value[e]), a, Object.keys(o || {}).reduce((t, r) => (t[r] = Gt(Bs(() => {
			lu(n);
			let t = n._s.get(e);
			return o[r].call(t, t);
		})), t), {}));
	}
	return c = Ru(e, l, t, n, r, !0), c;
}
function Ru(e, t, n = {}, r, i, a) {
	...
	let v = (t, n = "") => {
		...
		let i = function() {
			...
			return l instanceof Promise ? l.then((e) => (Ou(a, e), e)).catch((e) => (Ou(o, e), Promise.reject(e))) : (Ou(a, l), l);
		};
		return i[Au] = !0, i[ju] = n, i;
	}, y = /* @__PURE__ */ Lt({
		_p: r,
		$id: e,
		...
		$reset: g,
		$subscribe(t, n = {}) {
			let i = Du(d, t, n.detached, () => a()), a = o.run(() => pr(() => r.state.value[e], (r) => {
				(n.flush === "sync" ? u : l) && t({
					storeId: e,
					type: fu.direct,
					events: void 0
	...
	r._s.set(e, y);
	let b = (r._a && r._a.runWithContext || ku)(() => r._e.run(() => (o = De()).run(() => t({ action: v }))));
	for (let t in b) {
		let n = b[t];
		/* @__PURE__ */ q(n) && !Iu(n) || /* @__PURE__ */ Ht(n) ? a || (p && Pu(n) && (/* @__PURE__ */ q(n) ? n.value = p[t] : Mu(n, p[t])), r.state.value[e][t] = n) : typeof n == "function" && (b[t] = v(n, t), s.actions[t] = n);
	}
	return Fu(y, b), Fu(/* @__PURE__ */ K(y), b), Object.defineProperty(y, "$state", {
		get: () => r.state.value[e],
		set: (e) => {
			h((t) => {
				Fu(t, e);
...
function zu(e, t, n) {
	...
	function a(n, a) {
		let o = J();
		return n ||= o ? sr(uu, null) : null, n && lu(n), n = cu, n._s.has(e) || (i ? Ru(e, t, r, n) : Lu(e, r, n)), n._s.get(e);
	}
	return a.$id = e, a;
}
function Bu(e) {
...
//#endregion
//#region node_modules/.pnpm/@dialecte+core@0.2.16/node_modules/@dialecte/core/dist/utils-B_-lXlpE.js
var Vu = {
	UNKNOWN: {
		code: "D0001",
...
function Ku(e, t) {
	let n = Gu[e], r = {
		...
		message: t.message ?? n.message,
		detail: t.detail,
		method: qu((/* @__PURE__ */ Error()).stack),
		ref: t.ref,
		cause: t.cause
	}, i = Error(t.detail);
	throw i.cause = r, i;
...
function Qu() {
	return Ju(Yu, { detail: "getProject: shell context not set. Call setShellContext(api) before app.mount()." }), Yu.project;
}
//#endregion
//#region node_modules/.pnpm/@septkit+ui@0.0.32_daisyui@5.5.19_tailwindcss@4.2.2_typescript@5.9.3_vite@8.0.9_@types+node@22.19.17_jiti@2.6.1_/node_modules/@septkit/ui/dist/external/.pnpm/@dialecte_core@0.2.16/node_modules/@dialecte/core/dist/utils-B_-lXlpE.js
var $u = {
	UNKNOWN: {
		code: "D0001",
		message: "An unknown error occurred"
...
function ed(e, t) {
	let n = $u[e], r = {
		...
		message: t.message ?? n.message,
		detail: t.detail,
		method: td((/* @__PURE__ */ Error()).stack),
		ref: t.ref,
		cause: t.cause
	}, i = Error(t.detail);
	throw i.cause = r, i;
...
var rd = Object.create, id = Object.defineProperty, ad = Object.getOwnPropertyDescriptor, od = Object.getOwnPropertyNames, sd = Object.getPrototypeOf, cd = Object.prototype.hasOwnProperty, ld = (e, t) => () => (t || (e((t = { exports: {} }).exports, t), e = null), t.exports), ud = (e, t, n, r) => {
	if (t && typeof t == "object" || typeof t == "function") for (var i = od(t), a = 0, o = i.length, s; a < o; a++) s = i[a], !cd.call(e, s) && s !== n && id(e, s, {
		get: ((e) => t[e]).bind(null, s),
		enumerable: !(r = ad(t, s)) || r.enumerable
	});
	return e;
}, dd = (e, t, n) => (n = e == null ? {} : rd(sd(e)), ud(t || !e || !e.__esModule ? id(n, "default", {
	value: e,
	enumerable: !0
}) : n, e));
function fd(e, t) {
...
var pd = /* @__PURE__ */ dd((/* @__PURE__ */ ld(((e, t) => {
	(function(n, r) {
...
})))(), 1), md = Symbol.for("Dexie"), hd = globalThis[md] || (globalThis[md] = pd.default);
if (pd.default.semVer !== hd.semVer) throw Error(`Two different versions of Dexie loaded in the same app: ${pd.default.semVer} and ${hd.semVer}`);
var { liveQuery: gd, mergeRanges: _d, rangesOverlap: vd, RangeSet: yd, cmp: bd, Entity: xd, PropModification: Sd, replacePrefix: Cd, add: wd, remove: Td, DexieYProvider: Ed } = hd, Dd = /* @__PURE__ */ ld(((e, t) => {
...
function kd(e) {
	...
	let a = Object.keys(r).length > 0, o = Object.keys(i).length > 0, s = a || o, c = Bs(() => {
		let e = t.value;
		if (nd(e, { detail: "createDocumentStore: document accessed before hydration. Ensure hydrate() is called before consumers read document, or guard with isHydrated." }), !s) return e;
		let n = e;
		return Ad(n, {
			query: a ? Ad(n.query, fd(r, n.query)) : n.query,
			transaction: o ? (e) => n.transaction((t) => e(Ad(t, fd(i, t)))) : n.transaction
		});
	}), l = Bs(() => t.value !== null);
	function u(e) {
		t.value = e;
...
var Md = typeof window < "u" && typeof document < "u";
...
function Id(e, t = !1, n = "Timeout") {
	return new Promise((r, i) => {
		setTimeout(t ? () => i(n) : r, e);
	});
}
function Ld(e, t = 200, n = {}) {
	return Pd(Fd(t, n), e);
}
function Rd(e, t = !1) {
	function n(n, { flush: r = "sync", deep: i = !1, timeout: a, throwOnTimeout: o } = {}) {
		...
		return a != null && c.push(Id(a, o).then(() => en(e)).finally(() => s?.())), Promise.race(c);
	}
	function r(r, i) {
		...
		return s != null && u.push(Id(s, c).then(() => en(e)).finally(() => (l?.(), en(e)))), Promise.race(u);
	}
	function i(e) {
		return n((e) => !!e, e);
	}
...
Md && window.document, Md && window.navigator, Md && window.location;
function Bd(e, t, n) {
	let { immediate: r = !0, delay: i = 0, onError: a = globalThis.reportError ?? Nd, onSuccess: o = Nd, resetOnExecute: s = !0, shallow: c = !0, throwError: l } = n ?? {}, u = c ? /* @__PURE__ */ Yt(t) : /* @__PURE__ */ Jt(t), d = /* @__PURE__ */ Yt(!1), f = /* @__PURE__ */ Yt(!1), p = /* @__PURE__ */ Yt(void 0), m = 0;
	async function h(n = 0, ...r) {
		let i = m += 1;
		s && (u.value = en(t)), p.value = void 0, d.value = !1, f.value = !0, n > 0 && await Id(n);
...
function Vd(e) {
	let { document: t, fetcher: n, initial: r } = e, { state: i, isLoading: a, error: o, execute: s } = Bd(n, r), c = Ld(s, 50);
	return pr(() => {
...
function Hd(e) {
	...
	{
		let t = e.parentNode;
		return !t || t.tagName === "BODY" ? !1 : Hd(t);
	}
}
//#endregion
...
var [Wd, Gd] = /* @__PURE__ */ Ud("ConfigProvider");
//#endregion
...
function Kd(e) {
	return e ? e.flatMap((e) => e.type === Y ? Kd(e.children) : [e]) : [];
}
//#endregion
...
var [qd, Jd] = /* @__PURE__ */ Ud("PopperRoot");
//#endregion
...
function Xd(e, t, n = ".", r) {
	if (!Yd(t)) return Xd(e, {}, n, r);
	let i = { ...t };
	for (let t of Object.keys(e)) {
		if (t === "__proto__" || t === "constructor") continue;
		let a = e[t];
		a != null && (r && r(i, t, a, n) || (Array.isArray(a) && Array.isArray(i[t]) ? i[t] = [...a, ...i[t]] : Yd(a) && Yd(i[t]) ? i[t] = Xd(a, i[t], (n ? `${n}.` : "") + t.toString(), r) : i[t] = a));
	}
	return i;
}
function Zd(e) {
	...
	{
		let t = e.parentNode;
		return !(t instanceof Element) || t.tagName === "BODY" ? !1 : Zd(t);
	}
}
jd(() => /* @__PURE__ */ Jt([]));
//#endregion
...
function rf(e) {
	return ((af(e) ? e.ownerDocument : e.document) || window.document)?.documentElement;
}
function af(e) {
	return ef() ? e instanceof Node || e instanceof nf(e).Node : !1;
}
function of(e) {
	return ef() ? e instanceof Element || e instanceof nf(e).Element : !1;
}
function sf(e) {
	return ef() ? e instanceof HTMLElement || e instanceof nf(e).HTMLElement : !1;
}
function cf(e) {
	return !ef() || typeof ShadowRoot > "u" ? !1 : e instanceof ShadowRoot || e instanceof nf(e).ShadowRoot;
}
function lf(e) {
	let { overflow: t, overflowX: n, overflowY: r, display: i } = ff(e);
...
function pf(e) {
	if (tf(e) === "html") return e;
	let t = e.assignedSlot || e.parentNode || cf(e) && e.host || rf(e);
	return cf(t) ? t.host : t;
}
function mf(e) {
	let t = pf(e);
	return df(t) ? e.ownerDocument ? e.ownerDocument.body : e.body : sf(t) && lf(t) ? t : mf(t);
}
function hf(e, t, n) {
	t === void 0 && (t = []), n === void 0 && (n = !0);
	let r = mf(e), i = r === e.ownerDocument?.body, a = nf(r);
	if (i) {
		let e = gf(a);
		return t.concat(a, a.visualViewport || [], lf(r) ? r : [], e && n ? hf(e) : []);
	} else return t.concat(r, hf(r, [], n));
}
function gf(e) {
...
function _f(e, t) {
	let n = pf(e);
	return n === t || !of(n) || df(n) ? !1 : ff(n).position === "fixed" || _f(n, t);
}
var vf = Object.defineProperty, yf = Object.getOwnPropertyDescriptor, bf = Object.getOwnPropertyNames, xf = Object.prototype.hasOwnProperty, Sf = (e, t) => {
	let n = {};
	for (var r in e) vf(n, r, {
		get: e[r],
		enumerable: !0
	});
	return t || vf(n, Symbol.toStringTag, { value: "Module" }), n;
}, Cf = (e, t, n, r) => {
	if (t && typeof t == "object" || typeof t == "function") for (var i = bf(t), a = 0, o = i.length, s; a < o; a++) s = i[a], !xf.call(e, s) && s !== n && vf(e, s, {
		get: ((e) => t[e]).bind(null, s),
		enumerable: !(r = yf(t, s)) || r.enumerable
	});
	return e;
};
((e, t, n) => (Cf(e, t, "default"), n && Cf(n, t, "default")))(/* @__PURE__ */ Sf({
	Vue: () => au,
	Vue2: () => void 0,
	del: () => Ef,
	install: () => wf,
...
}, [Of, kf] = /* @__PURE__ */ Ud("PopperContent");
({ ...Df });
//#endregion
//#region node_modules/.pnpm/@septkit+ui@0.0.32_daisyui@5.5.19_tailwindcss@4.2.2_typescript@5.9.3_vite@8.0.9_@types+node@22.19.17_jiti@2.6.1_/node_modules/@septkit/ui/dist/external/.pnpm/@lucide_vue@1.16.0_vue@3.5.32_typescript@5.8.3_/node_modules/@lucide/vue/dist/esm/shared/src/utils/isEmptyString.js
var { document: Af, isHydrated: jf, hydrate: Mf, clear: Nf } = kd();
//#endregion
...
async function If(e) {
	...
	if (!t || !n) return;
	let r = await zf(e, t), i = await e.query.getAttributes(n);
	return {
		id: i.id || "",
		toolId: i.toolID || "",
		uuid: i.uuid || "",
...
async function zf(e, t) {
	...
	return [r, ...Array.from(new Set(i.map((e) => e.name))).filter(Boolean).map((e) => Bf(n, e))].sort((e, t) => e.prefix === "SCL" ? -1 : t.prefix === "SCL" ? 1 : e.prefix.localeCompare(t.prefix));
}
function Bf(e, t) {
...
var Vf = zu("versionStore", () => {
	let e = /* @__PURE__ */ Jt(), t = /* @__PURE__ */ Jt(), n = Bs(() => Pf(t.value, e.value));
	async function r(n) {
		e.value = void 0, t.value = void 0, e.value = await Ff(n), t.value = await If(n);
	}
...
var Gf = ["open"], Kf = { class: "modal-box relative max-w-lg w-full max-h-[70vh] overflow-auto" }, qf = { class: "fieldset" }, Jf = { class: "fieldset" }, Yf = {
	key: 0,
	role: "alert",
	class: "alert alert-error text-sm"
}, Xf = { class: "flex justify-end gap-2 mt-4" }, Zf = /* @__PURE__ */ Kr({
	...
	emits: ["update:isOpen"],
	setup(e) {
		let t = e, n = Ba(e, "isOpen"), r = /* @__PURE__ */ Jt(""), i = /* @__PURE__ */ Jt(""), a = /* @__PURE__ */ Jt(), o = Vf();
		Wf(n, function() {
		...
		async function s() {
			a.value = void 0;
			try {
				Wu(o.currentVersionRevision, { detail: "No current version/revision found" }), await o.editVersionDetails(Af.value, o.currentVersionRevision.version, o.currentVersionRevision.revision, r.value, i.value), l();
			} catch (e) {
		...
		return (e, t) => (X(), Z("dialog", {
			...
			Q("form", {
				...
				Q("fieldset", qf, [t[6] ||= Q("legend", { class: "fieldset-legend text-sm" }, "What?", -1), ir(Q("input", {
					type: "text",
					class: "input w-full",
					"onUpdate:modelValue": t[1] ||= (e) => r.value = e,
					placeholder: "Describe the changes"
				}, null, 512), [[kl, r.value]])]),
				Q("fieldset", Jf, [t[7] ||= Q("legend", { class: "fieldset-legend text-sm" }, "Why?", -1), ir(Q("input", {
					type: "text",
					class: "input w-full",
					"onUpdate:modelValue": t[2] ||= (e) => i.value = e,
					placeholder: "Reason for the changes"
				}, null, 512), [[kl, i.value]])]),
				a.value ? (X(), Z("div", Yf, F(a.value), 1)) : us("", !0),
				Q("div", Xf, [Q("button", {
					type: "button",
					class: "btn",
					onClick: t[3] ||= (e) => l()
...
}), Qf = { class: "w-full max-w-lg my-2" }, $f = { class: "bg-base-100 rounded border-none overflow-hidden" }, ep = { class: "p-4" }, tp = { class: "space-y-1" }, np = {
	class: "flex items-baseline gap-2",
	"data-testid": "current-version-version-row"
}, rp = { class: "select-text" }, ip = {
	class: "flex items-baseline gap-2",
	"data-testid": "current-version-revision-row"
}, ap = { class: "select-text" }, op = { key: 0 }, sp = { class: "space-y-1" }, cp = {
	class: "flex items-baseline gap-2",
	"data-testid": "current-version-editedby-row"
}, lp = { class: "select-text" }, up = {
	class: "flex items-baseline gap-2",
	"data-testid": "current-version-date-row"
}, dp = { class: "select-text" }, fp = { class: "mt-5 bg-base-300 rounded-xl p-4 overflow-hidden" }, pp = {
	class: "mt-2 text-sm overflow-auto max-h-54 pr-1 space-y-3",
	"data-testid": "changes-details"
}, mp = { class: "select-text whitespace-pre-wrap" }, hp = { class: "select-text whitespace-pre-wrap" }, gp = {
	key: 1,
	class: "mt-2 text-sm opacity-70"
}, _p = /* @__PURE__ */ Kr({
	__name: "current-version-widget",
	setup(e) {
		let t = Qu(), { sclFileHistoryItems: n, generalInformationItem: r } = Bu(Vf()), i = /* @__PURE__ */ Jt(!1), a = Bs(() => r.value?.currentVersion ?? "-"), o = Bs(() => r.value?.currentRevision ?? "-"), s = Bs(() => !r.value?.currentVersion || !r.value?.currentRevision ? null : n.value?.find((e) => e.version === a.value && e.revision === o.value) ?? null), c = Bs(() => s.value?.who?.trim() || "-"), l = Bs(() => Uf(s.value?.when ?? "-"));
		async function u() {
			await t.export(Af.value.documentId, { withDownload: !0 });
		}
		function d() {
			i.value = !0;
		}
		return (e, t) => (X(), Z("section", Qf, [Q("div", $f, [Q("div", ep, [
			t[11] ||= Q("h2", { class: "text-lg font-semibold mb-4" }, "Current version", -1),
			Q("div", tp, [Q("div", np, [t[1] ||= Q("span", { class: "font-medium" }, "Version:", -1), Q("span", rp, F(a.value), 1)]), Q("div", ip, [t[2] ||= Q("span", { class: "font-medium" }, "Revision:", -1), Q("span", ap, F(o.value), 1)])]),
			t[12] ||= Q("div", { class: "divider my-4" }, null, -1),
			s.value ? (X(), Z("div", op, [Q("div", sp, [Q("div", cp, [t[3] ||= Q("span", { class: "font-semibold" }, "Edited by:", -1), Q("span", lp, F(c.value), 1)]), Q("div", up, [t[4] ||= Q("span", { class: "font-semibold" }, "Date:", -1), Q("span", dp, F(l.value), 1)])]), Q("div", fp, [Q("div", { class: "flex items-start justify-between gap-4" }, [t[6] ||= Q("h4", { class: "font-semibold" }, "Changes", -1), Q("div", { class: "inline-block" }, [Q("button", {
				...
				"aria-hidden": "true"
			}, [Q("path", { d: "M12 20h9" }), Q("path", { d: "M16.5 3.5a2.121 2.121 0 0 1 3 3L7 19l-4 1 1-4Z" })], -1)]])])]), Q("div", pp, [Q("div", null, [t[7] ||= Q("p", { class: "italic font-medium" }, "What?:", -1), Q("p", mp, F(s.value.what), 1)]), Q("div", null, [t[8] ||= Q("p", { class: "italic font-medium" }, "Why?:", -1), Q("p", hp, F(s.value.why), 1)])])])])) : (X(), Z("div", gp, [...t[9] ||= [Q("em", null, "No version information found.", -1)]])),
			Q("button", {
...
}), vp = { class: "w-full max-w-lg my-2" }, yp = { class: "bg-base-100 rounded border-none overflow-hidden" }, bp = { class: "p-4" }, xp = {
	key: 0,
	class: "space-y-2"
}, Sp = { class: "flex items-baseline gap-2" }, Cp = { class: "select-text" }, wp = { class: "flex items-baseline gap-2" }, Tp = { class: "select-text" }, Ep = { class: "flex items-baseline gap-2" }, Dp = { class: "select-text" }, Op = { class: "flex items-baseline gap-2" }, kp = { class: "select-text" }, Ap = { class: "space-y-2" }, jp = { class: "font-medium" }, Mp = { class: "select-text" }, Np = {
	key: 0,
	...
	setup(e) {
		let { generalInformationItem: t } = Bu(Vf());
		function n(e) {
			if (!e) return "—";
			let t = [];
		...
		return (e, i) => (X(), Z("section", vp, [Q("div", yp, [Q("div", bp, [i[7] ||= Q("h2", { class: "text-lg font-semibold mb-4" }, "General Information", -1), $t(t) ? (X(), Z("div", xp, [
			Q("div", Sp, [i[0] ||= Q("span", { class: "font-medium" }, "id:", -1), Q("span", Cp, F($t(t).id || "—"), 1)]),
			Q("div", wp, [i[1] ||= Q("span", { class: "font-medium" }, "toolID:", -1), Q("span", Tp, F($t(t).toolId || "—"), 1)]),
			Q("div", Ep, [i[2] ||= Q("span", { class: "font-medium" }, "uuid:", -1), Q("span", Dp, F($t(t).uuid || "—"), 1)]),
			Q("div", Op, [i[3] ||= Q("span", { class: "font-medium" }, "nameStructure:", -1), Q("span", kp, F($t(t).nameStructure || "—"), 1)]),
			i[5] ||= Q("div", { class: "divider my-4" }, null, -1),
			Q("div", Ap, [(X(!0), Z(Y, null, Xi($t(t)?.namespaces ?? [], (e) => (X(), Z("div", {
				key: e.prefix,
				class: "flex items-baseline gap-2"
			}, [Q("span", jp, F(r(e.prefix)) + ":", 1), Q("span", Mp, F(n(e)), 1)]))), 128)), $t(t)?.namespaces?.length ? us("", !0) : (X(), Z("div", Np, [...i[4] ||= [Q("em", null, "No namespaces found.", -1)]]))])
		])) : (X(), Z("div", Pp, [...i[6] ||= [Q("em", null, "No general information found.", -1)]]))])])]));
	}
}), Ip = { class: "w-full max-w-lg my-2" }, Lp = { class: "overflow-hidden" }, Rp = {
	key: 0,
	class: "space-y-1"
}, zp = { class: "space-y-1" }, Bp = { class: "collapse collapse-arrow collapse-arrow-left w-full" }, Vp = { class: "collapse-title text-base font-semibold py-1 min-h-0" }, Hp = { class: "collapse-content" }, Up = { class: "space-y-1" }, Wp = { class: "collapse-title text-base font-semibold py-1 min-h-0" }, Gp = { class: "collapse-content text-sm space-y-2" }, Kp = { class: "space-y-1" }, qp = { class: "flex items-baseline gap-2" }, Jp = { class: "select-text" }, Yp = { class: "flex items-baseline gap-2" }, Xp = { class: "select-text" }, Zp = { class: "space-y-1" }, Qp = { class: "flex items-baseline gap-2" }, $p = { class: "select-text" }, em = { class: "flex items-baseline gap-2" }, tm = { class: "select-text" }, nm = {
	key: 0,
	class: "text-sm opacity-70"
}, rm = {
	key: 1,
	...
	setup(e) {
		let { sclFileHistoryItems: t } = Bu(Vf()), n = Bs(() => {
			let e = t.value ?? [];
			if (!e.length) return [];
			let n = [...e].sort((e, t) => {
		...
		return (e, t) => (X(), Z("section", Ip, [Q("div", Lp, [t[8] ||= Q("h2", { class: "text-lg font-semibold mb-4" }, "Previous versions", -1), n.value.length ? (X(), Z("div", Rp, [Q("div", zp, [(X(!0), Z(Y, null, Xi(n.value, (e) => (X(), Z("div", {
			key: e.version,
			class: "w-full"
		}, [Q("div", Bp, [
			t[6] ||= Q("input", { type: "checkbox" }, null, -1),
			Q("div", Vp, " Version " + F(e.version), 1),
			Q("div", Hp, [Q("div", Up, [(X(!0), Z(Y, null, Xi(e.items, (e) => (X(), Z("div", {
				key: e.version + "-" + e.revision,
				class: "collapse collapse-arrow collapse-arrow-left w-full"
			}, [
				t[4] ||= Q("input", { type: "checkbox" }, null, -1),
				Q("div", Wp, " Version " + F(e.version) + "." + F(e.revision), 1),
				Q("div", Gp, [Q("div", Kp, [Q("div", qp, [t[0] ||= Q("span", { class: "font-semibold" }, "Edited by:", -1), Q("span", Jp, F(e.who || "—"), 1)]), Q("div", Yp, [t[1] ||= Q("span", { class: "font-semibold" }, "Date:", -1), Q("span", Xp, F(r(e.when)), 1)])]), Q("div", Zp, [Q("div", Qp, [t[2] ||= Q("span", { class: "font-semibold" }, "What:", -1), Q("span", $p, F(e.what || "—"), 1)]), Q("div", em, [t[3] ||= Q("span", { class: "font-semibold" }, "Why:", -1), Q("span", tm, F(e.why || "—"), 1)])])])
			]))), 128)), e.items.length ? us("", !0) : (X(), Z("div", nm, [...t[5] ||= [Q("em", null, "No revisions found.", -1)]]))])])
		])]))), 128))])])) : (X(), Z("div", rm, [...t[7] ||= [Q("em", null, "No version history found.", -1)]]))])]));
	}
}), am = (e, t) => {
	let n = e.__vccOpts || e;
	for (let [e, r] of t) n[e] = r;
	return n;
}, om = /* @__PURE__ */ am(im, [["__scopeId", "data-v-c965f3aa"]]), sm = {}, cm = {
	width: "16",
	height: "16",
	viewBox: "0 0 20 20",
	fill: "currentColor"
...
function lm(e, t) {
	return X(), Z("svg", cm, [...t[0] ||= [Q("path", { d: "M5 11C4.44772 11 4 10.5523 4 10C4 9.44772 4.44772 9 5 9H15C15.5523 9 16 9.44772 16 10C16 10.5523 15.5523 11 15 11H5Z" }, null, -1), Q("path", { d: "M9 5C9 4.44772 9.44772 4 10 4C10.5523 4 11 4.44772 11 5V15C11 15.5523 10.5523 16 10 16C9.44772 16 9 15.5523 9 15V5Z" }, null, -1)]]);
}
var um = /* @__PURE__ */ am(sm, [["render", lm]]), dm = { class: "w-full" }, fm = ["open"], pm = { class: "modal-box relative max-w-lg w-full max-h-[70vh] overflow-auto" }, mm = { class: "version-modal__fieldset" }, hm = { class: "version-modal__legend" }, gm = { class: "version-modal__radio-label" }, _m = ["disabled"], vm = { class: "version-modal__label" }, ym = { class: "version-modal__legend" }, bm = { class: "version-modal__label" }, xm = { class: "version-modal__label" }, Sm = {
	key: 0,
	role: "alert",
	class: "alert alert-error text-sm"
}, Cm = /* @__PURE__ */ am(/* @__PURE__ */ Kr({
	...
	setup(e) {
		...
		return (e, u) => (X(), Z(Y, null, [Q("div", dm, [Q("button", {
			class: "btn mb-2 w-full",
			onClick: c,
			title: "New version/revision"
		}, [$(um, { class: "w-5 h-5 shrink-0" }), u[5] ||= Q("span", { class: "overflow-hidden text-ellipsis whitespace-nowrap" }, "New version/revision", -1)])]), Q("dialog", {
			class: "modal",
			role: "dialog",
			"aria-modal": "true",
			open: n.value,
			...
			Q("form", {
				...
				Q("fieldset", mm, [Q("legend", hm, [
					u[9] ||= cs(" Version type ", -1),
					Q("label", gm, [ir(Q("input", {
						id: "version-radio",
						type: "radio",
					...
					}, null, 8, _m), [[Ml, r.value]]), u[8] ||= Q("span", null, "Revision", -1)], 2)
				])]),
				Q("label", vm, [u[10] ||= Q("span", null, "Edited by", -1), ir(Q("input", {
				...
				Q("legend", ym, [
					u[13] ||= cs(" Changes ", -1),
					Q("label", bm, [u[11] ||= Q("span", null, "What?", -1), ir(Q("input", {
						class: "version-modal__input input",
						"onUpdate:modelValue": u[3] ||= (e) => a.value = e,
						placeholder: "Describe the changes"
					}, null, 512), [[kl, a.value]])]),
					Q("label", xm, [u[12] ||= Q("span", null, "Why?", -1), ir(Q("input", {
						class: "version-modal__input input",
						"onUpdate:modelValue": u[4] ||= (e) => o.value = e,
						placeholder: "Reason for the changes"
					}, null, 512), [[kl, o.value]])])
				]),
				s.value ? (X(), Z("div", Sm, F(s.value), 1)) : us("", !0),
...
}), [["__scopeId", "data-v-3c687d2a"]]), wm = {
	key: 0,
	class: "overflow-auto h-full flex flex-col items-center p-4"
}, Tm = /* @__PURE__ */ Kr({
	__name: "app",
	setup(e) {
		let t = Vf(), n = Bs(() => !!t.currentVersionRevision);
		Vd({
			document: Af,
			fetcher: async () => {
				await t.loadVersionHistory(Af.value);
			},
			initial: void 0
		});
		async function r(e, n, r, i) {
			await t.createVersion(Af.value, e, n, r, i, "");
		}
		return (e, t) => $t(jf) ? (X(), Z("article", wm, [
			$(Cm, {
...
function Em(e, t) {
	Wu(document.getElementById(e), { detail: `could not find root element: ${e}` }), Xu({
		project: t.project,
		activeDocumentId: t.activeDocumentId,
		commands: t.commands
	});
	let n = (e) => {
		e ? Mf(t.project.openDocument(e)) : Nf();
	};
	n(t.activeDocumentId.value);
	let r = t.activeDocumentId.subscribe(n), i = $l(Tm);
	return i.use(Tu()), i.mount(`#${e}`), () => {
		r(), i.unmount(), Zu(), Nf();
	};
}
//#endregion

import { s as _a, H as Sa, r as Oa, G as xa, a7 as Aa, a5 as Pa, a0 as Ot, ae as jr, ad as Me, af as qr, ag as Ca, ah as Da } from "./import-wrapper-prod-DxtF_TnE.js";
function Na(O) {
  return _a() ? (Sa(O), !0) : !1;
}
// @__NO_SIDE_EFFECTS__
...
function ja(O = {}) {
  const {
    ...
    var V;
    const H = (V = Fa(O.input)) != null ? V : b ? b.createElement("input") : void 0;
    return H && (H.type = "file", H.onchange = (ae) => {
      const J = ae.target;
    ...
    const H = q.value;
    H && (H.multiple = Ot(V.multiple), H.accept = Ot(V.accept), H.webkitdirectory = Ot(V.directory), Ra(V, "capture") && (H.capture = Ot(V.capture)));
  }, pe = (V) => {
    const H = q.value;
    if (!H)
      return;
...
function Ga() {
  return Vr || (Vr = 1, function(O) {
    (function(b) {
      ...
      function D(s) {
        for (var i = Math.max(b.MAX_BUFFER_LENGTH, 10), _ = 0, T = 0, ee = A.length; T < ee; T++) {
          var Q = s[A[T]].length;
          if (Q > i)
            switch (A[T]) {
              case "textNode":
              ...
              case "script":
                ...
                break;
              default:
                Ue(s, "Max buffer length exceeded: " + A[T]);
            }
          _ = Math.max(_, Q);
        }
      ...
      function pe(s, i) {
        ...
        this._parser.onend = function() {
          ...
          _.emit("error", T), _._parser.error = null;
        }, this._decoder = null, G.forEach(function(T) {
          Object.defineProperty(_, "on" + T, {
            get: function() {
              return _._parser["on" + T];
            },
            set: function(ee) {
              if (!ee)
                return _.removeAllListeners(T), _._parser["on" + T] = ee, ee;
              _.on(T, ee);
            },
            enumerable: !0,
            configurable: !1
      ...
      pe.prototype = Object.create(q.prototype, {
        ...
        return !_._parser["on" + s] && G.indexOf(s) !== -1 && (_._parser["on" + s] = function() {
          ...
          T.splice(0, 0, s), _.emit.apply(_, T);
        }), q.prototype.on.call(_, s, i);
      };
      var V = "[CDATA[", H = "DOCTYPE", ae = "http://www.w3.org/XML/1998/namespace", J = "http://www.w3.org/2000/xmlns/", ge = { xml: ae, xmlns: J }, $ = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, be = /[:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/, Se = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD]/, le = /[#:_A-Za-z\u00C0-\u00D6\u00D8-\u00F6\u00F8-\u02FF\u0370-\u037D\u037F-\u1FFF\u200C-\u200D\u2070-\u218F\u2C00-\u2FEF\u3001-\uD7FF\uF900-\uFDCF\uFDF0-\uFFFD\u00B7\u0300-\u036F\u203F-\u2040.\d-]/;
      function ne(s) {
        return s === " " || s === `
` || s === "\r" || s === "	";
      }
...
Char: ` + s.c), i = new Error(i), s.error = i, Fe(s, "onerror", i), s;
      ...
      function je(s, i) {
        var _ = s.indexOf(":"), T = _ < 0 ? ["", s] : s.split(":"), ee = T[0], Q = T[1];
      ...
      function Ie(s) {
        ...
        if (s.opt.xmlns) {
          var i = je(s.attribName, !0), _ = i.prefix, T = i.local;
          if (_ === "xmlns")
            if (T === "xml" && s.attribValue !== ae)
              oe(
                s,
                "xml: prefix must be bound to " + ae + `
Actual: ` + s.attribValue
              );
            else if (T === "xmlns" && s.attribValue !== J)
              oe(
                s,
...
Actual: ` + s.attribValue
              ...
              ee.ns === Q.ns && (ee.ns = Object.create(Q.ns)), ee.ns[T] = s.attribValue;
            }
      ...
      function Be(s, i) {
        if (s.opt.xmlns) {
          var _ = s.tag, T = je(s.tagName);
          _.prefix = T.prefix, _.local = T.local, _.uri = _.ns[T.prefix] || "", _.prefix && !_.uri && (oe(s, "Unbound namespace prefix: " + JSON.stringify(s.tagName)), _.uri = T.prefix);
          ...
          for (var Q = 0, ue = s.attribList.length; Q < ue; Q++) {
            var xe = s.attribList[Q], he = xe[0], Xe = xe[1], Te = je(he, !0), Ke = Te.prefix, gn = Te.local, vt = Ke === "" ? "" : _.ns[Ke] || "", Ne = {
              name: he,
              value: Xe,
              prefix: Ke,
              local: gn,
      ...
      function At(s) {
        ...
        for (var Q = s.tags.length; Q-- > i; ) {
          ...
          for (var he in ue.ns)
            xe[he] = ue.ns[he];
          var Xe = s.tags[s.tags.length - 1] || s;
          s.opt.xmlns && ue.ns !== Xe.ns && Object.keys(ue.ns).forEach(function(Te) {
            var Ke = ue.ns[Te];
            W(s, "onclosenamespace", { prefix: Te, uri: Ke });
          });
        }
        i === 0 && (s.closedRoot = !0), s.tagName = s.attribValue = s.attribName = "", s.attribList.length = 0, s.state = S.TEXT;
      }
      function Ye(s) {
        var i = s.entity, _ = i.toLowerCase(), T, ee = "";
        return s.ENTITIES[i] ? s.ENTITIES[i] : s.ENTITIES[_] ? s.ENTITIES[_] : (i = _, i.charAt(0) === "#" && (i.charAt(1) === "x" ? (i = i.slice(2), T = parseInt(i, 16), ee = T.toString(16)) : (i = i.slice(1), T = parseInt(i, 10), ee = T.toString(10))), i = i.replace(/^0+/, ""), isNaN(T) || ee.toLowerCase() !== i ? (oe(s, "Invalid character entity"), "&" + s.entity + ";") : String.fromCodePoint(T));
      }
      function Pt(s, i) {
...
` ? (i.line++, i.column = 0) : i.column++), i.state) {
            ...
            case S.TEXT:
              if (i.sawRoot && !i.closedRoot) {
                for (var ee = _ - 1; T && T !== "<" && T !== "&"; )
                  T = at(s, _++), T && i.trackPosition && (i.position++, T === `
` ? (i.line++, i.column = 0) : i.column++);
                i.textNode += s.substring(ee, _ - 1);
              }
              T === "<" && !(i.sawRoot && i.closedRoot && !i.strict) ? (i.state = S.OPEN_WAKA, i.startTagPosition = i.position) : (!ne(T) && (!i.sawRoot || i.closedRoot) && oe(i, "Text data outside of root node."), T === "&" ? i.state = S.TEXT_ENTITY : i.textNode += T);
              continue;
            case S.SCRIPT:
              T === "<" ? i.state = S.SCRIPT_ENDING : i.script += T;
              continue;
            case S.SCRIPT_ENDING:
              T === "/" ? i.state = S.CLOSE_TAG : (i.script += "<" + T, i.state = S.SCRIPT);
              continue;
            case S.OPEN_WAKA:
              if (T === "!")
                i.state = S.SGML_DECL, i.sgmlDecl = "";
              else if (!ne(T)) if (se($, T))
                i.state = S.OPEN_TAG, i.tagName = T;
              else if (T === "/")
            ...
            case S.SGML_DECL:
              ...
              i.doctype && i.doctype !== !0 && i.sgmlDecl ? (i.state = S.DOCTYPE_DTD, i.doctype += "<!" + i.sgmlDecl + T, i.sgmlDecl = "") : (i.sgmlDecl + T).toUpperCase() === V ? (W(i, "onopencdata"), i.state = S.CDATA, i.sgmlDecl = "", i.cdata = "") : (i.sgmlDecl + T).toUpperCase() === H ? (i.state = S.DOCTYPE, (i.doctype || i.sawRoot) && oe(
                i,
                "Inappropriately located doctype declaration"
              ), i.doctype = "", i.sgmlDecl = "") : T === ">" ? (W(i, "onsgmldeclaration", i.sgmlDecl), i.sgmlDecl = "", i.state = S.TEXT) : (de(T) && (i.state = S.SGML_DECL_QUOTED), i.sgmlDecl += T);
              continue;
            case S.SGML_DECL_QUOTED:
              T === i.q && (i.state = S.SGML_DECL, i.q = ""), i.sgmlDecl += T;
              continue;
            case S.DOCTYPE:
              T === ">" ? (i.state = S.TEXT, W(i, "ondoctype", i.doctype), i.doctype = !0) : (i.doctype += T, T === "[" ? i.state = S.DOCTYPE_DTD : de(T) && (i.state = S.DOCTYPE_QUOTED, i.q = T));
              continue;
            case S.DOCTYPE_QUOTED:
              i.doctype += T, T === i.q && (i.q = "", i.state = S.DOCTYPE);
              continue;
            case S.DOCTYPE_DTD:
              T === "]" ? (i.doctype += T, i.state = S.DOCTYPE) : T === "<" ? (i.state = S.OPEN_WAKA, i.startTagPosition = i.position) : de(T) ? (i.doctype += T, i.state = S.DOCTYPE_DTD_QUOTED, i.q = T) : i.doctype += T;
              continue;
            case S.DOCTYPE_DTD_QUOTED:
              i.doctype += T, T === i.q && (i.state = S.DOCTYPE_DTD, i.q = "");
              continue;
            case S.COMMENT:
              T === "-" ? i.state = S.COMMENT_ENDING : i.comment += T;
              continue;
            case S.COMMENT_ENDING:
              T === "-" ? (i.state = S.COMMENT_ENDED, i.comment = rt(i.opt, i.comment), i.comment && W(i, "oncomment", i.comment), i.comment = "") : (i.comment += "-" + T, i.state = S.COMMENT);
              continue;
            case S.COMMENT_ENDED:
              T !== ">" ? (oe(i, "Malformed comment"), i.comment += "--" + T, i.state = S.COMMENT) : i.doctype && i.doctype !== !0 ? i.state = S.DOCTYPE_DTD : i.state = S.TEXT;
              continue;
            case S.CDATA:
              T === "]" ? i.state = S.CDATA_ENDING : i.cdata += T;
              continue;
            case S.CDATA_ENDING:
              T === "]" ? i.state = S.CDATA_ENDING_2 : (i.cdata += "]" + T, i.state = S.CDATA);
              continue;
            case S.CDATA_ENDING_2:
              T === ">" ? (i.cdata && W(i, "oncdata", i.cdata), W(i, "onclosecdata"), i.cdata = "", i.state = S.TEXT) : T === "]" ? i.cdata += "]" : (i.cdata += "]]" + T, i.state = S.CDATA);
              continue;
            case S.PROC_INST:
              T === "?" ? i.state = S.PROC_INST_ENDING : ne(T) ? i.state = S.PROC_INST_BODY : i.procInstName += T;
              continue;
            case S.PROC_INST_BODY:
              if (!i.procInstBody && ne(T))
                continue;
              T === "?" ? i.state = S.PROC_INST_ENDING : i.procInstBody += T;
              continue;
            case S.PROC_INST_ENDING:
              T === ">" ? (W(i, "onprocessinginstruction", {
                name: i.procInstName,
                body: i.procInstBody
              }), i.procInstName = i.procInstBody = "", i.state = S.TEXT) : (i.procInstBody += "?" + T, i.state = S.PROC_INST_BODY);
              continue;
            case S.OPEN_TAG:
              se(be, T) ? i.tagName += T : (Ve(i), T === ">" ? Be(i) : T === "/" ? i.state = S.OPEN_TAG_SLASH : (ne(T) || oe(i, "Invalid character in tag name"), i.state = S.ATTRIB));
              continue;
            case S.OPEN_TAG_SLASH:
              T === ">" ? (Be(i, !0), At(i)) : (oe(i, "Forward-slash in opening tag not followed by >"), i.state = S.ATTRIB);
              continue;
            case S.ATTRIB:
              if (ne(T))
                continue;
              T === ">" ? Be(i) : T === "/" ? i.state = S.OPEN_TAG_SLASH : se($, T) ? (i.attribName = T, i.attribValue = "", i.state = S.ATTRIB_NAME) : oe(i, "Invalid attribute name");
              continue;
            case S.ATTRIB_NAME:
              T === "=" ? i.state = S.ATTRIB_VALUE : T === ">" ? (oe(i, "Attribute without value"), i.attribValue = i.attribName, Ie(i), Be(i)) : ne(T) ? i.state = S.ATTRIB_NAME_SAW_WHITE : se(be, T) ? i.attribName += T : oe(i, "Invalid attribute name");
              continue;
            case S.ATTRIB_NAME_SAW_WHITE:
              if (T === "=")
                ...
                oe(i, "Attribute without value"), i.tag.attributes[i.attribName] = "", i.attribValue = "", W(i, "onattribute", {
                  name: i.attribName,
                  value: ""
                }), i.attribName = "", T === ">" ? Be(i) : se($, T) ? (i.attribName = T, i.state = S.ATTRIB_NAME) : (oe(i, "Invalid attribute name"), i.state = S.ATTRIB);
              }
              continue;
            case S.ATTRIB_VALUE:
              if (ne(T))
                continue;
              de(T) ? (i.q = T, i.state = S.ATTRIB_VALUE_QUOTED) : (i.opt.unquotedAttributeValues || Ue(i, "Unquoted attribute value"), i.state = S.ATTRIB_VALUE_UNQUOTED, i.attribValue = T);
              continue;
            case S.ATTRIB_VALUE_QUOTED:
              if (T !== i.q) {
                T === "&" ? i.state = S.ATTRIB_VALUE_ENTITY_Q : i.attribValue += T;
                continue;
              }
              Ie(i), i.q = "", i.state = S.ATTRIB_VALUE_CLOSED;
              continue;
            case S.ATTRIB_VALUE_CLOSED:
              ne(T) ? i.state = S.ATTRIB : T === ">" ? Be(i) : T === "/" ? i.state = S.OPEN_TAG_SLASH : se($, T) ? (oe(i, "No whitespace between attributes"), i.attribName = T, i.attribValue = "", i.state = S.ATTRIB_NAME) : oe(i, "Invalid attribute name");
              continue;
            case S.ATTRIB_VALUE_UNQUOTED:
              if (!Oe(T)) {
                T === "&" ? i.state = S.ATTRIB_VALUE_ENTITY_U : i.attribValue += T;
                continue;
              }
              Ie(i), T === ">" ? Be(i) : i.state = S.ATTRIB;
              continue;
            case S.CLOSE_TAG:
              if (i.tagName)
                T === ">" ? At(i) : se(be, T) ? i.tagName += T : i.script ? (i.script += "</" + i.tagName, i.tagName = "", i.state = S.SCRIPT) : (ne(T) || oe(i, "Invalid tagname in closing tag"), i.state = S.CLOSE_TAG_SAW_WHITE);
              else {
                if (ne(T))
                  continue;
                mt($, T) ? i.script ? (i.script += "</" + T, i.state = S.SCRIPT) : oe(i, "Invalid tagname in closing tag.") : i.tagName = T;
              }
              continue;
            case S.CLOSE_TAG_SAW_WHITE:
              if (ne(T))
                continue;
              T === ">" ? At(i) : oe(i, "Invalid characters in closing tag");
              continue;
            case S.TEXT_ENTITY:
            ...
            case S.ATTRIB_VALUE_ENTITY_U:
              ...
              } else se(i.entity.length ? le : Se, T) ? i.entity += T : (oe(i, "Invalid character in entity name"), i[xe] += "&" + i.entity + T, i.entity = "", i.state = ue);
              continue;
            default:
      ...
      String.fromCodePoint || function() {
        var s = String.fromCharCode, i = Math.floor, _ = function() {
          var T = 16384, ee = [], Q, ue, xe = -1, he = arguments.length;
          if (!he)
            return "";
          for (var Xe = ""; ++xe < he; ) {
            var Te = Number(arguments[xe]);
            ...
            Te <= 65535 ? ee.push(Te) : (Te -= 65536, Q = (Te >> 10) + 55296, ue = Te % 1024 + 56320, ee.push(Q, ue)), (xe + 1 === he || ee.length > T) && (Xe += s.apply(null, ee), ee.length = 0);
          }
          return Xe;
        };
...
var tr = { exports: {} }, Ha = tr.exports, Gr;
function Xa() {
    ...
    (function(A, d) {
      ...
      function ge(e) {
        return { from: function(t) {
          return e.prototype = Object.create(t.prototype), J(e.prototype, "constructor", e), { extend: H.bind(null, e.prototype) };
        } };
      }
...
`);
 ...
 ` + o : ""), this.inner = o || null) : typeof a == "object" && (this.message = "".concat(a.name, " ").concat(a.message), this.inner = a) : (this.message = At[t] || n, this.inner = null);
      ...
      ee.ModifyError = at, ee.DexieError = Ye, ee.BulkError = He;
      ...
      }, wn = !0, Qt = !0, st = [], zt = [], Tn = ue, We = { id: "global", global: !0, ref: 0, unhandleds: [], onunhandled: Q, pgp: !1, env: {}, finalize: Q }, U = We, Rt = [], ut = 0, Yt = [];
      function j(e) {
      ...
      var En = { get: function() {
        ...
        J(this, "then", e && e.prototype === Dt ? En : { get: function() {
          return e;
        }, set: En.set });
      } };
      ...
      function _n(e, t) {
        var n, r;
        zt.push(t), e._state === null && (n = e._lib && gt(), t = Tn(t), e._state = !1, e._value = t, r = e, st.some(function(a) {
      ...
      H(j.prototype, { then: En, _then: function(e, t) {
      ...
      } }), typeof Symbol < "u" && Symbol.toStringTag && J(j.prototype, Symbol.toStringTag, "Dexie.Promise"), We.env = ur(), H(j, { all: function() {
      ...
      var Ee = { awaits: 0, echoes: 0, id: 0 }, ea = 0, Xt = [], Wt = 0, $t = 0, ta = 0;
      function $e(e, t, n, r) {
      ...
      function Ze(e, t) {
        var n, r = U;
        (t ? !Ee.echoes || Wt++ && e === U : !Wt || --Wt && e === U) || queueMicrotask(t ? (function(a) {
          ++$t, Ee.echoes && --Ee.echoes != 0 || (Ee.echoes = Ee.awaits = Ee.id = 0), Xt.push(U), Ze(a, !0);
      ...
      function xn(e) {
        Promise === it && Ee.echoes === 0 ? Wt === 0 ? e() : enqueueNativeMicroTask(e) : setTimeout(e, 0);
      }
      ("" + ke).indexOf("[native code]") === -1 && (wt = Je = Q);
      var ye = j.reject, lt = "￿", Ge = "Invalid key provided. Keys must be of type string, number, Date or Array<string | number | Date>.", lr = "String expected.", Tt = [], Zt = "__dbnames", An = "readonly", Pn = "readwrite";
      function ft(e, t) {
        return e ? t ? function() {
      ...
      var mr = (ce.prototype._trans = function(e, t, n) {
        ...
        return this._trans("readwrite", function(u) {
          ...
          return r.core.mutate({ trans: u, type: "add", keys: a, values: h, wantResults: o }).then(function(m) {
            ...
            if (l === 0) return o ? w : p;
            throw new He("".concat(r.name, ".bulkAdd(): ").concat(l, " of ").concat(f, " operations failed"), m);
          });
        });
        ...
        return this._trans("readwrite", function(u) {
          ...
          return r.core.mutate({ trans: u, type: "put", keys: a, values: h, wantResults: o }).then(function(m) {
            var l = m.numFailures, w = m.results, p = m.lastResult, m = m.failures;
            if (l === 0) return o ? w : p;
            throw new He("".concat(r.name, ".bulkPut(): ").concat(l, " of ").concat(f, " operations failed"), m);
          });
        });
          ...
          return n.getMany({ trans: u, keys: r, cache: "clone" }).then(function(c) {
            ...
            return n.mutate({ trans: u, type: "put", keys: f, values: h, updates: { keys: r, changeSpecs: a } }).then(function(l) {
              ...
              for (var m = 0, g = Object.keys(p); m < g.length; m++) {
                var v, E = g[m], x = o[Number(E)];
                x != null && (v = p[E], delete p[E], p[x] = v);
              }
              throw new He("".concat(t.name, ".bulkUpdate(): ").concat(w, " of ").concat(y, " operations failed"), p);
            });
          });
        });
        ...
        return this._trans("readwrite", function(r) {
          ...
          if (a === 0) return o;
          throw new He("".concat(t.name, ".bulkDelete(): ").concat(a, " of ").concat(n, " operations failed"), u);
        });
      }, ce);
      function ce() {
      }
      ...
      var ra = (re.prototype._read = function(e, t) {
        ...
        return this._read(function(n) {
          ...
          if (Et(r, !0)) return a.count({ trans: n, query: { index: nn(r, a.schema), range: r.range } }).then(function(u) {
        ...
        return this._write(function(r) {
          ...
          u = typeof e == "function" ? e : (a = M(e), o = a.length, function(E) {
            for (var x = !1, P = 0; P < o; ++P) {
              var C = a[P], N = e[C], F = Oe(E, C);
              N instanceof Bt ? (se(E, C, N.execute(F)), x = !0) : F !== N && (se(E, C, N), x = !0);
            }
            return x;
          });
          ...
          return t.clone().primaryKeys().then(function(E) {
            function x(C) {
              var N = Math.min(y, E.length - C), F = E.slice(C, C + N);
              return (v ? Promise.resolve([]) : c.getMany({ trans: r, keys: F, cache: "immutable" })).then(function(I) {
                ...
                if (!v) for (var X = 0; X < N; ++X) {
                  var te = I[X], Y = { value: we(te), primKey: E[C + X] };
                  u.call(Y, Y.value, Y) !== !1 && (Y.value == null ? L.push(E[C + X]) : f || Z(h(te), h(Y.value)) === 0 ? (K.push(Y.value), f && B.push(E[C + X])) : (L.push(E[C + X]), k.push(Y.value)));
                }
        ...
        return e._addAlgorithm(function(m, g, v) {
          ...
          for (var P = null, C = p; C < l; ++C) {
            var N = function(F, I, k, K, B, L) {
              for (var X = Math.min(F.length, K.length), te = -1, Y = 0; Y < X; ++Y) {
                var me = I[Y];
              ...
              return X < K.length && L === "next" ? F + k.substr(F.length) : X < F.length && L === "prev" ? F.substr(0, k.length) : te < 0 ? null : F.substr(0, te) + K[te] + k.substr(te + 1);
            }(E, x, c[C], f[C], u, h);
      ...
      var Tr = (Object.defineProperty(_e.prototype, "Collection", { get: function() {
        ...
        return E._ondirectionchange = function(x) {
          l = x === "next" ? (v = m, a) : (v = g, o), y.sort(w);
        }, E._addAlgorithm(function(x, P, C) {
      ...
      function ua(e, t, f) {
        ...
        function a(w) {
          ...
          return { name: m, schema: w, mutate: function(g) {
            var v = g.trans, E = g.type, x = g.keys, P = g.values, C = g.range;
            return new Promise(function(N, F) {
              ...
              if (E === "deleteRange") {
                ...
                if (K) for (var Ce = 0; Ce < L; ++Ce) te.push(B = Pe && Pe[Ce] !== void 0 ? I[E](z[Ce], Pe[Ce]) : I[E](z[Ce])), B.onerror = X;
                else for (Ce = 0; Ce < L; ++Ce) te.push(B = I[E](z[Ce])), B.onerror = X;
              }
              function vn(De) {
                De = De.target.result, te.forEach(function(ht, Jn) {
                  return ht.error != null && (Y[Jn] = ht.error);
                }), N({ numFailures: me, failures: Y, results: E === "delete" ? x : te.map(function(ht) {
                  return ht.result;
                }), lastResult: De });
              }
            ...
            return new Promise(function(x, P) {
              x = fe(x);
              for (var C, N = v.objectStore(m), F = E.length, I = new Array(F), k = 0, K = 0, B = function(te) {
                te = te.target, I[te._pos] = te.result, ++K === k && x(I);
              }, L = qe(P), X = 0; X < F; ++X) E[X] != null && ((C = N.get(E[X]))._pos = X, C.onsuccess = B, C.onerror = L, ++k);
              k === 0 && x(I);
            });
          }, get: function(g) {
            ...
            return new Promise(function(v, E) {
              ...
              }, I.onerror = qe(E)) : (x = 0, P = !N && "openKeyCursor" in K ? K.openKeyCursor(B) : K.openCursor(B), C = [], P.onsuccess = function(L) {
                var X = P.result;
                return X ? (C.push(N ? X.value : X.primaryKey), ++x === F ? v({ result: C }) : void X.continue()) : v({ result: C });
              }, P.onerror = qe(E));
            });
          }), openCursor: function(g) {
            var v = g.trans, E = g.values, x = g.query, P = g.reverse, C = g.unique;
            return new Promise(function(N, F) {
              N = fe(N);
              var K = x.index, I = x.range, k = v.objectStore(m), k = K.isPrimaryKey ? k : k.index(K.name), K = P ? C ? "prevunique" : "prev" : C ? "nextunique" : "next", B = !E && "openKeyCursor" in k ? k.openKeyCursor(r(I), K) : k.openCursor(r(I), K);
              B.onerror = qe(F), B.onsuccess = fe(function(L) {
                var X, te, Y, me, z = B.result;
                z ? (z.___id = ++sa, z.done = !1, X = z.continue.bind(z), te = (te = z.continuePrimaryKey) && te.bind(z), Y = z.advance.bind(z), me = function() {
                  ...
                  return B.onsuccess = fe(function(De) {
                    B.onsuccess = Ce, Ce();
                  }), z.continue = X, z.continuePrimaryKey = te, z.advance = Y, Ce(), vn;
                }, N(z)) : N(null);
              }, F);
            });
          }, count: function(g) {
            var v = g.query, E = g.trans, x = v.index, P = v.range;
            return new Promise(function(C, N) {
              var F = E.objectStore(m), I = x.isPrimaryKey ? F : F.index(x.name), F = r(P), I = F ? I.count(F) : I.count();
        ...
        var o, u, c, y = (u = f, c = _r((o = e).objectStoreNames), { schema: { name: o.name, tables: c.map(function(w) {
          ...
          var p = w.keyPath, v = w.autoIncrement, m = q(p), g = {}, v = { name: w.name, primaryKey: { name: null, isPrimaryKey: !0, outbound: p == null, compound: m, keyPath: p, autoIncrement: v, unique: !0, extractKey: kn(p) }, indexes: _r(w.indexNames).map(function(E) {
            return w.index(E);
          }).map(function(C) {
      ...
      function fa(e, t, n, r) {
        ...
        $e(function() {
          return U.trans = o, U.transless = c, t !== 0 ? (on(e, n), h = t, ((f = o).storeNames.includes("$meta") ? f.table("$meta").get("version").then(function(y) {
            ...
            return w = y, p = o, m = n, g = [], y = (l = e)._versions, v = l._dbSchema = cn(0, l.idbdb, m), (y = y.filter(function(E) {
              return E._cfg.version >= w;
            })).length !== 0 ? (y.forEach(function(E) {
              g.push(function() {
                var x = v, P = E._cfg.dbschema;
                ...
                l.idbdb.objectStoreNames.contains("$meta") && (Math.ceil(l.idbdb.version / 10) === E._cfg.version ? (l.idbdb.deleteObjectStore("$meta"), delete l._dbSchema.$meta, l._storeNames = l._storeNames.filter(function(P) {
                  return P !== "$meta";
                })) : x.objectStore("$meta").put(E._cfg.version, "version"));
              });
            }), function E() {
      ...
      H(Ae.prototype, ((ke = { add: function(e) {
        ...
        function c() {
          return new j(function(w, p) {
            ...
            g.onerror = qe(p), g.onblocked = fe(e._fireOnBlocked), g.onupgradeneeded = fe(function(v) {
              var E;
              y = g.transaction, t.autoSchema && !e._options.allowEmptyDB ? (g.onerror = Kt, y.abort(), g.result.close(), (E = n.deleteDatabase(m)).onsuccess = E.onerror = fe(function() {
              ...
              y = null;
              var v, E, x, P, C, N = e.idbdb = g.result, F = Se(N.objectStoreNames);
              if (0 < F.length) try {
                var I = N.transaction((P = F).length === 1 ? P[0] : P, "readonly");
                if (t.autoSchema) E = N, x = I, (v = e).verno = E.version / 10, x = v._dbSchema = cn(0, E, x), v._storeNames = Se(E.objectStoreNames, 0), sn(v, [v._allTables], M(x), x);
              ...
              Tt.push(e), N.onversionchange = fe(function(k) {
      ...
      var ma = { stack: "dbcore", name: "VirtualIndexMiddleware", level: 1, create: function(e) {
        return d(d({}, e), { table: function(t) {
          ...
          function u(l, w, p) {
            var m = Lt(l), g = a[m] = a[m] || [], v = l == null ? 0 : typeof l == "string" ? 1 : l.length, E = 0 < w, E = d(d({}, p), { name: E ? "".concat(m, "(virtual-from:").concat(p.name, ")") : p.name, lowLevelIndex: p, isVirtual: E, keyTail: w, keyLength: v, extractKey: kn(l), unique: !E && p.unique });
            return g.push(E), E.isPrimaryKey || o.push(E), 1 < v && u(v === 2 ? l[0] : l.slice(0, v - 1), w + 1, p), g.sort(function(x, P) {
          ...
          return d(d({}, n), { schema: d(d({}, r), { primaryKey: t, indexes: o, getIndexByKeyPath: function(l) {
            ...
            function v(E) {
              return Object.create(E, { continue: { value: function(x) {
                x != null ? E.continue(hn(x, l.reverse ? e.MAX_KEY : e.MIN_KEY, p)) : l.unique ? E.continue(E.key.slice(0, g).concat(l.reverse ? e.MIN_KEY : e.MAX_KEY, p)) : E.continue();
              } }, continuePrimaryKey: { value: function(x, P) {
                E.continuePrimaryKey(hn(x, e.MAX_KEY, p), P);
      ...
      var ya = { stack: "dbcore", name: "HooksMiddleware", level: 2, create: function(e) {
        return d(d({}, e), { table: function(t) {
          ...
          return d(d({}, n), { mutate: function(a) {
                ...
                return o._promise("readwrite", function() {
                  return function l(w, p, m) {
                    return n.query({ trans: w, values: !1, query: { index: r, range: p }, limit: m }).then(function(g) {
                      var v = g.result;
                      return y({ type: "delete", keys: v, trans: w }).then(function(E) {
                        return 0 < E.numFailures ? Promise.reject(E.failures[0]) : v.length < m ? { failures: [], numFailures: 0, lastResult: void 0 } : l(w, d(d({}, p), { lower: v[v.length - 1], lowerOpen: !0 }), m);
                      });
                    });
                  }(a.trans, a.range, 1e4);
                }, !0);
            ...
            return n.mutate(a);
            function y(l) {
              var w, p, m, g = U.trans, v = l.keys || Hn(r, l);
              if (!v) throw new Error("Keys missing");
              return (l = l.type === "add" || l.type === "put" ? d(d({}, l), { keys: v }) : d({}, l)).type !== "delete" && (l.values = D([], l.values)), l.keys && (l.keys = D([], l.keys)), w = n, m = v, ((p = l).type === "add" ? Promise.resolve([]) : w.getMany({ trans: p.trans, keys: m, cache: "immutable" })).then(function(E) {
                var x = v.map(function(P, C) {
                  var N, F, I, k = E[C], K = { onerror: null, onsuccess: null };
                ...
                return n.mutate(l).then(function(P) {
                  for (var C = P.failures, N = P.results, F = P.numFailures, P = P.lastResult, I = 0; I < v.length; ++I) {
                    var k = (N || v)[I], K = x[I];
                    k == null ? K.onerror && K.onerror(C[I]) : K.onsuccess && K.onsuccess(l.type === "put" && E[I] ? l.values[I] : k);
                  }
      ...
      var ga = { stack: "dbcore", level: 0, name: "Observability", create: function(e) {
        ...
        return d(d({}, e), { transaction: function(r, a, o) {
          ...
          var a = e.table(r), o = a.schema, u = o.primaryKey, l = o.indexes, c = u.extractKey, f = u.outbound, h = u.autoIncrement && l.filter(function(p) {
            ...
            var g, v, E, x = p.trans, P = p.mutatedParts || (p.mutatedParts = {}), C = m(""), N = m(":dels"), F = p.type, K = p.type === "deleteRange" ? [p.range] : p.type === "delete" ? [p.keys] : p.values.length < 50 ? [Hn(u, p).filter(function(B) {
              return B;
            }), p.values] : [], I = K[0], k = K[1], K = p.trans._cache;
            return q(I) ? (C.addKeys(I), (K = F === "delete" || I.length === k.length ? Dr(I, K) : null) || N.addKeys(I), (K || k) && (g = m, v = K, E = k, o.indexes.forEach(function(B) {
              var L = g(B.name || "");
              function X(Y) {
              ...
              return !I || p.type !== "add" && p.type !== "put" || (C.addKeys(B.results), h && h.forEach(function(L) {
                for (var X = p.values.map(function(z) {
                  return L.extractKey(z);
                }), te = L.keyPath.findIndex(function(z) {
                  return z === u.keyPath;
                }), Y = 0, me = B.results.length; Y < me; ++Y) X[Y][te] = B.results[Y];
                m(L.name).addKeys(X);
                    ...
                    return a[p].apply(this, arguments).then(function(k) {
                      if (p === "query") {
                        if (f && m.values) return N.then(function(X) {
                          return X = X.result, P.addKeys(X), k;
                        });
      ...
      function kr(e, t, w, r, a, o) {
        ...
        var u = t.query.index, c = u.multiEntry, f = t.query.range, h = r.schema.primaryKey.extractKey, y = u.extractKey, l = (u.lowLevelIndex || u).extractKey, w = w.reduce(function(p, m) {
          var g = p, v = [];
          if (m.type === "add" || m.type === "put") for (var E = new Ae(), x = m.values.length - 1; 0 <= x; --x) {
            var P, C = m.values[x], N = h(C);
            E.hasKey(N) || (P = y(C), (c && q(P) ? P.some(function(B) {
              return Xn(B, f);
            }) : Xn(P, f)) && (E.addKey(N), v.push(C)));
          }
          switch (m.type) {
            case "add":
      ...
      var Ta = { stack: "dbcore", level: 0, name: "Cache", create: function(e) {
        ...
        return d(d({}, e), { transaction: function(n, r, a) {
              ...
              if (o.abort(), r === "readwrite") {
                for (var h = /* @__PURE__ */ new Set(), y = 0, l = n; y < l.length; y++) {
                  ...
                  if (p) {
                    ...
                    if (c._explicit && f && c.mutatedParts) for (var v = 0, E = Object.values(p.queries.query); v < E.length; v++) for (var x = 0, P = (F = E[v]).slice(); x < P.length; x++) Un((I = P[x]).obsSet, c.mutatedParts) && (Ve(F, I), I.subscribers.forEach(function(L) {
                      return h.add(L);
                    }));
                    else if (0 < g.length) {
          ...
          return d(d({}, r), { mutate: function(o) {
            ...
            return c ? (u = r.mutate(o), o.type !== "add" && o.type !== "put" || !(50 <= o.values.length || Hn(a, o).some(function(f) {
              return f == null;
        ...
        var f = (function h(y, l, w, p, m) {
          return j.resolve().then(function() {
            ...
            return x && wt(), g = j.follow(function() {
              var P;
              (E = m.call(v, v)) && (x ? (P = Je.bind(null, null), E.then(P, P)) : typeof E.next == "function" && typeof E.throw == "function" && (E = zn(E)));
      ...
      function ve(e, t) {
        ...
        h.dbReadyPromise = new j(function(l) {
        ...
        }), this.Collection = (a = this, Ft(ra.prototype, function(E, v) {
          this.db = a;
          var p = fr, m = null;
          if (v) try {
            p = v();
          ...
          this.db = o, this._tx = p, this.name = l, this.schema = w, this.hook = o._allTables[l] ? o._allTables[l].hook : kt(null, { creating: [Xe, Q], reading: [xe, ue], updating: [Ke, Q], deleting: [Te, Q] });
        })), this.Transaction = (u = this, Ft(ia.prototype, function(l, w, p, m, g) {
          var v = this;
          l !== "readonly" && w.forEach(function(E) {
            E = (E = p[E]) === null || E === void 0 ? void 0 : E.yProps, E && (w = w.concat(E.map(function(x) {
              return x.updatesTable;
            })));
          }), this.db = u, this.mode = l, this.storeNames = w, this.schema = p, this.chromeTransactionDurability = m, this.idbtrans = null, this.on = kt(this, "complete", "error", "abort"), this.parent = g || null, this.active = !0, this._reculock = 0, this._blockedFuncs = [], this._resolve = null, this._reject = null, this._waitingFor = null, this._waitingQueue = null, this._spinCount = 0, this._completion = new j(function(E, x) {
            v._resolve = E, v._reject = x;
          }), this._completion.then(function() {
            v.active = !1, v.on.complete.fire();
          }, function(E) {
            var x = v.active;
            return v.active = !1, v.on.error.fire(E), v.parent ? v.parent._reject(E) : x && v.idbtrans && v.idbtrans.abort(), ye(E);
          });
        ...
        })), this.WhereClause = (f = this, Ft(Tr.prototype, function(l, w, p) {
          ...
          n.on("blocked").fire(l), Tt.filter(function(w) {
            return w.name === n.name && w !== n && !w._state.vcFired;
          }).map(function(w) {
            return w.on("versionchange").fire(l);
          });
        }, this.use(va), this.use(Ta), this.use(ga), this.use(ma), this.use(ya);
      ...
      var yn, ke = typeof Symbol < "u" && "observable" in Symbol ? Symbol.observable : "@@observable", Ea = (Wn.prototype.subscribe = function(e, t, n) {
      ...
      function Br(e) {
        var t, n = !1, r = new Ea(function(a) {
          ...
          var l = !1, w = function() {
            ...
            var g, v, E;
            !c && yn.indexedDB && (f = {}, g = {}, u && u.abort(), u = new AbortController(), E = function(x) {
              var P = gt();
              try {
                o && wt();
                var C = $e(e, x);
            ...
            }(v = { subscr: g, signal: u.signal, requery: w, querier: e, trans: null }), Promise.resolve(E).then(function(x) {
      ...
      H(dt, d(d({}, ee), { delete: function(e) {
        ...
        Ct(e);
      } }, derive: ge, extend: G, props: H, override: le, Events: kt, on: tt, liveQuery: Br, extendObservabilitySet: pn, getByKeyPath: Oe, setByKeyPath: se, delByKeyPath: function(e, t) {
        typeof t == "string" ? se(e, t, void 0) : "length" in t && [].map.call(t, function(n) {
          se(e, n, void 0);
        });
      }, shallowClone: mt, deepClone: we, getObjectDiff: Yn, cmp: Z, asap: de, minKey: -1 / 0, addons: [], connections: Tt, errnames: s, dependencies: yn, cache: pt, semVer: "4.2.0", version: "4.2.0".split(".").map(function(e) {
        return parseInt(e);
      ...
      return typeof BroadcastChannel < "u" && ((Kr = function() {
        ...
        return !e || e instanceof Ye || e instanceof TypeError || e instanceof SyntaxError || !e.name || !T[e.name] ? e : (t = new T[e.name](t || e.message, e), "stack" in e && J(t, "stack", { get: function() {
...
function no(O) {
  const { parentRecordsBatch: b, parentTagName: A } = O, d = [...b], D = Xr(A);
  for (const R of b) {
...
function ro(O) {
  const { children: b, tagName: A } = O, d = b.map((R) => R.id), D = Xr(A);
  Gt[A] = D.filter(
...
function Wr(O) {
  ...
  async function M() {
    ...
    const { resolve: V, promise: H } = Promise.withResolvers();
    return R = V, H;
  }
  function q(ie) {
    if (d.length >= A && R) {
...
function po(O) {
  const { node: b, state: A } = O, d = { ...A }, D = crypto.randomUUID(), R = go(b), M = bo(b), q = wo(b.attributes), G = To(A.currentParentElements), ie = {
    id: D,
    tagName: R,
    namespace: M,
    attributes: q,
...
async function Po(O, b) {
  ...
  async function q() {
    ...
    let H = await A.table("DataTypeTemplates").orderBy("id").first();
    if (!H) {
      const J = {
      ...
      H = await d.addRecord(J);
      const ge = await d.findRootSCL();
      await d.ensureRelationship(ge, H);
    }
    ...
    for (const J of ae) {
      ...
      if (await d.findOneRecordByAttribute(
        ...
        continue;
      const be = await pe(J);
      await d.ensureRelationship(H, be);
    }
  }
  async function G() {
    const V = await D.table("FunctionCategory").toArray();
    for (const H of V) {
      const ae = await ar(D, H), J = [];
  ...
  async function pe(V) {
    const H = await d.addRecord(V), ae = await R.findChildRecords(V);
    for (const J of ae) {
      const ge = await pe(J);
      d.ensureRelationship(H, ge);
    }
    return H;
  }
}

...
- UI display problem for Control Dataflows when window is zoomed out
- Do not create empty LNodeInputs/LNodeOutputs elements after cancelling dataflow (placeholder) creation

## [66] - 2026-08-11

### Fixed

- Save buttons in dialogs are disabled while a save is in progress to prevent multiple save requests

## [65] - 2026-08-11

### Fixed

- Dataflow dialogs no longer occasionally reset to empty right after being reopened

## [63] - 2026-08-03

### Fixed

- Do not show "Supervised" indicator for dataflow lines when dataflow specification view is active
- Also show "Supervised" indicator for dataflow group lines, when all dataflow lines in the group are supervised

## [62] - 2026-07-31

### Fixed

- Remove "..." when dataflow group only contains 1 dataflow line

### Changed

- Rename "Monitoring" to "Supervision"

### Added

- Show an indicator on supervised dataflow lines and a matching "Supervised" entry in the legend

## [61] - 2026-07-31

### Fixed

- Do not create duplicate DOS elements in LNodes when creating dataflows and placeholders

## [60] - 2026-07-29

### Fixed

- Make select inputs in Dataflow implementation form wider
- Do not remove supervision when there is still a subscribing dataflow for the Control Block
- Preselect "Create new" option for ExtRef during dataflow implementation if no existing ExtRef is available

## [59] - 2026-07-28

### Changed

- Remove context menu and use icon action buttons instead for dataflow (group) actions: Implement, Unimplement, Show Details, Delete

## [58] - 2026-07-24

### Added

- Create Dataflows and Dataflow placeholders of type "Internal" (only between LNodes of the same IED). Internal dataflows cannot be implemented.

## [57] - 2026-07-23

### Added

- Delete manually created implemented Dataflows without specification in the Dataflow Implementation View
- Delete supervision when a supervised dataflow is unimplemented or deleted
- Show monitoring details (supervising LGOS/LSVS path and Val) for implemented GOOSE/SMV dataflows

## [55] - 2026-07-07

### Added

- Possibility to manually create implemented Dataflows without specification in the Dataflow Implementation View
- Display manually created implemented Dataflows without specification (ExtRefs without SourceRef) in the Dataflow Implementation View

## [54] - 2026-06-02

### Changed

- Warning Badge in Dataflow implementation view now shows whether an LNode is mapped to an S-IED or not mapped at all

## [53] - 2026-06-02

### Added

- Delete implemented dataflows
- Delete placeholders
...
- Dataflow Implementation View shows the mapped LNs instead of LNodes from the specification, if the LNode is mapped to a real IED

### Fixed

- Switching between extensions no longer leaves a broken or stale view
- Delete Inputs element container when last ExtRef is removed
- Consider "instMag.f" in correct FCDA ordering for SMV dataflows

## [51] - 2026-06-16

### Added

- Delete specified dataflows

## [50] - 2026-06-12

### Changed

- Delete ExtRef on Dataflow unimplementation, when it came from SET

### Fixed

- Do not set pLN, pDO, pDA, pServT when creating ExtRefs for dataflow implementation
- Handle ExtRefs that can lie within LN0 elements too

## [49] - 2026-06-05

### Added

- Show ExtRef's location and properties for implemented dataflows
- Highlight the matching FCDA in the DataSet list for an implemented dataflow

## [48] - 2026-06-03

### Changed

- Restrict SMV dataflows to sending LNodes of class TCTR or TVTR for dataflow creation, placeholder creation and placeholderresolution
- SMV ControlBlock matching logic now follows the default rule: 1 SMV control block + dataset per CT/VT core per function (LDevice)

## [47] - 2026-06-03

### Fixed

- ExtRef validation during dataflow implementation

## [46] - 2026-06-03

### Fixed

- After a Dataflow has been created, a placeholder has been resolved or a Dataflow has been implemented, show its details in the sidebar
